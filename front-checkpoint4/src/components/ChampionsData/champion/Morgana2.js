...
const Morgana2 = {
  ...
  data: {
    Morgana: {
      ...
      skins: [
        { id: "25000", num: 0, name: "default", chromas: true },
        { id: "25001", num: 1, name: "Morgana exilée", chromas: false },
        { id: "25002", num: 2, name: "Morgana pécheresse", chromas: false },
        {
          id: "25003",
          num: 3,
        ...
        { id: "25004", num: 4, name: "Morgana des ronces", chromas: true },
        { id: "25005", num: 5, name: "Morgana mariée fantôme", chromas: false },
        {
          id: "25006",
          num: 6,
        ...
        },
        {
          id: "25010",
          num: 10,
          name: "Morgana spectre lunaire",
          chromas: false,
        },
        { id: "25011", num: 11, name: "Morgana sorcière", chromas: false },
        {
          id: "25017",
          num: 17,
        ...
        { id: "25026", num: 26, name: "Morgana de l'assemblée", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Entrave sombre",
          description:
            "Morgana utilise la magie noire pour immobiliser un ennemi, l'obligeant à ressentir la douleur qu'il a causée et lui infligeant des dégâts magiques. ",
          tooltip:
            "Projette une boule de feu stellaire qui immobilise le premier ennemi touché pendant {{ rootduration }} sec en lui infligeant <magicDamage>{{ totaldamage }} pts de dégâts magiques</magicDamage>.",
          leveltip: {
            label: [
              "Dégâts",
          ...
          maxammo: "-1",
          range: [1250, 1250, 1250, 1250, 1250],
          rangeBurn: "1250",
          image: {
            full: "MorganaQ.png",
            sprite: "spell7.png",
        ...
        },
        {
          ...
          description:
            "Morgana déploie une ombre maudite sur une zone, blessant les ennemis qui osent y mettre les pieds. Ces ennemis subissent des dégâts magiques sur la durée qui augmentent avec leurs PV manquants.",
          tooltip:
            "Embrase une zone pendant {{ wduration }} sec, infligeant <magicDamage>{{ totalmindamage }} pts de dégâts magiques</magicDamage> par seconde aux ennemis dans la zone. Les dégâts augmentent avec les PV manquants de la cible, jusqu'à {{ missinghealthamppercent*100 }}% max.<br /><br />Le délai de récupération de Tourment ténébreux est réduit de {{ cdrefundpercent*100 }}% chaque fois que Morgana est soignée par Siphon d'âme.",
          leveltip: {
            label: ["Dégâts par seconde", "Coût en @AbilityResourceName@"],
            effect: [
        ...
        },
        {
          ...
          name: "Bouclier noir",
          description:
            "Morgana offre à un allié une barrière de feu stellaire qui absorbe les dégâts magiques et les entraves jusqu'à ce que celle-ci soit brisée.",
          tooltip:
            "Octroie un bouclier à un champion allié pendant {{ shieldduration }} sec. Le bouclier absorbe <magicDamage>{{ totalshieldstrength }} pts de dégâts magiques</magicDamage> et protège contre les entraves tant qu'il est actif.",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Morgana détache ses ailes, libérant toute sa puissance céleste et se mettant à survoler le sol. Elle lance des chaînes sombres sur les champions ennemis proches, gagnant de la vitesse de déplacement dans leur direction. La chaîne ralentit ces ennemis et leur inflige des dégâts ; après un délai, les ennemis qui n'ont pas brisé les chaînes sont étourdis.",
          tooltip:
            "Morgana s'enchaîne aux champions ennemis proches, leur infligeant <magicDamage>{{ totaldamage }} pts de dégâts magiques</magicDamage> et les ralentissant de {{ slowpercent }}%. Au bout de {{ chainduration }} sec, les ennemis qui n'ont pas brisé leurs chaînes subissent <magicDamage>{{ totaldamage }} pts de dégâts magiques</magicDamage> supplémentaires et sont étourdis pendant {{ stunduration }} sec.<br /><br />Pendant l'incantation de Chaînes spirituelles, Morgana augmente sa vitesse de déplacement de {{ hastepercent }}% en direction des ennemis enchaînés.",
          leveltip: {
            label: [
              "Dégâts",
      ...
      passive: {
        name: "Siphon d'âme",
        description:
          "Morgana peut drainer l'esprit de ses ennemis. Elle récupère des PV quand elle blesse des champions, des grands sbires et des grands monstres.",
        image: {
