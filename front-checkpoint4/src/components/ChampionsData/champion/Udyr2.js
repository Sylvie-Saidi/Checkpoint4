...
const Udyr2 = {
  ...
  data: {
    Udyr: {
      ...
      skins: [
        { id: "77000", num: 0, name: "default", chromas: false },
        { id: "77001", num: 1, name: "Udyr ceinture noire", chromas: false },
        { id: "77002", num: 2, name: "Udyr primitif", chromas: false },
        {
          id: "77003",
          num: 3,
        ...
        { id: "77004", num: 4, name: "Udyr incognito", chromas: false },
        { id: "77005", num: 5, name: "Udyr oracle draconique", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          id: "UdyrTigerStance",
          name: "Posture du tigre",
          description:
            "Posture du tigre : Activation - La vitesse d'attaque d'Udyr est augmentée pendant quelques secondes. Effet persistant - Lors de sa première attaque puis toutes les trois attaques, Udyr inflige des dégâts importants en 2 sec.",
          tooltip:
            "<spellPassive>Effet persistant : </spellPassive>lors de sa première attaque puis toutes les trois attaques, Udyr réalise une Frappe du tigre, infligeant {{ e1 }} <scaleAD>(+{{ f2 }})</scaleAD> pts de dégâts physiques supplémentaires en {{ e5 }} sec. <br /><br />Si une cible est affectée par Frappe du tigre, une nouvelle application de Frappe du tigre inflige instantanément le reste des dégâts.<br /><br /><spellPassive>Activation :</spellPassive> la vitesse d'attaque d'Udyr augmente de {{ e2 }}% pendant {{ e6 }} sec.<br />",
          leveltip: {
            label: [
              "Dégâts de base",
        ...
        {
          id: "UdyrTurtleStance",
          name: "Posture de la tortue",
          description:
            "Posture de la tortue : Activation - Udyr profite d'un bouclier temporaire qui absorbe les dégâts. Effet persistant - Lors de sa première attaque puis toutes les trois attaques, Udyr récupère 2,5% de ses PV max.",
          tooltip:
            "<spellPassive>Effet persistant : </spellPassive>lors de sa première attaque puis toutes les trois attaques, Udyr récupère <scaleHealth>(+{{ f1 }})</scaleHealth> PV ({{ e3 }}% de ses PV max), et ce montant augmente de 1% tous les 1% de PV qu'il lui manque.<br /><br /><spellPassive>Activation : </spellPassive>Udyr s'entoure d'un bouclier qui absorbe {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts pendant {{ e2 }} sec.",
          leveltip: {
            label: ["PV du bouclier"],
            effect: ["{{ e1 }} -> {{ e1NL }}"],
          },
          maxrank: 6,
          cooldown: [6, 6, 6, 6, 6, 6],
        ...
        {
          id: "UdyrBearStance",
          name: "Posture de l'ours",
          description:
            "Posture de l'ours : Activation - La vitesse de déplacement d'Udyr augmente pendant un court instant. Effet persistant - Les attaques de base d'Udyr étourdissent la cible pendant 1 sec. Cet effet ne peut pas être infligé à la même cible pendant quelques secondes.",
          tooltip:
            "<spellPassive>Effet persistant : </spellPassive>les attaques de base d'Udyr étourdissent la cible pendant {{ e3 }} sec. Cet effet ne peut pas être infligé deux fois de suite en moins de {{ e4 }} sec.<br /><br /><spellPassive>Activation : </spellPassive>Udyr profite d'un bonus de {{ e1 }}% en vitesse de déplacement et ignore les collisions pendant {{ e2 }} sec.",
          leveltip: {
            label: [
        ...
        {
          id: "UdyrPhoenixStance",
          name: "Posture du phénix",
          description:
            "Posture du phénix : Activation - Udyr envoie des vagues de feu infligeant des dégâts aux ennemis proches. Effet persistant - Lors de sa première attaque puis toutes les trois attaques, Udyr projette des flammes sur les ennemis en face de lui.",
          tooltip:
            "<spellPassive>Effet persistant :</spellPassive> lors de sa première attaque puis toutes les trois attaques, Udyr engloutit les ennemis devant lui dans les flammes, infligeant {{ totalconedamage }} pts de dégâts magiques.<br /><br /><spellPassive>Activation : </spellPassive>Udyr envoie des vagues de feu, infligeant {{ totalaoedamagepertick }} pts de dégâts magiques chaque seconde aux ennemis proches pendant {{ phoenixaoeduration }} sec.",
          leveltip: {
            label: ["Dégâts de la pulsation", "Dégâts des flammes"],
            effect: [
      ...
      passive: {
        ...
        description:
          "Quand Udyr adopte une posture, il gagne temporairement un bonus en vitesse d'attaque et en vitesse de déplacement. Cet effet peut être cumulé plusieurs fois.",
        image: {
