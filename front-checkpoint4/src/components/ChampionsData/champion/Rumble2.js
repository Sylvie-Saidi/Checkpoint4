...
const Rumble2 = {
  ...
  data: {
    Rumble: {
      ...
      skins: [
        { id: "68000", num: 0, name: "default", chromas: false },
        { id: "68001", num: 1, name: "Rumble de la jungle", chromas: false },
        { id: "68002", num: 2, name: "Rumble de Bilgewater", chromas: false },
        {
          id: "68003",
          num: 3,
      ...
      spells: [
        {
          ...
          name: "Lance-flammes",
          description:
            "Rumble enflamme les adversaires devant lui, infligeant des dégâts magiques dans une zone conique pendant 3 sec. Dans la Zone rouge, les dégâts augmentent.",
          tooltip:
            "Rumble enflamme ses adversaires, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques dans une zone conique en {{ e9 }} sec. Ce sort inflige {{ e4 }}% de dégâts aux sbires.<br /><br /><keywordCaution>Bonus Zone rouge :</keywordCaution> inflige {{ e5 }}% de dégâts.",
          leveltip: {
            label: ["Dégâts", "Délai de récupération", "Dégâts aux sbires"],
            effect: [
              "{{ e1 }} -> {{ e1NL }}",
              "{{ cooldown }} -> {{ cooldownNL }}",
          ...
          vars: [{ link: "spelldamage", coeff: 1.1, key: "a1" }],
          costType: " pts de Vapeur",
          maxammo: "-1",
          ...
          resource: "{{ e2 }} pts de Vapeur",
        },
        {
          id: "RumbleShield",
          name: "Bouclier recyclé",
          description:
            "Rumble crée un bouclier qui le protège des dégâts et lui donne un bonus de rapidité. Dans la Zone rouge, les PV du bouclier et le bonus de vitesse sont augmentés.",
          tooltip:
            "Rumble crée un bouclier pendant {{ e5 }} sec qui absorbe {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts. Rumble gagne aussi un bonus de {{ e2 }}% en vitesse de déplacement pendant {{ e6 }} sec.<br /><br /><keywordCaution>Bonus Zone rouge :</keywordCaution> les PV du bouclier et la vitesse de déplacement augmentent de 50%.",
          leveltip: {
            label: ["PV du bouclier", "Vitesse de déplacement"],
          ...
          resource: "{{ e3 }} pts de Vapeur",
        },
        {
          id: "RumbleGrenade",
          name: "Harpon électrique",
          description:
            "Rumble tire un harpon qui électrocute sa cible, lui infligeant des dégâts magiques et réduisant sa vitesse de déplacement. Rumble peut porter 2 harpons en même temps. Dans la Zone rouge, les dégâts et le pourcentage de ralentissement sont augmentés.",
          tooltip:
            "Rumble tire un harpon électrifié, infligeant {{ e1 }}<scaleAP> (+{{ a1 }})</scaleAP> pts de dégâts magiques et un effet de ralentissement cumulable de {{ e2 }}% pendant {{ e7 }} sec. Rumble peut stocker jusqu'à 2 harpons à la fois, et il récupère un harpon toutes les {{ ammorechargetime }} sec (délai modifié par la réduction des délais de récupération).<br /><br /><keywordCaution>Bonus Zone rouge :</keywordCaution> les dégâts et le pourcentage de ralentissement augmentent de 50%.",
          leveltip: {
        ...
        },
        {
          ...
          name: "Éradication",
          description:
            "Rumble tire une bordée de roquettes, créant un mur de flammes qui blesse et ralentit les ennemis.",
          tooltip:
            "Rumble lance une bordée de roquettes qui laisse une traînée de feu pendant {{ trailduration }} sec. Les ennemis dans la zone voient leur vitesse de déplacement être réduite de {{ slowamount }}% et ils subissent <magicDamage>{{ damagepersecond }} pts de dégâts magiques</magicDamage> par seconde.<br /><br /><specialRules>Vous pouvez contrôler la position de l'attaque en cliquant et en déplaçant le curseur sur une ligne.</specialRules>",
          leveltip: {
      ...
      passive: {
        ...
        description:
          "Chaque sort lancé par Rumble augmente sa Vapeur. Quand Rumble atteint 50% de Vapeur, il entre dans la Zone rouge, ce qui confère des effets bonus à ses compétences de base. Quand il atteint 100% de Vapeur, il entre en Surchauffe, ce qui lui permet d'infliger des dégâts supplémentaires avec ses attaques de base mais l'empêche de lancer des sorts pendant quelques secondes.",
        image: {
