...
const Sejuani2 = {
  ...
  data: {
    Sejuani: {
      ...
      skins: [
        { id: "113000", num: 0, name: "default", chromas: false },
        {
          id: "113001",
          num: 1,
        ...
        { id: "113002", num: 2, name: "Sejuani fatale", chromas: false },
        { id: "113003", num: 3, name: "Sejuani classique", chromas: false },
        {
          id: "113004",
          num: 4,
        ...
        },
        {
          id: "113006",
          num: 6,
          name: "Sejuani chasseuse de bêtes",
          chromas: false,
        },
        {
          id: "113007",
        ...
        { id: "113015", num: 15, name: "Sejuani Hextech", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Sejuani charge droit devant elle, projetant les ennemis dans les airs. La charge s'arrête si elle touche un champion ennemi.",
          tooltip:
            "Sejuani charge, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis et les projetant dans les airs. La charge s'arrête si elle touche un champion ennemi.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Sejuani donne deux coups de masse, infligeant des dégâts et appliquant des effets Givre.",
          tooltip:
            'Sejuani frappe avec son fléau, infligeant {{ e1 }} <scaleHealth>(+{{ f1 }})</scaleHealth> <scaleAP>(+{{ f3 }})</scaleAP> pts de dégâts physiques et appliquant <span class="color07F2F1">Givre</span> sur les ennemis touchés, en plus de repousser les sbires et les monstres.<br /><br />Elle frappe ensuite avec son fléau, infligeant {{ e3 }} <scaleHealth>(+{{ f2 }})</scaleHealth> <scaleAP>(+{{ f4 }})</scaleAP> pts de dégâts physiques, appliquant <span class="color07F2F1">Givre</span> sur les ennemis touchés et les ralentissant de {{ slowamount*100 }}% pendant {{ slowduration }} sec.',
          leveltip: {
            label: [
              "Dégâts du premier coup",
        ...
        },
        {
          ...
          name: "Permafrost",
          description:
            "Sejuani gèle et étourdit un champion ennemi qui porte le nombre max d'effets Givre.",
          tooltip:
            '<spellPassive>Passive :</spellPassive> les attaques de base des champions de mêlée alliés proches appliquent <span class="color07F2F1">Givre</span> sur les champions ennemis, sur les grands monstres, sur les monstres moyens et sur les grands sbires.<br /><br /><spellPassive>Active :</spellPassive> l\'ennemi affecté par 4 effets <span class="color07F2F1">Givre</span> subit {{ e3 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques, est étourdi pendant {{ e1 }} sec et est brièvement déplacé.<br /><br /><rules>Les champions ennemis étourdis par Sejuani ne peuvent plus recevoir d\'effet </rules><span class="size16 color07F2F1">Givre</span><rules> pendant {{ f2 }} sec.</rules>',
          leveltip: { label: ["Dégâts"], effect: ["{{ e3 }} -> {{ e3NL }}"] },
          maxrank: 5,
        ...
        },
        {
          ...
          description:
            "Sejuani projette des bolas qui gèlent et étourdissent le premier champion touché, en plus de créer une tempête de glace qui ralentit les autres ennemis.",
          tooltip:
            "Sejuani projette ses bolas de glace pure, qui infligent {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques au premier champion ennemi touché et l'étourdit pendant {{ e2 }} sec.<br /><br />Les bolas gagnent en puissance quand ils vont loin, infligeant {{ e7 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts magiques, étourdissant pendant {{ e6 }} sec et créant une tempête qui ralentit les autres ennemis de {{ e8 }}%. Au bout de {{ e3 }} sec, la tempête inflige {{ e7 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts magiques et un ralentissement de {{ e4 }}% pendant {{ e5 }} sec.",
          leveltip: {
            label: [
              "Dégâts minimum",
              "Dégâts maximum",
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                { id: "3083", count: 1, hideCount: false },
                { id: "3742", count: 2, hideCount: false },
                { id: "3110", count: 1, hideCount: false },
              ],
            },
            {
