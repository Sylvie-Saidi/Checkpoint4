...
const Zilean2 = {
  ...
  data: {
    Zilean: {
      ...
      skins: [
        { id: "26000", num: 0, name: "default", chromas: false },
        { id: "26001", num: 1, name: "Vieux saint Zilean", chromas: false },
        { id: "26002", num: 2, name: "Zilean groovy", chromas: false },
        {
          id: "26003",
          num: 3,
          name: "Zilean du désert de Shurima",
          chromas: false,
        },
        {
          id: "26004",
        ...
        { id: "26005", num: 5, name: "Zilean lune de sang", chromas: false },
        { id: "26006", num: 6, name: "Zilean folie sucrée", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Lance une bombe dans une zone. La bombe se colle sur une unité qui s'en approche (en priorité les champions) et explose après 3 secondes, infligeant des dégâts de zone. Si une Bombe à retardement explose prématurément à cause d'une autre Bombe à retardement, les ennemis sont également étourdis.",
          tooltip:
            "Zilean lance une bombe à retardement dans une zone. La bombe se colle sur la première unité qui entre dans une petite zone autour d'elle (en priorité les champions). La bombe explose au bout de {{ e2 }} sec, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques à tous les ennemis proches. <br /><br />Poser une bombe sur une unité qui en porte déjà une fait exploser la première bombe, étourdissant les ennemis pris dans l'explosion pendant {{ e4 }} sec.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          name: "Retour rapide",
          description:
            "Zilean se prépare à de futures confrontations, réduisant le délai de récupération de ses autres compétences.",
          tooltip:
            "Réduit de {{ e2 }} sec les délais de récupération des autres sorts de base de Zilean.",
          leveltip: {
          ...
          resource: "{{ e3 }} pts de mana",
        },
        {
          id: "TimeWarp",
          name: "Distorsion temporelle",
          description:
            "Zilean distord le temps autour d'une unité, réduisant la vitesse de déplacement d'un ennemi ou augmentant celle d'un allié pendant un court moment.",
          tooltip:
            "Zilean réduit de {{ e2 }}% la vitesse de déplacement d'un champion ennemi ou augmente d'autant celle d'un champion allié pendant {{ e1 }} sec.",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Zilean place une rune temporelle sur un champion allié, le renvoyant dans le passé s'il subit des dégâts mortels.",
          tooltip:
            "Zilean se marque ou marque un champion allié avec une rune de protection pendant {{ rduration }} sec. Si la cible subit des dégâts et meurt, elle échappe à la mort en revenant dans le temps avec {{ rtotalheal }} PV.",
          leveltip: {
            label: [
              "Soins",
              "Délai de récupération",
      ...
      passive: {
        ...
        description:
          "Zilean stocke du temps sous forme d'<font color='#BB55EE'>expérience</font>. <br><br>Quand il a suffisamment d'<font color='#BB55EE'>expérience</font> pour augmenter le niveau d'un allié, il peut la lui offrir en lui cliquant dessus avec le bouton droit. Zilean reçoit autant d'<font color='#BB55EE'>expérience</font> qu'il en donne. Ne peut pas être utilisé en combat.",
        image: {
