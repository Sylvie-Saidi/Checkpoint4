...
const Nocturne2 = {
  ...
  data: {
    Nocturne: {
      ...
      skins: [
        { id: "56000", num: 0, name: "default", chromas: false },
        {
          id: "56001",
          num: 1,
          name: "Nocturne terreur glaciale",
          chromas: false,
        },
        { id: "56002", num: 2, name: "Nocturne du Néant", chromas: false },
        { id: "56003", num: 3, name: "Nocturne ravageur", chromas: false },
        { id: "56004", num: 4, name: "Nocturne revenant", chromas: false },
        { id: "56005", num: 5, name: "Nocturne eternum", chromas: false },
        {
          id: "56006",
          num: 6,
          name: "Nocturne spectre maudit",
          chromas: false,
        },
        { id: "56007", num: 7, name: "Nocturne sylvestre", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Crépuscule",
          description:
            "Nocturne projette une lame noire qui inflige des dégâts et laisse une Lueur crépusculaire derrière elle. Les champions ennemis touchés émettent également une Lueur crépusculaire. Quand il est dans la lueur, Nocturne peut traverser les unités et profite d'un bonus en vitesse de déplacement et en dégâts d'attaque.",
          tooltip:
            "Nocturne projette une lame noire qui inflige {{ e2 }} <scaleAD>(+{{ f1 }})</scaleAD> pts de dégâts physiques et laisse une Lueur crépusculaire derrière elle pendant {{ e3 }} sec. Les champions ennemis touchés émettent également une Lueur crépusculaire.<br /><br />Quand il est dans la lueur, Nocturne peut traverser les unités et profite d'un bonus de {{ e1 }}% en vitesse de déplacement et de {{ e4 }} en dégâts d'attaque.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Nocturne renforce ses lames, ce qui augmente passivement sa vitesse d'attaque. En lançant Linceul des ténèbres, Nocturne se fond dans l'obscurité, ce qui crée une barrière magique capable de bloquer une compétence ennemie et de doubler le bonus passif en vitesse d'attaque en cas de blocage.",
          tooltip:
            '<span class="colorFF9900">Passive :</span> Nocturne gagne {{ e1 }}% de vitesse d\'attaque.<br /><br /><span class="colorFF9900">Active :</span> Nocturne crée une barrière magique qui dure 1,5 sec et qui bloque la prochaine compétence ennemie.<br /><br />Si une compétence est bloquée par le bouclier, le bonus passif de Nocturne est doublé pendant {{ e4 }} sec.<br /><br /><rules>Linceul des ténèbres reste actif pendant le vol de Paranoïa.</rules>',
          leveltip: {
            label: [
        ...
        },
        {
          ...
          description:
            "Nocturne implante un cauchemar dans l'esprit de sa cible, infligeant des dégâts chaque seconde et terrifiant la cible si elle reste à portée pendant toute la durée du sort.",
          tooltip:
            '<span class="colorFF9900">Passive :</span> Nocturne augmente grandement sa vitesse de déplacement vers les ennemis terrifiés.<br /><br /><span class="colorFF9900">Active :</span> Nocturne implante un cauchemar dans l\'esprit de sa cible, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques en {{ e3 }} sec. Si Nocturne reste à portée de la cible pendant toute la durée du sort, la cible est terrifiée pendant {{ e2 }} sec.',
          leveltip: {
            label: [
              "Dégâts",
              "Durée de peur",
        ...
        },
        {
          ...
          name: "Paranoïa",
          description:
            "Nocturne réduit le champ de vision de tous les champions ennemis et supprime la vision qu'ils ont de leurs alliés. Il peut ensuite se projeter vers un champion ennemi proche.",
          tooltip:
            "Nocturne réduit le champ de vision de tous les champions ennemis et supprime la vision qu'ils ont de leurs alliés pendant {{ paranoiaduration }} sec.<br /><br />Tant que Paranoïa est active, Nocturne peut se projeter vers un champion ennemi, infligeant <physicalDamage>{{ damage }}</physicalDamage> pts de dégâts physiques.",
          leveltip: {
      ...
      passive: {
        name: "Lames d'ombre",
        description:
          "Toutes les quelques secondes, la prochaine attaque de Nocturne frappe les ennemis proches, infligeant des dégâts physiques supplémentaires et lui rendant des PV. <br><br>Les attaques de base de Nocturne réduisent ce délai.",
        image: {
