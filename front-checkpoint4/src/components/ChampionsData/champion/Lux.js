const Lux = {
  ...
  data: {
    Lux: {
      ...
      skins: [
        { id: "99000", num: 0, name: "default", chromas: false },
        { id: "99001", num: 1, name: "Lux sorcière", chromas: false },
        { id: "99002", num: 2, name: "Lux voleuse de sorts", chromas: false },
        { id: "99003", num: 3, name: "Lux commando", chromas: false },
        { id: "99004", num: 4, name: "Lux impériale", chromas: false },
        {
          id: "99005",
          num: 5,
        ...
        { id: "99007", num: 7, name: "Lux élémentaliste", chromas: false },
        { id: "99008", num: 8, name: "Lux impératrice lunaire", chromas: true },
        {
          id: "99014",
          num: 14,
          name: "Lux gardienne des pyjamas",
          chromas: false,
        },
        {
          id: "99015",
        ...
        },
        {
          id: "99016",
          num: 16,
          name: "Lux de l'Académie du combat édition prestige",
          chromas: false,
        },
        { id: "99017", num: 17, name: "Lux démiurge cosmique", chromas: false },
        { id: "99018", num: 18, name: "Lux cosmique", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          tooltip:
            "Projette une sphère de lumière, immobilisant jusqu'à deux ennemis pendant {{ e3 }} sec et leur infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques à chacun.",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Lux lance son bâton et courbe la lumière autour des cibles alliées touchées, les protégeant contre les dégâts.",
          tooltip:
            "Lance le bâton de Lux dans la direction ciblée, protégeant les champions alliés touchés contre {{ e2 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts pendant {{ e3 }} sec. Une fois à destination, le bâton revient vers Lux et l'effet se cumule.",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Crée une anomalie composée de lumière dans une zone, ralentissant les ennemis proches. Lux peut la faire exploser pour blesser les ennemis dans la zone d'effet.",
          tooltip:
            "Crée une zone qui ralentit les ennemis de {{ e1 }}% et éclaire la zone. Au bout de {{ e3 }} sec, la zone explose et inflige {{ e2 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques.<br /><br />Activer de nouveau pour faire exploser la zone plus tôt.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          name: "Éclat final",
          description:
            "Après avoir chargé de l'énergie, Lux tire un rayon lumineux qui inflige des dégâts à toutes les cibles dans la zone. En outre, Éclat final déclenche la compétence passive de Lux et rafraîchit la durée du sortilège d'Illumination.",
          tooltip:
            "Tire un rayon lumineux, infligeant <magicDamage>{{ totaldamage }}</magicDamage> pts de dégâts magiques à tous les ennemis sur une ligne.<br /><br />Éclat final embrase et réactualise le sortilège Illumination.",
          leveltip: {
            label: ["Dégâts", "Délai de récupération"],
            effect: [
              "{{ damage }} -> {{ damageNL }}",
      ...
      passive: {
        name: "Illumination",
        description:
          "Les sorts de Lux infligeant des dégâts chargent la cible en énergie pendant 6 sec. La prochaine attaque de Lux embrase l'énergie, infligeant des dégâts magiques supplémentaires à la cible (en fonction du niveau de Lux).",
        image: {
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              minSummonerLevel: -1,
              maxSummonerLevel: -1,
              showIfSummonerSpell: "S5_SummonerSmiteQuick",
              hideIfSummonerSpell: "",
              appendAfterSection: "",
              visibleWithAllOf: [""],
              hiddenWithAnyOf: [""],
