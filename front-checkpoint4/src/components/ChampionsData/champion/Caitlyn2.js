const Caitlyn2 = {
  ...
  data: {
    Caitlyn: {
      ...
      skins: [
        { id: "51000", num: 0, name: "default", chromas: true },
        { id: "51001", num: 1, name: "Caitlyn résistante", chromas: false },
        { id: "51002", num: 2, name: "Shérif Caitlyn", chromas: false },
        { id: "51003", num: 3, name: "Caitlyn safari", chromas: false },
        { id: "51004", num: 4, name: "Caitlyn arctique", chromas: false },
        { id: "51005", num: 5, name: "Agent Caitlyn", chromas: false },
        {
          id: "51006",
          num: 6,
        ...
        },
        {
          id: "51010",
          num: 10,
          name: "Caitlyn spectre lunaire",
          chromas: true,
        },
        { id: "51011", num: 11, name: "Caitlyn Pulsefire", chromas: true },
        { id: "51013", num: 13, name: "Caitlyn fusil à eau", chromas: true },
        { id: "51019", num: 19, name: "Caitlyn arcade", chromas: false },
        {
          id: "51020",
          num: 20,
          name: "Caitlyn arcade édition prestige",
          chromas: false,
        },
      ],
      lore:
      ...
      spells: [
        {
          ...
          tooltip:
            "Caitlyn fait monter son fusil en puissance pendant {{ e4 }} sec pour tirer un projectile fin et perforant qui inflige {{ e1 }} <scaleAD>(+{{ f1 }})</scaleAD> pts de dégâts physiques. Après avoir touché une cible, le projectile s'élargit et inflige {{ e2 }}% de dégâts en moins. <br /><br />Le Pacificateur de Piltover inflige toujours 100% de ses dégâts aux cibles révélées par des pièges.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          name: "Piège-yordle",
          description:
            "Caitlyn pose un piège pour trouver des yordles sournois. Quand il est déclenché, le piège révèle et immobilise le champion ennemi pendant 1,5 sec, octroyant à Caitlyn un Tir dans la tête renforcé.",
          tooltip:
            'Pose un piège qui se déclenche au passage d\'un champion ennemi, immobilisant ce dernier pendant {{ e6 }} sec et vous octroyant une <span class="coloree91d7">vision pure</span> de cet ennemi pendant un court instant.<br /><br />Les pièges durent {{ e3 }} sec. {{ e5 }} pièges peuvent être actifs simultanément.<br /><br />Tir dans la tête inflige {{ e2 }} <scaleAD>(+{{ f1 }})</scaleAD> pts de dégâts supplémentaires aux ennemis pris au piège.',
          leveltip: {
            label: [
              "Dégâts supplémentaires de Tir dans la tête contre les cibles piégées",
        ...
        },
        {
          ...
          description:
            "Caitlyn lance un filet lourd qui ralentit sa cible. Le recul projette Caitlyn en arrière.",
          tooltip:
            "Tire un filet et le recul projette Caitlyn en arrière. Le filet inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et ralentit le premier ennemi touché de {{ e3 }}% pendant {{ e2 }} sec.",
          leveltip: {
      ...
      passive: {
        ...
        description:
          "Toutes les quelques attaques de base ou quand elle vise une cible prise dans un de ses pièges ou dans son filet, Caitlyn tire dans la tête de sa cible, infligeant des dégâts supplémentaires qui augmentent avec ses chances de coup critique. Contre les cibles prises au piège ou dans un filet, la portée du Tir dans la tête est doublée.",
        image: {
