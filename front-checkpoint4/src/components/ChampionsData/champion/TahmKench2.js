...
const TahmKench2 = {
  ...
  data: {
    TahmKench: {
      ...
      skins: [
        { id: "223000", num: 0, name: "default", chromas: false },
        {
          id: "223001",
          num: 1,
        ...
        { id: "223002", num: 2, name: "Urf Kench", chromas: false },
        { id: "223003", num: 3, name: "Tahm Kench numismate", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Coup de langue",
          description:
            "Tahm Kench donne un coup de fouet avec sa langue, blessant et ralentissant la première unité touchée. Cette compétence étourdit la cible si celle-ci porte trois effets Goût acquis.",
          tooltip:
            'Inflige {{ e3 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques au premier ennemi touché et le ralentit de {{ e4 }}% pendant {{ e5 }} sec. Les champions portant 3 effets Goût acquis sont également étourdis pendant {{ e6 }} sec.<br /><br />Activez <span class="color0bf7de">Dévoration</span> pendant le Coup de langue pour dévorer des monstres/sbires à distance.',
          leveltip: {
            label: ["Dégâts de base", "Ralentissement"],
            effect: [
              "{{ e3 }} -> {{ e3NL }}",
        ...
        },
        {
          ...
          name: "Dévoration",
          description:
            "Tahm Kench dévore une cible, infligeant des dégâts magiques équivalents à un pourcentage des PV max de la cible. Il peut cracher dans une direction les sbires et monstres dévorés, infligeant des dégâts magiques dans la zone d'impact.",
          tooltip:
            'Dévore une cible pendant {{ e1 }} sec (la moitié pour les champions ennemis). Les ennemis subissent des dégâts magiques équivalents à {{ e7 }} (+{{ e3 }}%) <scaleAP>(+{{ a1 }}%)</scaleAP> de leurs PV max ({{ e2 }} max contre les monstres neutres).<br /><br /><spellPassive>Champions ennemis :</spellPassive> 3 effets Goût acquis doivent être cumulés sur la cible à dévorer. Lorsqu\'il contient un champion, Tahm Kench est ralenti de 95% et il est inerte.<br /><br /><spellPassive>Sbires et monstres :</spellPassive> réactivez pour cracher, infligeant {{ e7 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts magiques aux cibles touchées.<br /><br /><rules><span class="color8c8c8c">Quand Dévoration est utilisée sur un ennemi, son délai de récupération et son coût en mana sont réduits de moitié.</span></rules>',
          leveltip: {
            label: ["Dégâts de base", "Dégâts par sbire craché"],
            effect: ["{{ e7 }} -> {{ e7NL }}", "{{ e7 }} -> {{ e7NL }}"],
          },
          maxrank: 5,
          ...
          vars: [
            { link: "spelldamage", coeff: 0.02, key: "a1" },
        ...
        },
        {
          ...
          name: "Peau épaisse",
          description:
            "Tahm Kench transforme les dégâts subis en PV gris. Quand les PV gris se dissipent, Tahm Kench récupère des PV équivalents à un pourcentage des PV gris. À l'activation, tous les PV gris sont transformés en bouclier.",
          tooltip:
            "<spellPassive>Passive :</spellPassive> {{ e3 }}% des dégâts subis quand cette compétence n'est pas active sont convertis en PV gris. En cas de dissipation, {{ healthratio }} des PV gris sont convertis en PV.<br /><br /><spellPassive>Active :</spellPassive> convertit tous les PV gris en un bouclier qui dure {{ e1 }} sec.",
          leveltip: {
            label: ["Conversion des dégâts en PV gris"],
            effect: [
        ...
        {
          id: "TahmKenchNewR",
          name: "Traversée des abysses",
          description:
            "Tahm Kench se téléporte sur la carte en transportant éventuellement un champion allié.",
          tooltip:
            "Lance une canalisation pouvant durer jusqu'à 6 sec. Pendant ce temps, un champion allié peut cliquer avec le bouton droit sur Tahm Kench pour le rejoindre. Réactiver la compétence permet au contraire de voyager seul. À la réactivation ou quand un allié embarque, Tahm se rend à l'endroit ciblé.<br /><br /><rules>Les dégâts infligés par les champions ennemis interrompent la canalisation.<br />Les alliés en combat avec des champions ennemis ne peuvent pas embarquer pour la Traversée des abysses.</rules>",
          leveltip: {
            label: ["Délai de récupération", "Portée"],
            effect: [
              "{{ cooldown }} -> {{ cooldownNL }}",
              "{{ e1 }} -> {{ e1NL }}",
            ],
          ...
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
          range: [2500, 5500, 8500],
          rangeBurn: "2500/5500/8500",
          image: {
      ...
      passive: {
        name: "Goût acquis",
        description:
          "Tahm Kench met tout son poids dans ses attaques et ses compétences, permettant à ses PV totaux d'augmenter ses dégâts. Blesser des champions ennemis leur applique des effets Goût acquis. Si un champion ennemi porte 3 effets Goût acquis, Tahm Kench peut le dévorer.",
        image: {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                { id: "2138", count: 1, hideCount: true },
                { id: "3364", count: 1, hideCount: false },
              ],
            },
          ],
        },
          ...
          blocks: [
            {
              ...
              hiddenWithAnyOf: [""],
              items: [
                { id: "3858", count: 1, hideCount: false },
                { id: "2003", count: 2, hideCount: false },
                { id: "3340", count: 1, hideCount: false },
              ],
            },
            ...
            },
            {
              ...
              maxSummonerLevel: -1,
              showIfSummonerSpell: "",
              hideIfSummonerSpell: "SummonerTeleport",
              appendAfterSection: "",
              visibleWithAllOf: [""],
              hiddenWithAnyOf: [""],
              items: [
            ...
            },
            {
              ...
              minSummonerLevel: -1,
              maxSummonerLevel: -1,
              showIfSummonerSpell: "SummonerSnowURFSnowball_Mark",
              hideIfSummonerSpell: "",
              appendAfterSection: "",
              visibleWithAllOf: [""],
              hiddenWithAnyOf: [""],
            ...
            },
            {
              ...
              minSummonerLevel: -1,
              maxSummonerLevel: -1,
              showIfSummonerSpell: "SummonerSnowball",
              hideIfSummonerSpell: "",
              appendAfterSection: "",
              visibleWithAllOf: [""],
              hiddenWithAnyOf: [""],
