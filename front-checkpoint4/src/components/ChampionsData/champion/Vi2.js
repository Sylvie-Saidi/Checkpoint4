const Vi2 = {
  ...
  data: {
    Vi: {
      ...
      skins: [
        { id: "254000", num: 0, name: "default", chromas: false },
        { id: "254001", num: 1, name: "Vi de l'unité Néon", chromas: false },
        { id: "254002", num: 2, name: "Agent Vi", chromas: true },
        { id: "254003", num: 3, name: "Vi séductrice", chromas: false },
        { id: "254004", num: 4, name: "Vi démoniaque", chromas: false },
        {
          id: "254005",
          num: 5,
        ...
        { id: "254011", num: 11, name: "PROJET : Vi", chromas: false },
        { id: "254012", num: 12, name: "Vi bourreau des cœurs", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Brise-coffre",
          description:
            "Vi charge ses gants et balance un coup de poing destructeur qui l'entraîne vers l'avant. Les ennemis touchés sont repoussés et subissent un effet Coups fracassants.",
          tooltip:
            "Charge un puissant coup de poing qui projette Vi en avant.<br /><br /><spellPassive>Première activation :</spellPassive> réduit votre vitesse de déplacement de {{ e4 }}% tout en augmentant vos dégâts et la portée du coup en 1,25 sec.<br /><br /><spellPassive>Deuxième activation :</spellPassive> fonce vers l'avant, infligeant de {{ e1 }} <scaleAD>(+{{ f3 }})</scaleAD> à {{ f2 }} <scaleAD>(+{{ f1 }})</scaleAD> pts de dégâts physiques et appliquant Coups fracassants à tous les ennemis touchés. S'arrête au contact d'un champion ennemi, le projetant en arrière.",
          leveltip: {
            label: [
              "Dégâts minimum",
              "Dégâts maximum",
          ...
          vars: [{ link: "bonusattackdamage", coeff: 1.4, key: "f1" }],
        ...
        },
        {
          ...
          tooltip:
            "La 3e attaque d'affilée contre une même cible inflige des dégâts physiques supplémentaires équivalents à {{ e1 }}% <scaleAD>(+{{ f1 }}%)</scaleAD> des PV max de la cible, réduit son armure de {{ e3 }}% et augmente la vitesse d'attaque de Vi de {{ e2 }}% pendant {{ e4 }} sec (max : {{ e5 }} pts de dégâts contre les sbires et les monstres).<br /><br />Déclencher Coups fracassants réduit de 3 sec le délai de récupération de Bouclier antichoc.",
          leveltip: {
            label: ["Pourcentage des PV max en dégâts", "Vitesse d'attaque"],
          ...
          vars: [{ link: "@special.viw", coeff: 35, key: "f1" }],
        ...
        {
          id: "ViE",
          name: "Force excessive",
          description:
            "La prochaine attaque de Vi traversera sa cible, infligeant des dégâts aux ennemis qui se trouvent derrière.",
          tooltip:
            "Permet à la prochaine attaque de base d'infliger {{ e1 }} <scaleAD>(+{{ f3 }})</scaleAD> <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts physiques à la cible et aux ennemis derrière elle.<br /><br />Vi charge un autre coup de poing toutes les <scaleLevel>{{ ammorechargetime }}</scaleLevel> sec et peut conserver 2 charges simultanément.",
          leveltip: {
            label: [
              "Dégâts",
              "Délai de chargement",
          ...
          vars: [
            { link: "attackdamage", coeff: 1.15, key: "f3" },
            { link: "spelldamage", coeff: 0.9, key: "a1" },
          ],
          costType: " {{ abilityresourcename }}",
          maxammo: "2",
        ...
        },
        {
          ...
          name: "Marteau-pilon",
          description:
            "Vi fonce sur un ennemi, écartant ceux qui sont sur son passage. Quand elle atteint sa cible, elle la projette dans les airs, saute par-dessus et la renvoie au sol.",
          tooltip:
            'Cible un champion ennemi et lui fonce dessus, le projetant en l\'air pendant {{ rstunduration }} sec. Inflige <physicalDamage>{{ damage }}</physicalDamage> pts de dégâts physiques.<br /><br />Pendant la charge, Vi ne peut pas être arrêtée et elle a une <span class="coloree91d7">vision pure</span> de la cible. Elle écarte aussi tous les ennemis sur son passage, leur infligeant des dégâts et les étourdissant pendant {{ secondarytargetstunduration }} sec.',
          leveltip: {
            label: [
              "Dégâts de base",
              "Délai de récupération",
      ...
      passive: {
        ...
        description:
          "Vi charge un bouclier sur la durée. Le bouclier peut être activé en frappant un ennemi avec une compétence.",
        image: {
          full: "ViPassive.png",
          sprite: "passive4.png",
          group: "passive",
