...
const Neeko2 = {
  ...
  data: {
    Neeko: {
      ...
      skins: [
        { id: "518000", num: 0, name: "default", chromas: false },
        {
          id: "518001",
          num: 1,
        ...
        },
        {
          id: "518011",
          num: 11,
          name: "Neeko gardienne des étoiles édition prestige",
          chromas: false,
        },
      ],
      lore:
      ...
      spells: [
        {
          ...
          tooltip:
            "Neeko lance une graine qui éclot pour infliger {{ explosiondamage }} pts de dégâts magiques. Si la graine tue une unité ou touche un champion ou un grand monstre, l'éclosion se répète, infligeant {{ seconddamage }} pts de dégâts magiques (2 explosions supplémentaires max).",
          leveltip: {
            label: [
              "Dégâts initiaux",
              "Dégâts secondaires",
        ...
        },
        {
          ...
          name: "Métaclonage",
          description:
            "Passivement, Neeko inflige des dégâts magiques supplémentaires toutes les 3 attaques. Elle peut activer la compétence pour envoyer un clone dans une direction.",
          tooltip:
            '<span class="colorFF9900">Passive :</span> toutes les 3 attaques, Neeko inflige {{ passivebonusdamagecalc }} pts de dégâts magiques supplémentaires et augmente sa vitesse de déplacement de {{ passivehaste }}% pendant {{ passivehasteduration }} sec.<br /><br /><span class="colorFF9900">Active :</span> Neeko devient invisible pendant {{ stealthduration }} sec et projette un clone qui dure {{ cloneduration }} sec. Neeko et le clone ont une vitesse de déplacement augmentée de {{ haste }}% pendant {{ hasteduration }} sec.',
          leveltip: {
            label: [
              "Dégâts passifs",
              "Vitesse de déplacement active",
        ...
        },
        {
          ...
          description:
            "Neeko tire un projectile qui blesse et qui immobilise tous les ennemis traversés. Si le projectile touche un ennemi, il devient plus gros, plus rapide et la durée d'immobilisation est augmentée.",
          tooltip:
            "Neeko tire un projectile qui inflige {{ basedamage }} pts de dégâts magiques et qui immobilise les ennemis pendant {{ minrootduration }} sec.<br /><br />Le projectile se renforce après avoir touché un ennemi, devenant plus large, plus rapide et immobilisant pendant {{ maxrootduration }} sec.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Après une courte préparation, Neeko bondit dans les airs et s'entoure d'un bouclier. Quand elle atterrit, les ennemis proches sont blessés et étourdis. La préparation ne se voit pas si Neeko est déguisée.",
          tooltip:
            "Après {{ delayuntilreveal }} sec de préparation, Neeko bondit dans les airs. Elle s'entoure d'un bouclier capable d'absorber {{ baseshield }} pts de dégâts (+{{ shieldmultiplier }} par champion ennemi proche).<br /><br />Quand Neeko atterrit, elle inflige {{ totaldamage }} pts de dégâts magiques aux ennemis proches et les étourdit pendant {{ ccduration }} sec.<br /><br />Cette compétence peut être préparée en secret si Neeko est déguisée.",
          leveltip: {
            label: ["Dégâts", "PV du bouclier", "Bouclier par champion"],
            effect: [
              "{{ damage }} -> {{ damageNL }}",
      ...
      passive: {
        name: "Mirage inné",
        description:
          "Neeko peut prendre l'apparence d'un champion allié. Se faire blesser par un champion ennemi ou lancer un sort infligeant des dégâts met fin au déguisement.",
        image: {
          full: "Neeko_P.png",
          sprite: "passive2.png",
          group: "passive",
