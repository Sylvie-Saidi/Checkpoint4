const Jayce2 = {
  ...
  data: {
    Jayce: {
      ...
      skins: [
        { id: "126000", num: 0, name: "default", chromas: false },
        { id: "126001", num: 1, name: "Full Metal Jayce", chromas: false },
        { id: "126002", num: 2, name: "Jayce séducteur", chromas: false },
        { id: "126003", num: 3, name: "Jayce déchu", chromas: false },
        { id: "126004", num: 4, name: "Jayce marteau radieux", chromas: false },
        {
          id: "126005",
          num: 5,
      ...
      spells: [
        {
          ...
          description:
            "Marteau : bondit sur un ennemi, infligeant des dégâts physiques et ralentissant les ennemis.<br><br>Canon : tire un orbe qui explose en touchant un ennemi ou en arrivant au bout de sa course, infligeant des dégâts physiques à tous les ennemis touchés.",
          tooltip:
            "Bondit sur un ennemi, infligeant <physicalDamage>{{ damage }} pts de dégâts physiques</physicalDamage> aux ennemis proches et les ralentissant de {{ slow*-100 }}% pendant {{ slowduration }} sec.",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Marteau - Passive : rend du mana à chaque attaque.<br>Active : crée un champ d'électricité qui blesse les ennemis proches pendant plusieurs secondes.<br><br>Canon : provoque une poussée d'énergie, augmentant la vitesse d'attaque au maximum pour plusieurs attaques.",
          tooltip:
            "<spellPassive>Passive :</spellPassive> avec le marteau, vous récupérez {{ managain }} pts de mana par attaque.<br /><br /><spellPassive>Active :</spellPassive> crée un champ d'électricité qui inflige <magicDamage>{{ damage }} pts de dégâts magiques</magicDamage> en {{ duration }} sec aux ennemis proches.",
          leveltip: {
            label: ["Dégâts", "Restauration du mana"],
            effect: [
              "{{ basedamage }} -> {{ basedamageNL }}",
              "{{ managain }} -> {{ managainNL }}",
            ],
      ...
      passive: {
        ...
        description:
          "Après avoir activé Transformation, Jayce augmente sa vitesse de déplacement de 40 et peut traverser les unités pendant 1,25 sec.",
        image: {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                { id: "3155", count: 1, hideCount: false },
              ],
            },
            {
              type: "consumables",
