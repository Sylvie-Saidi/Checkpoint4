const Warwick2 = {
  ...
  data: {
    Warwick: {
      ...
      skins: [
        { id: "19000", num: 0, name: "default", chromas: false },
        { id: "19001", num: 1, name: "Warwick gris", chromas: true },
        { id: "19002", num: 2, name: "Urf le lamantin", chromas: false },
        { id: "19003", num: 3, name: "Grand méchant Warwick", chromas: false },
        { id: "19004", num: 4, name: "Warwick de la toundra", chromas: false },
        { id: "19005", num: 5, name: "Warwick sauvage", chromas: false },
        { id: "19006", num: 6, name: "Warwick de feu", chromas: false },
        { id: "19007", num: 7, name: "Warwick hyène", chromas: false },
        { id: "19008", num: 8, name: "Warwick maraudeur", chromas: false },
        { id: "19009", num: 9, name: "Urfwick", chromas: false },
        {
          id: "19010",
          num: 10,
        ...
        { id: "19016", num: 16, name: "PROJET : Warwick", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Warwick se jette en avant et mord sa cible, infligeant des dégâts en fonction des PV max de cette cible et récupérant des PV équivalents à une partie des dégâts infligés.",
          tooltip:
            'Warwick se jette en avant et mord sa cible. Si la touche est maintenue, Warwick <span class="colorFFEB7F">se lie</span> à sa cible et saute derrière elle.<br /><br />Quand la touche est relâchée, Warwick inflige des dégâts magiques équivalents à <scaleAD>{{ a1 }}</scaleAD><scaleAP> +{{ a2 }}</scaleAP> plus {{ e1 }}% des PV max de la cible (applique les effets à l\'impact). Rend des PV équivalents à {{ e3 }}% des dégâts infligés.<br /><br /><span class="size16 color8C8C8C">Tant que Warwick est <span class="size16 colorFFEB7F">lié</span> à sa cible, il suit tous ses déplacements et les ennemis ne peuvent pas le faire bouger.</span>',
          leveltip: {
            label: [
              "Soins",
        ...
        },
        {
          ...
          description:
            "Warwick repère les ennemis qui ont moins de 50% de leurs PV et obtient contre eux des bonus en vitesse de déplacement et en vitesse d'attaque. Contre les ennemis qui ont moins de 20% de leurs PV, ces bonus sont triplés.",
          tooltip:
            "<span class=\"colorFF9900\"></span><spellPassive>Passive : </spellPassive>Warwick augmente sa vitesse d'attaque de {{ e2 }}% contre les ennemis qui ont moins de 50% de leurs PV. Il repère également sur toute la carte les champions qui ont peu de PV, ce qui lui permet de se déplacer {{ e1 }}% plus vite vers eux en dehors des combats. Ces bonus sont triplés contre les ennemis qui ont moins de 20% de leurs PV.<br /><br /><spellPassive>Active : </spellPassive>Warwick repère brièvement tous les ennemis. Le plus proche champion repéré est traqué pendant 8 sec. Utilisable seulement quand Warwick n'est pas au combat contre un champion.<br /><br />Quand aucun ennemi n'est traqué, le délai de récupération de Traque sanguinaire est deux fois plus rapide.",
          leveltip: {
            label: [
        ...
        },
        {
          ...
          description:
            "Warwick gagne de la réduction des dégâts pendant 2,5 sec. À la fin, ou si la compétence est réactivée, il hurle, ce qui fait fuir les ennemis proches pendant 1 sec.",
          tooltip:
            "Warwick obtient {{ e1 }}% de réduction des dégâts pendant 2,5 sec. À la fin de cette durée, ou si la compétence est réactivée, Warwick hurle, ce qui fait fuir tous les ennemis proches pendant {{ e3 }} sec.",
          leveltip: {
            label: ["Réduction des dégâts", "Délai de récupération"],
            effect: [
              "{{ e1 }}% -> {{ e1NL }}%",
              "{{ cooldown }} -> {{ cooldownNL }}",
            ],
        ...
        },
        {
          ...
          description:
            "Warwick bondit dans une direction (la distance augmente avec sa vitesse de déplacement supplémentaire) et neutralise le premier champion qu'il touche pendant 1,5 sec.",
          tooltip:
            "Warwick saute dans une direction sur une distance équivalente à 2,5 sec de déplacement, neutralisant le premier champion touché pendant {{ rduration }} sec. Inflige <magicDamage>{{ damagecumulative }}</magicDamage> pts de dégâts magiques et applique 3 fois les effets à l'impact. Warwick récupère des PV équivalents à 100% des dégâts qu'il inflige pendant Contrainte infinie.",
          leveltip: {
      ...
      passive: {
        ...
        description:
          "Les attaques de base de Warwick infligent des dégâts magiques supplémentaires. Si Warwick a moins de 50% de ses PV, il récupère des PV équivalents à ces dégâts. Si Warwick a moins de 25% de ses PV, le montant rendu est triplé.",
        image: {
          full: "WarwickP.png",
          sprite: "passive4.png",
          group: "passive",
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                { id: "1006", count: 1, hideCount: false },
                { id: "3340", count: 1, hideCount: false },
              ],
            },
            {
