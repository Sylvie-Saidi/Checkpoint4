...
const Taric2 = {
  ...
  data: {
    Taric: {
      ...
      skins: [
        { id: "44000", num: 0, name: "default", chromas: false },
        { id: "44001", num: 1, name: "Taric émeraude", chromas: false },
        { id: "44002", num: 2, name: "Taric du cinquième âge", chromas: false },
        { id: "44003", num: 3, name: "Taric hémolithe", chromas: false },
        { id: "44004", num: 4, name: "Taric à Malibu", chromas: true },
        { id: "44009", num: 9, name: "Taric Clair-Pavois", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Rend des PV aux champions alliés proches en fonction du nombre de charges stockées. Les attaques renforcées par Plastronneur octroient une charge de Bénédiction stellaire.",
          tooltip:
            "Consomme toutes les charges pour rendre {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> <scaleHealth>(+{{ f1 }})</scaleHealth> ({{ e2 }}% des PV max) PV par charge aux champions alliés proches, jusqu'à {{ e5 }} <scaleAP>(+{{ f3 }})</scaleAP> <scaleHealth>(+{{ f2 }})</scaleHealth> PV avec le maximum de charges.<br />Charges max : {{ e6 }}<br /><br />Les attaques renforcées par Plastronneur octroient 1 charge de Bénédiction stellaire.",
          leveltip: {
            label: [
              "Charges max",
              "Soins max",
          ...
          costType: " pts de mana, toutes les charges",
          maxammo: "-1",
          ...
          resource: "{{ cost }} pts de mana, toutes les charges",
        },
        {
          id: "TaricW",
          name: "Bastion",
          description:
            "Augmente passivement l'armure de Taric et de tout champion allié affecté par Bastion.<br><br>À l'activation, offre un bouclier à un allié et ce dernier bénéficie de l'effet Bastion aussi longtemps qu'il reste près de Taric. Les sorts de Taric se lancent également depuis l'allié affecté par Bastion.",
          tooltip:
            "Les sorts de Taric se lancent aussi depuis un allié proche protégé par Bastion.<br /><br /><spellPassive>Passive : </spellPassive>Bastion augmente l'armure de <scaleArmor>{{ f1 }}</scaleArmor> ({{ e1 }}% de l'armure de Taric).<br /><br /><spellPassive>Active : </spellPassive>offre à un allié un bouclier équivalent à {{ e2 }}% des PV max de cet allié pendant {{ e3 }} sec. Bastion persiste sur cette cible jusqu'à ce qu'une nouvelle cible soit choisie.",
          leveltip: {
            label: [
        ...
        },
        {
          ...
          name: "Éblouissement",
          description:
            "Taric prépare un rayon de lumière stellaire qui, après un bref délai, inflige des dégâts magiques et étourdit les ennemis.",
          tooltip:
            "Prépare un rayon de lumière stellaire qui, après {{ e3 }} sec de délai, inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> <scaleArmor>(+{{ f1 }})</scaleArmor> pts de dégâts magiques et étourdit les ennemis pendant {{ e2 }} sec.",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Après un délai, nimbe les champions alliés proches d'énergie cosmique, les rendant invulnérables pendant un court instant.",
          tooltip:
            "Après {{ initialdelay }} sec de délai, nimbe les champions alliés proches d'énergie cosmique, les rendant invulnérables pendant {{ invulnduration }} sec.",
          leveltip: {
      ...
      passive: {
        name: "Plastronneur",
        description:
          "Lancer des sorts renforce les 2 prochaines attaques de base de Taric, leur permettant d'infliger des dégâts magiques supplémentaires, de réduire les délais de récupération de ses sorts et de s'enchaîner rapidement.",
        image: {
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                { id: "3047", count: 1, hideCount: false },
                { id: "2045", count: 1, hideCount: false },
