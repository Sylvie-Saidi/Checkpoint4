import TwistedFate2 from "./TwistedFate2";
...
const Twitch = {
  ...
  data: {
    Twitch: {
      ...
      skins: [
        { id: "29000", num: 0, name: "default", chromas: false },
        { id: "29001", num: 1, name: "Twitch le boss", chromas: false },
        { id: "29002", num: 2, name: "Twitch de Whistler", chromas: false },
        { id: "29003", num: 3, name: "Twitch médiéval", chromas: true },
        { id: "29004", num: 4, name: "Twitch gangster", chromas: false },
        { id: "29005", num: 5, name: "Twitch Vandale", chromas: false },
        { id: "29006", num: 6, name: "Twitch pickpocket", chromas: false },
        { id: "29007", num: 7, name: "SSW Twitch", chromas: false },
        {
          id: "29008",
          num: 8,
        ...
        { id: "29012", num: 12, name: "Twitch roi des glaces", chromas: true },
        { id: "29027", num: 27, name: "Twitch Sombrepas", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Embuscade",
          description:
            "Twitch se camoufle pendant un court instant et sa vitesse de déplacement est augmentée. Quand il quitte son camouflage, sa vitesse d'attaque est augmentée pendant un court instant.<br><br>Quand un champion ennemi affecté par Venin mortel meurt, le délai de récupération d'Embuscade est réinitialisé.",
          tooltip:
            "Twitch se <span class=\"colorcd90ee\">camoufle</span> et sa vitesse de déplacement augmente de {{ e3 }}% pendant {{ e2 }} sec. Ce bonus est triplé quand Twitch est près d'un champion ennemi qui ne peut pas le voir. <br /><br />Quand Twitch quitte Embuscade, sa vitesse d'attaque augmente de {{ e1 }}% pendant {{ e6 }} sec. Embuscade est réinitialisée quand un champion affecté par <span class=\"color3ca126\">Venin mortel</span> meurt.<br /><br /><font color='#cd90ee'size='16'><u>Furtivité - Camouflage :</u></span> <font color='#8C8C8C'size='16'>Twitch est impossible à voir tant que les champions ennemis restent hors de son rayon de détection. Attaquer ou lancer des sorts met fin au camouflage.</span>",
          leveltip: {
            label: ["Durée du camouflage", "Vitesse d'attaque"],
            effect: ["{{ e2 }} -> {{ e2NL }}", "{{ e1 }}% -> {{ e1NL }}%"],
          },
          maxrank: 5,
        ...
        },
        {
          ...
          tooltip:
            'Twitch lance une fiole qui ajoute un effet <span class="color3ca126">Venin mortel</span> sur tous les ennemis touchés et laisse un nuage toxique qui persiste pendant {{ e3 }} sec.<br /><br />Les ennemis qui restent dans le nuage sont ralentis de {{ e2 }}% et reçoivent chaque seconde un effet <span class="color3ca126">Venin mortel</span> supplémentaire.',
          leveltip: {
            label: ["Ralentissement", "Délai de récupération"],
            effect: [
              "{{ e2 }}% -> {{ e2NL }}%",
              "{{ cooldown }} -> {{ cooldownNL }}",
            ],
        ...
        },
        {
          ...
          name: "Contamination",
          description:
            "Twitch contamine encore plus les ennemis empoisonnés avec de terribles maladies.",
          tooltip:
            'Inflige {{ e2 }} pts de dégâts physiques plus {{ e1 }}<scaleAP> (+{{ a1 }})</scaleAP> <scaleAD>(+{{ f1 }})</scaleAD> par effet <span class="color3ca126">Venin mortel</span> à tous les ennemis proches affectés par <span class="color3ca126">Venin mortel</span> <span class="colora3554e">(dégâts au maximum d\'effets : {{ f2 }}).</span>',
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          name: "Panique",
          description:
            "Twitch libère toute la puissance de son arbalète, tirant des carreaux à longue portée qui transpercent tous les ennemis touchés.",
          tooltip:
            "Pendant {{ e2 }} sec, Twitch gagne un bonus de {{ e5 }} en portée d'attaque et de {{ e1 }} en dégâts d'attaque supplémentaires.<br /><br />Pendant la même durée, ses attaques de base deviennent des carreaux perforants qui infligent {{ e3 }}% de dégâts en moins aux cibles subséquentes, jusqu'à un minimum de {{ e4 }}% de dégâts.<br /><br /><font color='#cd90ee'size='16'><u>Furtivité - Camouflage :</u></span> <font color='#8C8C8C'size='16'>activer Panique ne met pas fin au camouflage.</span>",
          leveltip: {
      ...
      passive: {
        name: "Venin mortel",
        description:
          "Les attaques de base de Twitch contaminent sa cible, lui infligeant des dégâts bruts chaque seconde.",
        image: {
