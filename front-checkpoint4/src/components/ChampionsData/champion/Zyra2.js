...
const Zyra2 = {
  ...
  data: {
    Zyra: {
      ...
      skins: [
        { id: "143000", num: 0, name: "default", chromas: false },
        { id: "143001", num: 1, name: "Zyra magmatique", chromas: false },
        { id: "143002", num: 2, name: "Zyra hantée", chromas: false },
        { id: "143003", num: 3, name: "SKT T1 Zyra", chromas: false },
        {
          id: "143004",
          num: 4,
        ...
        { id: "143005", num: 5, name: "Zyra de l'assemblée", chromas: false },
        {
          id: "143006",
          num: 6,
          name: "Zyra de l'assemblée édition prestige",
          chromas: false,
        },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Des ronces se répandent dans le sol et provoquent une explosion d'épines, infligeant des dégâts magiques aux ennemis dans la zone. Si le sort est lancé près d'une graine, Épines funestes fait pousser une Cracheuse de ronces qui tire sur les ennemis de loin.",
          tooltip:
            "Des ronces se répandent dans le sol et provoquent une explosion d'épines, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis dans la zone. <br /><br /><span class=\"colorDDDD77\">Jardin de ronces : </span>si les Épines funestes sont lancées près d'une graine, cela fait pousser une Cracheuse de ronces qui inflige {{ f1 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts magiques. La Cracheuse de ronces a 575 de portée et dure {{ f2 }} sec.",
          leveltip: {
          ...
          vars: [
            ...
            { link: "spelldamage", coeff: 0.15, key: "a2" },
          ],
        ...
        },
        {
          ...
          description:
            "Zyra plante une graine qui dure jusqu'à 60 sec. Lancer Épines funestes ou Racines fixatrices près des graines les change en plantes qui combattront pour Zyra. Zyra peut stocker plusieurs graines. Tuer des ennemis réduit le délai de rechargement de Croissance incontrôlée.",
          tooltip:
            'Plante une graine qui dure {{ e6 }} sec. Si un champion ennemi marche sur une graine, celle-ci est détruite. Les graines de Croissance incontrôlée octroient de la vision dans une petite zone et, si un champion ennemi marche dessus, octroient une <span class="coloree91d7">vision pure</span> de ce champion pendant {{ e3 }} sec.<br /><br />Zyra stocke une graine toutes les <scaleLevel>{{ ammorechargetime }}</scaleLevel> sec (max : 8 graines plantées). À chaque fois qu\'elle tue un ennemi, le délai de rechargement de Croissance incontrôlée est réduit de {{ e1 }}% ({{ e2 }}% pour les champions tués, les assistances, les grands sbires tués et les grands monstres tués).',
          leveltip: {
            label: ["Délai de rechargement des graines"],
        ...
        },
        {
          ...
          description:
            "Zyra lance des racines à travers le sol pour capturer sa cible, infligeant des dégâts et immobilisant les ennemis qu'elles touchent. Si le sort est lancé près d'une graine, Racines fixatrices fait pousser une Plante flagellante dont les attaques à courte portée réduisent la vitesse de déplacement des ennemis.",
          tooltip:
            "Lance des racines qui infligent {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et immobilisent les ennemis pendant {{ e5 }} sec.<br /><br /><span class=\"colorDDDD77\">Jardin de ronces : </span>si les Racines fixatrices passent près d'une graine, cela fait pousser une Plante flagellante qui inflige {{ f1 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts magiques et qui ralentit les ennemis de {{ e2 }}% pendant {{ e3 }} sec. Les ralentissements de multiples Plantes flagellantes se cumulent jusqu'à {{ maxslowstacks }} fois. La Plante flagellante a 400 de portée et dure {{ f2 }} sec.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Zyra invoque des ronces malfaisantes dans la zone ciblée, infligeant des dégâts aux ennemis en s'étendant avant de les projeter en l'air. Les plantes dans les ronces deviennent enragées.",
          tooltip:
            "Invoque la fureur de la nature, créant dans la zone ciblée des ronces malfaisantes qui infligent {{ e3 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques à tous les ennemis dans la zone en s'étendant. Au bout de 2 sec, les ronces se tendent et projettent les ennemis dans les airs pendant {{ e1 }} sec.<br /><br /><span class=\"colorDDDD77\">Jardin de ronces : </span>les plantes dans les ronces deviennent enragées, ce qui réinitialise leur durée, augmente leurs PV de {{ e2 }}% et leur permet de lancer une rafale d'attaques infligeant {{ e7 }}% de dégâts au total.",
          leveltip: {
            label: ["Dégâts", "Délai de récupération"],
            effect: [
              "{{ e3 }} -> {{ e3NL }}",
      ...
      passive: {
        ...
        description:
          "Des graines apparaissent régulièrement autour de Zyra, de plus en plus souvent au fur et à mesure qu'elle gagne des niveaux. Zyra peut lancer Épines funestes ou Racines fixatrices près des graines pour faire pousser des plantes qui combattront pour elle.",
        image: {
          full: "ZyraP.png",
          sprite: "passive4.png",
          group: "passive",
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              minSummonerLevel: -1,
              maxSummonerLevel: -1,
              showIfSummonerSpell: "SummonerReturn",
              hideIfSummonerSpell: "",
              appendAfterSection: "",
              visibleWithAllOf: [""],
              hiddenWithAnyOf: [""],
