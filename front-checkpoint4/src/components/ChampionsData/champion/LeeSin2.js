...
const LeeSin2 = {
  ...
  data: {
    LeeSin: {
      ...
      skins: [
        { id: "64000", num: 0, name: "default", chromas: false },
        { id: "64001", num: 1, name: "Lee Sin classique", chromas: false },
        { id: "64002", num: 2, name: "Lee Sin acolyte", chromas: false },
        { id: "64003", num: 3, name: "Lee Sin poing du dragon", chromas: true },
        { id: "64004", num: 4, name: "Lee Sin muay thaï", chromas: false },
        { id: "64005", num: 5, name: "Lee piSin", chromas: false },
        { id: "64006", num: 6, name: "SKT T1 Lee Sin", chromas: false },
        { id: "64010", num: 10, name: "Lee Sin pugiliste", chromas: false },
        { id: "64011", num: 11, name: "Lee Sin poing divin", chromas: false },
        { id: "64012", num: 12, name: "Lee Sin meneur de jeu", chromas: true },
        {
          id: "64027",
          num: 27,
        ...
        },
        {
          id: "64028",
          num: 28,
          name: "Lee Sin héraut de la nuit édition prestige",
          chromas: false,
        },
        { id: "64029", num: 29, name: "FPX Lee Sin", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          tooltip:
            "<spellActive>Onde sonore : </spellActive>Lee Sin émet une onde sonore pour localiser ses ennemis, infligeant {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques au premier ennemi touché et obtenant une <keywordMajor>vision pure</keywordMajor> de cet ennemi. <specialRules>Si Onde sonore touche un ennemi, Lee Sin peut lancer Coup résonant dans les {{ e7 }} sec qui suivent.</specialRules><br /><br /><spellActive>Coup résonant : </spellActive>Lee Sin fonce vers l'ennemi touché par Onde sonore, lui infligeant de {{ e2 }} <scaleAD>(+{{ a1 }})</scaleAD> à {{ e3 }} <scaleAD>(+{{ a2 }})</scaleAD> pts de dégâts physiques, selon les PV manquants de la cible.",
          leveltip: {
            label: [
              "Dégâts d'Onde sonore",
          ...
          vars: [
            { link: "bonusattackdamage", coeff: 1, key: "a1" },
            { link: "bonusattackdamage", coeff: 1, key: "a1" },
            { link: "bonusattackdamage", coeff: 2, key: "a2" },
          ],
        ...
        },
        {
          ...
          description:
            "Rempart : Lee Sin fonce vers l'allié ciblé, se protégeant contre les dégâts. Si l'allié est un champion, il est également protégé. Après avoir lancé Rempart, Lee Sin peut lancer Force d'âme dans les 3 sec qui suivent.<br>Force d'âme : l'entraînement intense de Lee Sin lui permet de décupler ses forces pendant un combat. Pendant 4 sec, Lee Sin augmente ses effets Vol de vie et Sort vampirique.",
          tooltip:
            "<spellActive>Rempart : </spellActive>Lee Sin fonce vers l'allié ciblé. Si l'allié est un champion, ils reçoivent tous deux un bouclier les protégeant contre {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts pendant {{ e3 }} sec et le délai de récupération de Rempart est réduit de {{ e6 }}%. <specialRules>Après avoir lancé Rempart, Lee Sin peut lancer Force d'âme dans les {{ e9 }} sec qui suivent.</specialRules><br /><br /><spellActive>Force d'âme : </spellActive>Lee Sin augmente ses effets Vol de vie et Sort vampirique de {{ e2 }}% pendant {{ e8 }} sec.",
          leveltip: {
            label: [
              "Absorption du bouclier de Rempart",
        ...
        },
        {
          ...
          description:
            "Trombe : Lee Sin frappe le sol, envoyant une onde de choc qui inflige des dégâts magiques et révèle les unités ennemies touchées. Si Trombe touche un ennemi, Lee Sin peut lancer Fracture dans les 3 sec qui suivent.<br>Fracture : Lee Sin estropie les ennemis proches blessés par Trombe, réduisant leur vitesse de déplacement pendant 4 sec. La vitesse de déplacement revient peu à peu à la normale pendant la durée du sort.",
          tooltip:
            "<spellActive>Trombe : </spellActive>Lee Sin frappe le sol, envoyant une onde de choc qui inflige {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts magiques. <specialRules>Si Trombe touche un ennemi, Lee Sin peut lancer Fracture dans les {{ e6 }} sec qui suivent.</specialRules><br /><br /><spellActive>Fracture : </spellActive>Lee Sin estropie les ennemis proches blessés par Trombe pendant {{ e5 }} sec, réduisant leur vitesse de déplacement de {{ e2 }}%. La vitesse de déplacement revient peu à peu à la normale pendant la durée du sort.",
          leveltip: {
            label: ["Dégâts de Trombe", "Ralentissement de Fracture"],
            effect: ["{{ e1 }} -> {{ e1NL }}", "{{ e2 }}% -> {{ e2NL }}%"],
          },
          maxrank: 5,
        ...
        },
        {
          ...
          tooltip:
            "Lee Sin donne un puissant coup de pied qui projette un champion ennemi en arrière, infligeant <physicalDamage>{{ damage }}</physicalDamage> pts de dégâts physiques.<br /><br />Les ennemis percutés par la cible sont projetés en l'air un court instant et subissent des dégâts physiques équivalents à <physicalDamage>{{ damage }}</physicalDamage> plus {{ percenthpcarrythrough }}% des PV supplémentaires de la cible initiale.",
          leveltip: {
            label: [
              "Dégâts",
      ...
      passive: {
        name: "Rafale",
        description:
          "Après avoir utilisé une compétence, Lee Sin voit sa vitesse d'attaque augmenter pour ses 2 prochaines attaques de base. Ces attaques accélérées lui rendent de l'énergie.",
        image: {
