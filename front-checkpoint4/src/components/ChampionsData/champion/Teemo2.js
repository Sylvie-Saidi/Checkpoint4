...
const Teemo2 = {
  ...
  data: {
    Teemo: {
      ...
      skins: [
        { id: "17000", num: 0, name: "default", chromas: false },
        { id: "17001", num: 1, name: "Teemo l'elfe heureux", chromas: false },
        { id: "17002", num: 2, name: "Teemo éclaireur", chromas: false },
        { id: "17003", num: 3, name: "Teemo blaireau", chromas: false },
        { id: "17004", num: 4, name: "Teemo astronaute", chromas: false },
        { id: "17005", num: 5, name: "Teemo lapin", chromas: true },
        { id: "17006", num: 6, name: "Super Teemo", chromas: false },
        { id: "17007", num: 7, name: "Teemo panda", chromas: false },
        {
          id: "17008",
          num: 8,
        ...
        { id: "17014", num: 14, name: "Teemo diablotin", chromas: false },
        { id: "17018", num: 18, name: "Teemo abeille", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Un puissant venin obscurcit la vue de l'ennemi, infligeant des dégâts à la cible et l'aveuglant pendant la durée de l'effet.",
          tooltip:
            "Inflige {{ calculateddamage }} pts de dégâts magiques et aveugle la cible pendant {{ blindduration }} sec. ",
          leveltip: {
            label: ["Dégâts", "Durée", "Coût en @AbilityResourceName@"],
            effect: [
        ...
        },
        {
          ...
          name: "Vélocité",
          description:
            "La vitesse de déplacement de Teemo est passivement augmentée jusqu'à ce qu'il soit frappé par un champion ennemi ou une tourelle ennemie. Teemo peut sprinter pour gagner un bonus temporaire en vitesse de déplacement qui n'est pas annulé si Teemo est touché.",
          tooltip:
            "<spellPassive>Passive :</spellPassive> la vitesse de déplacement de Teemo est augmentée de {{ passivemsbonus*100 }}%, sauf s'il a été blessé par un champion ennemi ou une tourelle ennemie il y a moins de 5 sec.<br /><br /><spellPassive>Active :</spellPassive> Teemo sprinte, doublant son bonus passif pendant {{ msbuffduration }} sec. Les dégâts ne dissipent pas ce bonus.",
          leveltip: {
            label: ["Vitesse de déplacement"],
            effect: [
              "{{ passivemsbonus*100.000000 }}% -> {{ passivemsbonusnl*100.000000 }}%",
            ],
          },
          maxrank: 5,
        ...
        },
        {
          ...
          name: "Tir toxique",
          description:
            "Toutes les attaques de Teemo empoisonnent la cible, infligeant des dégâts à l'impact puis chaque seconde pendant 4 secondes.",
          tooltip:
            "Les attaques de base de Teemo empoisonnent ses cibles, infligeant {{ impactcalculateddamage }} pts de dégâts magiques à l'impact, puis {{ tickcalculateddamage }} pts de dégâts magiques chaque seconde pendant {{ poisonduration }} sec.",
          leveltip: {
            label: ["Dégâts à l'impact", "Dégâts par seconde"],
            effect: [
        ...
        },
        {
          ...
          name: "Piège nocif",
          description:
            "Teemo se sert d'un des champignons stockés dans son sac à dos pour lancer un piège explosif. Si un ennemi marche sur le piège, un nuage empoisonné s'en échappe, ralentit les ennemis et leur inflige des dégâts sur la durée. Les champignons lancés sur d'autres champignons rebondissent et ont ainsi une plus grande portée.",
          tooltip:
            "Utilise un champignon stocké pour lancer un piège. Si un ennemi marche dessus, le piège explose et empoisonne tous les ennemis proches, réduisant leur vitesse de déplacement de {{ slowamount }}%, les révélant et leur infligeant {{ totaldamage }} pts de dégâts magiques en {{ debuffduration }} sec. <br /><br />Les pièges durent {{ mushroomduration }} minutes et il leur faut {{ armtime }} sec pour s'amorcer et se camoufler. Teemo peut stocker jusqu'à {{ maxammo }} pièges à la fois. Si un piège atterrit sur un autre piège, il rebondit jusqu'à <span class=\"colorFFFF99\">{{ bouncedistance }}</span> Teemo plus loin avant de se planter dans le sol.",
          leveltip: {
            label: [
              "Dégâts",
              "Ralentissement",
      ...
      passive: {
        name: "Guérilla",
        description:
          "Si Teemo reste immobile et sans agir pendant un court instant, il devient invisible indéfiniment. Dans les herbes hautes, Teemo peut activer et maintenir son invisibilité tout en se déplaçant. Quand il quitte son invisibilité, Teemo profite de l'Effet de surprise, augmentant sa vitesse d'attaque pendant 3 sec.",
        image: {
          full: "Teemo_P.png",
          sprite: "passive3.png",
          group: "passive",
