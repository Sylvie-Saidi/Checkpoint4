const Bard2 = {
  ...
  data: {
    Bard: {
      ...
      skins: [
        { id: "432000", num: 0, name: "default", chromas: true },
        { id: "432001", num: 1, name: "Bard sylvestre", chromas: false },
        { id: "432005", num: 5, name: "Bard des neiges", chromas: true },
        { id: "432006", num: 6, name: "Bard le barde", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          tooltip:
            "Bard tire un trait d'énergie, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques à un ou deux ennemis. La première cible touchée sera ralentie de {{ e3 }}% pendant {{ e4 }} sec.<br /><br />Si le trait d'énergie touche un autre ennemi ou un mur, tout ennemi touché est étourdi pendant {{ e2 }} sec.<br />",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          tooltip:
            'Bard fait apparaître un sanctuaire de soin qui offre immédiatement {{ e5 }} <scaleAP>(+{{ a1 }})</scaleAP> PV. Le sanctuaire gagne en puissance pendant 10 sec et peut rendre jusqu\'à {{ e6 }} <scaleAP>(+{{ a2 }})</scaleAP> PV. Il offre également un bonus de {{ e1 }}% en vitesse de déplacement qui diminue en {{ e2 }} sec. <br /><br />Bard peut activer jusqu\'à {{ e3 }} sanctuaires simultanément, lesquels ne disparaissent que si un champion allié les touche ou si un champion ennemi les écrase.<br /><br /><span class="colorFFCC00">Sanctuaires actifs : </span><scaleLevel>{{ f1 }}</scaleLevel> / <span class="colorFFCC00">{{ f2 }}</span><br />',
          leveltip: {
            label: ["Soins de base", "Soins max"],
            effect: ["{{ e5 }} -> {{ e5NL }}", "{{ e6 }} -> {{ e6NL }}"],
          },
          maxrank: 5,
        ...
        },
        {
          ...
          tooltip:
            "Bard ouvre un tunnel à sens unique dans un élément du décor proche. Les alliés et les ennemis proches de l'entrée peuvent tous utiliser ce tunnel en cliquant dessus avec le bouton droit, mais seule la vitesse des alliés est augmentée de {{ e2 }}%.<br /><br />Le tunnel disparaît au bout de {{ e1 }} sec.<br />",
          leveltip: {
        ...
        },
        {
          ...
          tooltip:
            "Bard envoie de l'énergie magique dans une zone. À l'impact, tous les champions, sbires, monstres et tourelles dans la zone sont mis en stase, devenant invincibles, impossibles à cibler et incapables d'agir pendant {{ rstasisduration }} sec.<br /><br />Les monstres épiques sont également mis en stase, bien qu'ils soient normalement insensibles aux entraves.",
          leveltip: {
            label: ["Délai de récupération"],
            effect: ["{{ cooldown }} -> {{ cooldownNL }}"],
          },
      ...
      passive: {
        ...
        description:
          "La présence de Bard fait apparaître des carillons magiques. Quand Bard collecte un carillon, il gagne de l'expérience, du mana et un bonus en vitesse de déplacement. De plus, des esprits inférieurs appelés Meeps suivent Bard et renforcent ses attaques. Collecter des carillons augmente peu à peu la puissance des Meeps.",
        image: {
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              maxSummonerLevel: -1,
              showIfSummonerSpell: "",
              hideIfSummonerSpell: "SummonerDarkStarChampSelect1",
              appendAfterSection: "",
              visibleWithAllOf: [""],
              hiddenWithAnyOf: [""],
              items: [
