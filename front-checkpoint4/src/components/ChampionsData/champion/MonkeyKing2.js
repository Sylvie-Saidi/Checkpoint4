...
const MonkeyKing2 = {
  ...
  data: {
    MonkeyKing: {
      ...
      skins: [
        { id: "62000", num: 0, name: "default", chromas: false },
        { id: "62001", num: 1, name: "Wukong volcanique", chromas: false },
        { id: "62002", num: 2, name: "Général Wukong", chromas: false },
        { id: "62003", num: 3, name: "Wukong dragon de jade", chromas: false },
        { id: "62004", num: 4, name: "Wukong des enfers", chromas: false },
        { id: "62005", num: 5, name: "Wukong radieux", chromas: false },
        { id: "62006", num: 6, name: "Wukong Lancier Stratus", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Écrasement",
          description:
            "La prochaine attaque de Wukong a une plus longue portée, inflige des dégâts supplémentaires et réduit l'armure de la cible pendant quelques secondes.",
          tooltip:
            "La prochaine attaque de Wukong et de son clone a une portée augmentée de {{ attackrangebonus }}, inflige <physicalDamage>{{ totaldamage }} pts de dégâts physiques supplémentaires</physicalDamage> et réduit l'armure de la cible de {{ armorshredpercent*100 }}% pendant {{ shredduration }} sec.<br /><br />Le délai de récupération de Écrasement est réduit de {{ cooldowndecrease }} sec chaque fois que Wukong ou son clone touchent un ennemi avec une attaque de base ou un sort.",
          leveltip: {
            label: [
              "Dégâts",
              "% réduction d'armure",
        ...
        },
        {
          ...
          description:
            "Wukong devient <font color='#91d7ee'>invisible</font> et se rue dans une direction, laissant derrière lui un clone qui attaquera les ennemis proches.",
          tooltip:
            'Wukong se rue vers le curseur et devient <span class="color91d7ee">invisible</span> pendant {{ stealthduration }} sec, laissant derrière lui un clone immobile pendant {{ cloneduration }} sec.<br /><br />Le clone attaque les ennemis proches que Wukong a récemment blessés et imite sa compétence ultime, infligeant {{ clonedamagemod*100 }}% des dégâts normaux.',
          leveltip: {
            label: [
        ...
        },
        {
          ...
          name: "Nimbus",
          description:
            "Wukong se rue sur l'ennemi ciblé et envoie des images qui attaquent les ennemis proches de sa cible, infligeant des dégâts à chaque ennemi frappé.",
          tooltip:
            "Wukong se rue sur un ennemi et envoie des clones qui copient la ruée sur un maximum de {{ extratargets }} ennemis proches supplémentaires. Chaque ennemi touché subit <magicDamage>{{ totaldamage }} pts de dégâts magiques</magicDamage>. Wukong et son clone gagnent ensuite un bonus en vitesse d'attaque de {{ attackspeed*100 }}% pendant {{ attackspeedduration }} sec.<br />",
          leveltip: {
            label: [
              "Dégâts",
              "Vitesse d'attaque",
        ...
        },
        {
          ...
          name: "Cyclone",
          description:
            "Wukong agrandit son bâton et le fait tournoyer, ce qui augmente sa vitesse de déplacement.<br><br>Les ennemis touchés subissent des dégâts et sont projetés en l'air.",
          tooltip:
            "Wukong fait tournoyer son bâton pendant {{ spinduration }} sec, ce qui augmente sa vitesse de déplacement de {{ movespeed*100 }}%. Pendant le tournoiement, il inflige <physicalDamage>{{ damagepersecondtotal }} (+{{ percentmaxhpdmgpersec }}% des PV max de la cible) pts de dégâts physiques</physicalDamage> par seconde aux ennemis proches, en plus de les projeter en l'air pendant {{ knockupduration }} sec.<br /><br />Cyclone peut être lancé une seconde fois dans les {{ recastwindow }} sec avant d'entrer en phase de récupération.",
          leveltip: {
            label: [
      ...
      passive: {
        name: "Peau de pierre",
        description:
          "Wukong augmente son armure et la régénération de ses PV lorsqu'il est en combat avec des champions ou des monstres (effet cumulable).",
        image: {
          ...
          blocks: [
            {
              ...
              hideIfSummonerSpell: "",
              items: [
                { id: "1074", count: 1, hideCount: false },
                { id: "2003", count: 1, hideCount: false },
