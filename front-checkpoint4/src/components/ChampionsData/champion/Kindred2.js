...
const Kindred2 = {
  ...
  data: {
    Kindred: {
      ...
      skins: [
        { id: "203000", num: 0, name: "default", chromas: false },
        {
          id: "203001",
          num: 1,
      ...
      spells: [
        {
          ...
          tooltip:
            "Agneau fait une cabriole et tire sur un maximum de trois ennemis proches, infligeant {{ e1 }}<scaleAD> (+{{ a1 }})</scaleAD> pts de dégâts physiques et augmentant sa vitesse d'attaque de <scaleLevel>{{ f2 }}%</scaleLevel> pendant {{ e8 }} sec.<br /><br />Lancer <scaleLevel>Frénésie de Loup</scaleLevel> ou faire une cabriole dans la zone de ce sort réduit le délai de récupération de Danse des flèches à {{ e4 }} sec.",
          leveltip: {
            label: ["Dégâts", "Délai de récupération de Frénésie de Loup"],
            effect: ["{{ e1 }} -> {{ e1NL }}", "{{ e4 }} -> {{ e4NL }}"],
          },
          maxrank: 5,
          cooldown: [9, 9, 9, 9, 9],
          cooldownBurn: "9",
        ...
        },
        {
          ...
          tooltip:
            "<spellPassive>Passive :</spellPassive> Kindred cumule des effets de Vigueur du chasseur en se déplaçant et en attaquant, jusqu'à un maximum de 100. Au maximum d'effets cumulés, la prochaine attaque de base d'Agneau rend jusqu'à <scaleLevel>{{ f1 }}</scaleLevel> PV à Kindred, selon ses PV manquants.<br /><br /><spellPassive>Active :</spellPassive> Loup marque son territoire, attaquant les ennemis proches dans la zone pendant {{ e4 }} sec. Agneau peut l'orienter vers des cibles précises en les attaquant. Si Agneau quitte le territoire de Loup, ce dernier cesse d'attaquer et rejoint Agneau.<br /><br />Les attaques de Loup infligent des dégâts magiques équivalents à {{ e5 }}<scaleAD> (+{{ a1 }})</scaleAD> plus <scaleLevel>{{ f3 }}%</scaleLevel> des PV actuels de la cible.<br /><br /><rules>La vitesse d'attaque de Loup augmente avec celle de Kindred. Ses attaques estropient les monstres, leur infligeant {{ e7 }}% de dégâts supplémentaires et réduisant leur vitesse de déplacement de {{ e8 }}% pendant 2 sec.</rules>",
          leveltip: {
        ...
        },
        {
          ...
          tooltip:
            'Estropie un ennemi, réduisant sa vitesse de déplacement de {{ e2 }}% pendant {{ e8 }} sec.<br /><br />Après qu\'Agneau a attaqué deux fois la cible, sa troisième attaque envoie Loup sur l\'ennemi, infligeant des dégâts physiques supplémentaires équivalents à {{ e1 }}<scaleAD> (+{{ a1 }})</scaleAD> plus <scaleLevel>{{ f2 }}%</scaleLevel> des PV manquants de la cible.<br /><br />Si la cible a moins de {{ e5 }}% <span class="colorFF5802">(+{{ f3 }}%)</span> de ses PV (augmenté par les <span class="colorFF5802">chances de coup critique</span>), l\'attaque de Loup est un coup critique qui inflige {{ e6 }}% de dégâts supplémentaires.<br /><br /><rules>[{{ e0 }} max contre les monstres].</rules>',
          leveltip: {
            label: ["Dégâts", "Délai de récupération"],
            effect: [
              "{{ e1 }} -> {{ e1NL }}",
        ...
        },
        {
          ...
          tooltip:
            'Agneau bénit le sol sous ses pieds pendant {{ e2 }} sec, créant une zone dans laquelle aucune créature vivante, <scaleAP>alliée</scaleAP> ou <span class="colorFF9999">ennemie</span>, ne peut mourir. Une fois à 10% de leurs PV max, les unités deviennent insensibles aux dégâts et aux soins.<br /><br />Quand la bénédiction se termine, toutes les créatures vivantes dans la zone récupèrent {{ e1 }} PV.',
          leveltip: {
