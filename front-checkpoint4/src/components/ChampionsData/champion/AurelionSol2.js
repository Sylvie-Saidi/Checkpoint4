const AurelionSol2 = {
  ...
  data: {
    AurelionSol: {
      ...
      spells: [
        {
          ...
          name: "Stellogenèse",
          description:
            "Aurelion Sol crée un disque en expansion qui explose quand il s'éloigne trop d'Aurelion Sol, étourdissant et blessant les ennemis.",
          tooltip:
            "<spellPassive>Première activation : </spellPassive>Aurelion Sol crée un nouveau noyau stellaire, lequel grandit progressivement et augmente de {{ e2 }}% la vitesse de déplacement d'Aurelion Sol.<br /><br />Le noyau explose quand il atteint la <span class=\"color308BDB\">bordure extérieure</span> d'Aurelion Sol, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et un étourdissement de {{ effect4amount*.25 }} à {{ e4 }} sec, selon la taille du noyau.<br /><br /><spellPassive>Deuxième activation : </spellPassive>le noyau explose prématurément.<br />",
          leveltip: {
            label: [
              "Dégâts",
        ...
        {
          id: "AurelionSolW",
          name: "Expansion céleste",
          description:
            "Aurelion Sol éloigne ses étoiles, augmentant leurs dégâts et leur vitesse.",
          tooltip:
            "<spellPassive>Passive : </spellPassive>augmente les dégâts de base des étoiles de {{ starbasedamageincrease }}.<br /><br /><spellPassive>Active : </spellPassive>les étoiles d'Aurelion Sol vont jusqu'à sa <span class=\"color308BDB\">bordure extérieure</span>. Elles tournent alors plus rapidement et infligent {{ damagemultiplier*100 }}% de dégâts, pour un total de {{ f1 }} <scaleAP>(+{{ f2 }})</scaleAP> pts de dégâts magiques. À la réactivation ou après 3 sec, les étoiles se rétractent et Aurelion Sol gagne un bonus de 40% en vitesse de déplacement qui décroît en 1,5 sec.<br />",
          leveltip: {
            label: [
              "Dégâts supplémentaires passifs",
              "Délai de récupération",
              "Coût en mana",
            ],
            effect: [
        ...
        {
          id: "AurelionSolE",
          name: "Comète légendaire",
          description: "Aurelion Sol s'envole et parcourt une longue distance.",
          tooltip:
            "Aurelion Sol s'envole sur {{ e3 }} unités de distance dans la direction choisie. N'est activable qu'en dehors des combats. Aurelion Sol peut voir et être vu par-dessus les murs pendant qu'il vole.<br /><br />Aurelion Sol est forcé d'atterrir si un champion ou une tourelle lui inflige des dégâts.<br />",
          leveltip: {
            label: ["Portée du vol", "Vitesse de vol", "Délai de récupération"],
            effect: [
              "{{ e3 }} -> {{ e3NL }}",
              "{{ e4 }} -> {{ e4NL }}",
              "{{ cooldown }} -> {{ cooldownNL }}",
        ...
        },
        {
          ...
          name: "Cri de lumière",
          description:
            "Aurelion Sol tire une vague de feu stellaire pur, blessant et ralentissant tous les ennemis pris dans la vague et repoussant les ennemis proches.",
          tooltip:
            "Projette une vague de feu stellaire pur, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et ralentissant de {{ e2 }}% pendant {{ e3 }} sec. <br /><br />La vague repousse également les ennemis proches jusqu'à la <span class=\"color308BDB\">bordure extérieure</span> d'Aurelion Sol.<br />",
          leveltip: {
      ...
      passive: {
        name: "Centre de l'univers",
        description:
          "Trois étoiles orbitent autour d'Aurelion Sol, infligeant des dégâts magiques aux ennemis qu'elles touchent.",
        image: {
