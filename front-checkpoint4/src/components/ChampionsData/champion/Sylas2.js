...
const Sylas2 = {
  ...
  data: {
    Sylas: {
      ...
      skins: [
        { id: "517000", num: 0, name: "default", chromas: false },
        { id: "517001", num: 1, name: "Sylas spectre lunaire", chromas: true },
        { id: "517008", num: 8, name: "Sylas de Freljord", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Sylas donne un coup en croisant ses chaînes, infligeant des dégâts magiques à l'endroit ciblé et ralentissant les ennemis. <br><br>Après un délai, une explosion d'énergie magique se produit à l'intersection des chaînes, infligeant des dégâts.",
          tooltip:
            "Sylas donne un coup de chaînes dans une zone en X, infligeant <scaleAP>{{ damage }}</scaleAP> pts de dégâts magiques à l'endroit ciblé et ralentissant les ennemis de {{ slowamountcalc }} pendant {{ slowduration }} sec. <br /><br />Au bout de {{ detonationdelay }} sec, une explosion d'énergie magique se produit à l'intersection des chaînes, infligeant <scaleAP>{{ explosiondamage }}</scaleAP>.<br /><br /><rules>L'explosion inflige {{ minionmonstermod*100 }}% de dégâts aux sbires et aux monstres.</rules>",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          name: "Régicide",
          description:
            "Sylas se jette sur un ennemi pour infliger des dégâts d'exécution et, contre des champions, récupérer des PV.",
          tooltip:
            "Sylas se jette sur un ennemi et lui assène un coup magique infligeant <scaleAP>{{ mindamage }}</scaleAP> pts de dégâts magiques.<br /><br />Si le sort touche un champion ennemi, Sylas récupère <scaleAP>{{ minhealing }}</scaleAP> - <scaleAP>{{ maxhealing }}</scaleAP> PV, selon ses PV manquants (soin maximal à {{ maxexecutethreshold*100 }}% de ses PV). ",
          leveltip: {
            label: [
              "Dégâts",
              "Soins",
        ...
        },
        {
          ...
          tooltip:
            'Sylas se rue dans une direction.<br /><br /><span class="colorFF5733">Réactivation :</span> Sylas lance sa chaîne dans une direction pour se rapprocher du premier ennemi touché en lui infligeant <scaleAP>{{ damage }}</scaleAP> pts de dégâts magiques et en le projetant dans les airs pendant {{ knockupduration }} sec.',
          leveltip: {
        ...
        },
        {
          ...
          tooltip:
            "Sylas dérobe l'ultime de l'ennemi ciblé et peut ensuite l'utiliser en tenant compte du rang de son propre ultime et de ses propres stats.<br /><br /><rules>Dérober un ennemi applique sur celui-ci un délai de récupération équivalent à 200% (modifié par la réduction des délais de récupération de Sylas, {{ minimumenemycooldown }} sec minimum) du délai de récupération de l'ultime de l'ennemi, empêchant ainsi Sylas de détourner à nouveau son ultime.</rules><br /><br /><rules>Sylas convertit les ratios de dégâts d'attaque non hybrides en ratios de puissance. Pour un ratio de 1 dégâts d'attaque supplémentaires, il obtient un ratio de 0,4 puissance. Pour un ratio de 1 dégâts d'attaque totaux, il obtient un ratio de 0,6 puissance.</rules>",
          leveltip: {
