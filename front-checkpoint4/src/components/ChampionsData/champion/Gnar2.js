const Gnar2 = {
  ...
  data: {
    Gnar: {
      ...
      skins: [
        { id: "150000", num: 0, name: "default", chromas: false },
        { id: "150001", num: 1, name: "Dino Gnar", chromas: true },
        { id: "150002", num: 2, name: "Gnar gentleman", chromas: false },
        { id: "150003", num: 3, name: "Gnar des neiges", chromas: false },
        { id: "150004", num: 4, name: "Gnar El León", chromas: false },
        {
          id: "150013",
          num: 13,
        ...
        { id: "150014", num: 14, name: "SSG Gnar", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          tooltip:
            "<span class=\"color33FF33\">Mini Gnar : </span>lance un boomerang qui inflige <physicalDamage>{{ minitotaldamage }} pts de dégâts physiques</physicalDamage> et ralentit les ennemis de {{ slowamount*100 }}% pendant {{ slowduration }} sec. Le boomerang revient vers Gnar après avoir frappé un ennemi, infligeant {{ minisubsequentmult*100 }}% des dégâts aux cibles secondaires. Chaque ennemi ne peut être frappé qu'une fois. Attraper le boomerang réduit son délai de récupération de {{ minicdrefund*100 }}%.<br /><br /><scaleHealth>Méga Gnar : </scaleHealth>lance un rocher qui s'arrête quand il touche un ennemi, ralentissant tous les ennemis proches et infligeant <physicalDamage>{{ megatotaldamage }} pts de dégâts physiques</physicalDamage>. Ramasser le rocher réduit son délai de récupération de {{ megacdrefund*100 }}%.",
          leveltip: {
            label: [
              "Dégâts du boomerang",
              "Dégâts du rocher",
        ...
        },
        {
          ...
          tooltip:
            "<span class=\"color33FF33\">Mini Gnar : </span><spellPassive>Passive :</spellPassive> toutes les 3 attaques ou tous les 3 sorts sur la même cible, inflige des dégâts magiques supplémentaires équivalents à <magicDamage>{{ minitotaldamage }}</magicDamage> + {{ minipercenthpdamage*100 }}% des PV max de la cible et confère à Gnar un bonus de {{ f1 }}% en vitesse de déplacement qui se dissipe progressivement en 3 sec (max : {{ minimonstercap }} pts de dégâts contre les monstres). <br /><br /><scaleHealth>Méga Gnar : </scaleHealth>étourdit les ennemis dans une zone donnée pendant {{ megastunduration }} sec, infligeant <physicalDamage>{{ megatotaldamage }} pts de dégâts physiques</physicalDamage>.<br /><br />Gnar obtient le bonus de vitesse d'Agitation à chaque fois qu'il passe de Méga à Mini.",
          leveltip: {
            label: [
              "Dégâts d'Agitation",
        ...
        },
        {
          ...
          tooltip:
            "<span class=\"color33FF33\">Mini Gnar : </span>bondit vers une position, gagnant {{ minibas*100 }}% de vitesse d'attaque pendant {{ miniasduration }} sec. Si Gnar atterrit sur une unité, il rebondit sur elle et va plus loin. Inflige <physicalDamage>{{ minitotaldamage }} pts de dégâts physiques</physicalDamage> et ralentit brièvement cette unité si c'était un ennemi.<br /><br /><scaleHealth>Méga Gnar : </scaleHealth>bondit vers une position et inflige <physicalDamage>{{ megatotaldamage }} pts de dégâts physiques</physicalDamage> aux ennemis proches à l'atterrissage. Les ennemis sur lesquels Gnar atterrit directement sont brièvement ralentis.<br /><br />Si Aplatissement est utilisé pour se transformer, Gnar pourra quand même rebondir.",
          leveltip: {
            label: [
              "Dégâts de Rebond",
              "Dégâts d'Aplatissement",
        ...
        },
        {
          ...
          tooltip:
            "<span class=\"color33FF33\">Mini Gnar : </span><spellPassive>Passive :</spellPassive> augmente à {{ rhypermovementspeedpercent }}% le bonus d'Agitation en vitesse de déplacement.<br /><br /><scaleHealth>Méga Gnar : </scaleHealth>projette les ennemis proches dans une direction spécifiée, leur infligeant <physicalDamage>{{ damage }}</physicalDamage> pts de dégâts physiques et les ralentissant de {{ rslowpercent }}% pendant {{ rccduration }} sec. Les ennemis qui touchent un mur subissent {{ rwallhitdamagemultiplier }}% des dégâts et sont étourdis au lieu d'être ralentis.",
          leveltip: {
            label: [
              "Dégâts",
