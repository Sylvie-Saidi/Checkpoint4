...
const MissFortune2 = {
  ...
  data: {
    MissFortune: {
      ...
      skins: [
        { id: "21000", num: 0, name: "default", chromas: false },
        { id: "21001", num: 1, name: "Miss Fortune cow-girl", chromas: false },
        { id: "21002", num: 2, name: "Miss Fortune Waterloo", chromas: false },
        {
          id: "21003",
          num: 3,
        ...
        { id: "21005", num: 5, name: "Mad Fortune", chromas: false },
        { id: "21006", num: 6, name: "Donna Fortune", chromas: false },
        { id: "21007", num: 7, name: "Miss Fortune arcade", chromas: true },
        { id: "21008", num: 8, name: "Capitaine Fortune", chromas: false },
        {
          id: "21009",
          num: 9,
        ...
        },
        {
          id: "21017",
          num: 17,
          name: "Miss Fortune gardienne des pyjamas",
          chromas: false,
        },
        {
          id: "21018",
        ...
        },
        {
          id: "21020",
          num: 20,
          name: "Miss Fortune sorcière édition prestige",
          chromas: false,
        },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Doublé",
          description:
            "Miss Fortune tire une balle sur une cible, blessant cette cible et celle qui se trouve derrière. Les deux coups peuvent aussi appliquer Cœur volage.",
          tooltip:
            "Miss Fortune tire une balle ricochante qui traverse un ennemi, infligeant {{ e2 }} <scaleAD>(+{{ a2 }})</scaleAD> <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts physiques à deux cibles. Les deux coups peuvent infliger des effets à l'impact.<br /><br />Le second coup peut être critique et ainsi infliger {{ f1 }}% de dégâts, et il est toujours critique si le premier coup a tué sa cible.",
          leveltip: {
            label: [
        ...
        },
        {
          ...
          name: "Fanfaronne",
          description:
            "Miss Fortune augmente passivement sa vitesse de déplacement quand elle n'est pas attaquée. Cette compétence peut être activée pour recevoir un bonus en vitesse d'attaque pendant un court instant. Quand cette compétence est en récupération, Cœur volage réduit le délai de récupération restant de Fanfaronne.",
          tooltip:
            '<span class="colorFF9900">Passive :</span> après ne pas avoir subi de dégâts directs pendant 5 sec, Miss Fortune obtient +{{ e5 }} vitesse de déplacement. Encore 5 sec plus tard, ce bonus augmente à {{ e2 }}.<br /><br /><span class="colorFF9900">Active :</span> octroie le bonus total de Fanfaronne en vitesse de déplacement et augmente la vitesse d\'attaque de {{ e1 }}% pendant {{ e3 }} sec.<br /><br />Cœur volage réduit le délai de récupération de Fanfaronne de {{ f2 }} sec.',
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Miss Fortune révèle une zone avec une pluie de balles, infligeant des vagues de dégâts aux ennemis et les ralentissant.",
          tooltip:
            'Miss Fortune révèle une zone en y faisant pleuvoir des balles qui infligent {{ e1 }} <span class="color99FF99">(+{{ a1 }})</span> pts de dégâts magiques en 2 sec et ralentissent les ennemis touchés de {{ e2 }}%.',
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Miss Fortune déchaîne un déluge de balles dans un cône devant elle, infligeant d'importants dégâts aux ennemis. Chaque vague de Barrage de plomb peut infliger des coups critiques.",
          tooltip:
            'Miss Fortune déchaîne un déluge de balles pendant {{ channelduration }} sec, infligeant <physicalDamage>{{ damageperwave }}</physicalDamage> pts de dégâts physiques par vague ({{ waves }} vagues au total).<br /><br />Chaque vague de Barrage de plomb peut être critique et ainsi infliger {{ critmultiplier }} des dégâts.<br /><br /><span class="colorF50F00">Dégâts totaux : {{ totaldamage }}</span>',
          leveltip: {
            label: ["Barrages de balles", "Délai de récupération"],
            effect: [
              "{{ waves }} -> {{ wavesNL }}",
              "{{ cooldown }} -> {{ cooldownNL }}",
            ],
      ...
      passive: {
        name: "Cœur volage",
        description:
          "Miss Fortune inflige des dégâts physiques supplémentaires quand elle attaque une nouvelle cible.",
        image: {
