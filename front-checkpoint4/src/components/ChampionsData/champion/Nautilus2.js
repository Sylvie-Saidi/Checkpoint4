...
const Nautilus2 = {
  ...
  data: {
    Nautilus: {
      ...
      skins: [
        { id: "111000", num: 0, name: "default", chromas: false },
        { id: "111001", num: 1, name: "Nautilus des abysses", chromas: false },
        { id: "111002", num: 2, name: "Nautilus souterrain", chromas: false },
        { id: "111003", num: 3, name: "AstroNautilus", chromas: false },
        { id: "111004", num: 4, name: "Nautilus purificateur", chromas: false },
        { id: "111005", num: 5, name: "Nautilus brise-monde", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Abordage",
          description:
            "Nautilus lance son ancre devant lui. S'il touche un ennemi, il se rapproche de la cible et la cible est tirée vers lui. S'il touche le décor, il se rapproche du décor, le délai de récupération d'Abordage est réduit de moitié et la moitié du coût en mana lui est rendu.",
          tooltip:
            "Nautilus lance son ancre devant lui. S'il touche une unité ennemie, Nautilus se rapproche d'elle et la tire vers lui, lui infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et l'étourdissant un court moment.<br /><br />Si l'ancre touche le décor, Nautilus se rapproche de l'ancre, le délai de récupération est réduit de {{ e3 }}% (<totalValue>{{ f1 }}</totalValue>) et Nautilus récupère {{ e4 }}% du coût en mana.",
          leveltip: {
          ...
          vars: [
            ...
            { link: "@special.nautilusq", coeff: 0.5, key: "f1" },
          ],
        ...
        },
        {
          ...
          tooltip:
            "Nautilus s'entoure d'énergie ténébreuse pendant {{ e3 }} sec, ce qui le protège contre {{ e1 }} <scaleHealth>(+{{ f1 }})</scaleHealth> ({{ e2 }}% de ses PV max) pts de dégâts.<br /><br />Tant que dure le bouclier, les attaques de base de Nautilus infligent {{ e4 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques supplémentaires en 2 sec à tous les ennemis proches de sa cible.",
          leveltip: {
            label: [
              "PV du bouclier",
          ...
          vars: [
            { link: "bonushealth", coeff: 0.1, key: "f1" },
        ...
        },
        {
          ...
          tooltip:
            "Nautilus frappe le sol, provoquant une explosion autour de lui. Chaque explosion inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis dans la zone et les ralentit de {{ e2 }}% pendant {{ e4 }} sec. Le ralentissement diminue peu à peu.<br /><br />Une unité peut être touchée par plus d'une explosion, mais chaque explosion secondaire lui inflige alors {{ e3 }}% de dégâts en moins.",
          leveltip: {
            label: [
              "Dégâts",
              "Ralentissement",
        ...
        },
        {
          ...
          tooltip:
            "Nautilus provoque une onde de choc qui poursuit un champion ennemi, infligeant {{ secondarytargetdamage }} pts de dégâts magiques aux autres ennemis sur son passage, les projetant dans les airs et les étourdissant pendant {{ stunduration }} sec.<br /><br />L'onde de choc explose en touchant sa cible, lui infligeant {{ primarytargetdamage }} pts de dégâts magiques, la projetant dans les airs et l'étourdissant pendant {{ stunduration }} sec.  ",
          leveltip: {
            label: [
              "Dégâts sur la trajectoire",
              "Dégâts secondaires",
      ...
      passive: {
        name: "Coup écrasant",
        description:
          "Les attaques de base de Nautilus infligent des dégâts physiques supplémentaires et immobilisent brièvement sa cible. Coup écrasant ne peut se déclencher qu'une fois toutes les quelques secondes sur la même cible.",
        image: {
