...
const Tristana2 = {
  ...
  data: {
    Tristana: {
      ...
      skins: [
        { id: "18000", num: 0, name: "default", chromas: false },
        { id: "18001", num: 1, name: "Tristana Riot Girl", chromas: false },
        {
          id: "18002",
          num: 2,
        ...
        { id: "18003", num: 3, name: "Tristana pompier", chromas: false },
        { id: "18004", num: 4, name: "Tristana guérilla", chromas: false },
        { id: "18005", num: 5, name: "Tristana pirate", chromas: false },
        { id: "18006", num: 6, name: "Tristana à propulsion", chromas: true },
        { id: "18010", num: 10, name: "Tristana dragonnière", chromas: true },
        { id: "18011", num: 11, name: "Tristana sorcière", chromas: false },
        {
          id: "18012",
          num: 12,
        ...
        { id: "18024", num: 24, name: "Tristana diablotin", chromas: true },
        {
          id: "18033",
          num: 33,
          name: "Tristana cosplay Pingouin",
          chromas: true,
        },
      ],
      lore:
      ...
      spells: [
        {
          ...
          tooltip:
            "<spellPassive>Active : </spellPassive>augmente la vitesse d'attaque de Tristana de {{ e1 }}% pendant {{ e2 }} sec.",
          leveltip: {
            label: ["Vitesse d'attaque", "Délai de récupération"],
            effect: [
        ...
        },
        {
          ...
          tooltip:
            "Tristana se propulse jusqu'à l'endroit visé, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et ralentissant de {{ e3 }}% pendant {{ e2 }} sec toutes les unités ennemies proches lorsqu'elle atterrit.<br /><br />Le délai de récupération de Saut roquette prend fin si vous tuez un champion, effectuez une assistance ou faites exploser le maximum d'effets Charge explosive sur un champion.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          tooltip:
            "<spellPassive>Passive : </spellPassive>les ennemis explosent lorsqu'ils sont tués par les attaques de base de Tristana, infligeant <magicDamage>{{ passivedamage }} pts de dégâts magiques</magicDamage> aux ennemis proches.<br /><br /><spellPassive>Active : </spellPassive>place une bombe sur une unité ou une tourelle ennemie. Au bout de {{ activeduration }} sec, la bombe explose, infligeant <physicalDamage>{{ activedamage }} pts de dégâts physiques</physicalDamage>. Chaque attaque ou compétence de Tristana augmente de {{ activeperstackamp*100 }}% les dégâts de la bombe, jusqu'à un maximum de <physicalDamage>{{ activemaxdamage }}</physicalDamage>.<br /><br />À {{ activemaxstacks }} effets cumulés, la bombe explose immédiatement. Le rayon de la déflagration est deux fois plus grand en cas d'utilisation contre une tourelle.",
          leveltip: {
            label: [
              "Dégâts de l'explosion passive",
        ...
        },
        {
          ...
          tooltip:
            "Tristana tire un énorme boulet de canon sur une unité ennemie. Il inflige {{ damagecalc }} pts de dégâts magiques et repousse les unités proches sur {{ knockbackdistance }} unités de distance.",
          leveltip: {
            label: [
              "Dégâts",
