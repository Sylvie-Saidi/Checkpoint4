...
const Ezreal2 = {
  ...
  data: {
    Ezreal: {
      ...
      skins: [
        { id: "81000", num: 0, name: "default", chromas: false },
        { id: "81001", num: 1, name: "Ezreal de Nottingham", chromas: false },
        { id: "81002", num: 2, name: "Ezreal buteur", chromas: false },
        { id: "81003", num: 3, name: "Ezreal de glace", chromas: false },
        { id: "81004", num: 4, name: "Ezreal spéléologue", chromas: false },
        { id: "81005", num: 5, name: "Ezreal Pulsefire", chromas: false },
        { id: "81006", num: 6, name: "TPA Ezreal", chromas: false },
        { id: "81007", num: 7, name: "Ezreal séducteur", chromas: true },
        { id: "81008", num: 8, name: "Ezreal as de pique", chromas: false },
        { id: "81009", num: 9, name: "Ezreal arcade", chromas: false },
        {
          id: "81018",
          num: 18,
        ...
        { id: "81019", num: 19, name: "SSG Ezreal", chromas: false },
        {
          id: "81020",
          num: 20,
          name: "Ezreal gardien des pyjamas",
          chromas: false,
        },
        {
          id: "81021",
      ...
      spells: [
        {
          ...
          name: "Tir mystique",
          description:
            "Ezreal tire un trait d'énergie blessant qui, s'il touche un ennemi, réduit légèrement tous les délais de récupération d'Ezreal.",
          tooltip:
            "Ezreal tire un trait d'énergie, infligeant <physicalDamage>{{ damage }} pts de dégâts physiques</physicalDamage> (peut appliquer des effets à l'impact). <br /><br />Les délais de récupération d'Ezreal sont réduits de {{ cdrefund }} sec si Tir mystique touche une cible.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          name: "Flux essentiel",
          description:
            "Ezreal tire un orbe qui se colle au premier champion ou objectif touché. Si Ezreal frappe un ennemi affecté par un orbe, ce dernier explose et inflige des dégâts.",
          tooltip:
            "Ezreal tire un orbe qui se colle pendant {{ detonationtimeout }} sec au premier champion ou objectif touché.<br /><br />Frapper l'orbe avec une compétence ou une attaque le fait exploser, infligeant <magicDamage>{{ damage }} pts de dégâts magiques</magicDamage>. Si Ezreal le fait exploser avec une compétence, il récupère le coût de cette compétence + {{ manareturn }} pts de mana.",
          leveltip: {
            label: ["Dégâts", "Ratio de puissance total"],
            effect: [
              "{{ basedamage }} -> {{ basedamageNL }}",
        ...
        },
        {
          ...
          description:
            "Ezreal se téléporte dans une zone ciblée et tire un projectile autoguidé qui frappe l'ennemi le plus proche. Le tir vise en priorité les ennemis affectés par Flux essentiel.",
          tooltip:
            "Ezreal se téléporte dans une zone proche et tire un projectile sur l'ennemi le plus proche, infligeant <magicDamage>{{ damage }} pts de dégâts magiques</magicDamage>.<br /><br />Transfert arcanique vise en priorité les cibles affectées par Flux essentiel.",
          leveltip: {
        ...
        },
        {
          ...
          name: "Arc térébrant",
          description:
            "Ezreal se concentre avant de tirer une puissante vague d'énergie qui inflige d'importants dégâts à chaque unité traversée (les dégâts sont réduits pour les sbires et les monstres non épiques).",
          tooltip:
            "Ezreal se concentre pendant 1 sec avant de tirer un projectile à longue portée, infligeant <magicDamage>{{ damage }} pts de dégâts magiques</magicDamage> à chaque ennemi qu'il traverse.<br /><br />Inflige {{ damagereductionwaveclear.0*100 }}% de dégâts aux sbires et aux monstres non épiques.",
          leveltip: {
            label: ["Dégâts"],
      ...
      passive: {
        ...
        description:
          "Ezreal augmente sa vitesse d'attaque chaque fois qu'il touche un ennemi avec une compétence (cumulable jusqu'à 5 fois).",
        image: {
