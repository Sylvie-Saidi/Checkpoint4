const Zac = {
  ...
  data: {
    Zac: {
      ...
      skins: [
        { id: "154000", num: 0, name: "default", chromas: true },
        { id: "154001", num: 1, name: "Zac arme spéciale", chromas: false },
        { id: "154002", num: 2, name: "Zaquatique", chromas: false },
        { id: "154006", num: 6, name: "SKT T1 Zac", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          tooltip:
            "Le bras de Zac s'étire et agrippe le premier ennemi qu'il frappe, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> <span class=\"colorCC3300\">(+{{ f2 }})</span> pts de dégâts magiques et le ralentissant brièvement. La prochaine attaque de base de Zac est remplacée par une gifle à longue distance qui réitère les dégâts magiques et le ralentissement initiaux.<br /><br />Si Zac attrape un ennemi différent à chaque attaque, il les projette l'un vers l'autre, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> <span class=\"colorCC3300\">(+{{ f2 }})</span> pts de dégâts magiques dans une zone s'ils entrent en collision.",
          leveltip: {
        ...
        },
        {
          ...
          tooltip:
            'Le corps de Zac éclate, infligeant des dégâts magiques équivalents à {{ basedamage }} + ({{ basemaxhealthdamage*100 }}+{{ displaypercentdamage }}) des PV max de l\'ennemi.<br /><br />Absorber de la <span class="color3ca126">matière gluante</span> réduit le délai de récupération de Matière instable de 1 sec.<br /><br /><rules>Les dégâts selon les PV max sont limités à 200 contre les sbires et les monstres.</rules>',
          leveltip: {
            label: ["Dégâts fixes", "Pourcentage des PV max"],
            effect: [
        ...
        },
        {
          ...
          tooltip:
            '<spellPassive>Première activation :</spellPassive> Zac se tourne vers le curseur et charge pendant {{ e4 }} sec.<br /><br /><spellPassive>Deuxième activation :</spellPassive> Zac se propulse vers la zone ciblée, projetant en l\'air les ennemis proches pendant {{ f2 }} à {{ f3 }} sec (selon le temps de charge) et infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques. Zac perd des bouts supplémentaires de <span class="color3ca126">matière gluante</span> pour chaque champion ennemi touché.<br /><br /><rules>Fronde peut être annulée en vous déplaçant, ce qui réduit de moitié le coût et le délai de récupération de la compétence.</rules>',
          leveltip: {
        ...
        },
        {
          ...
          tooltip:
            '<spellPassive>Passive :</spellPassive> les soins des bouts de <span class="color3ca126">matière gluante</span> de Division cellulaire sont augmentés à {{ f8 }}% de vos PV max.<br /><br /><spellPassive>Active :</spellPassive> Zac rebondit {{ bounces }} fois, repoussant les ennemis pendant {{ knockupduration }} sec et infligeant {{ damageperbounce }} pts de dégâts magiques. Les ennemis touchés par plusieurs rebonds subissent {{ damagereductionbounce*100 }}% de dégâts en moins et ne sont pas projetés en l\'air. <br /><br />Les ennemis touchés par Boing ! sont ralentis de {{ slowamount*100 }}% pendant {{ slowduration }} sec.<br /><br />Zac augmente sa vitesse de déplacement sur la durée et peut lancer <spellActive>Matière instable</spellActive> tout en rebondissant.',
          leveltip: {
            label: [
              "Dégâts de base des rebonds",
              "Soins supplémentaires des bouts de matière",
