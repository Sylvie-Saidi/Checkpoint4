const Graves2 = {
  ...
  data: {
    Graves: {
      ...
      skins: [
        { id: "104000", num: 0, name: "default", chromas: false },
        { id: "104001", num: 1, name: "Graves tueur à gages", chromas: false },
        { id: "104002", num: 2, name: "Graves fugitif", chromas: false },
        { id: "104003", num: 3, name: "Don Graves", chromas: false },
        { id: "104004", num: 4, name: "Graves anti-émeutes", chromas: false },
        { id: "104005", num: 5, name: "Graves pistolet à eau", chromas: true },
        { id: "104006", num: 6, name: "Graves coupe-jarret", chromas: false },
        { id: "104007", num: 7, name: "Graves des neiges", chromas: true },
        {
          id: "104014",
          num: 14,
        ...
        { id: "104018", num: 18, name: "Graves prétorien", chromas: true },
        {
          id: "104025",
          num: 25,
      ...
      spells: [
        {
          ...
          tooltip:
            "Tire un projectile bourré de poudre qui inflige <physicalDamage>{{ totaldamage }} pts de dégâts physiques</physicalDamage> aux ennemis sur une ligne.<br /><br />Au bout de 2 sec, ou {{ terraincollisiondelay }} sec s'il percute un élément du décor, le projectile explose et inflige <physicalDamage>{{ totaldetonationdamage }} pts de dégâts physiques</physicalDamage> à tous les ennemis proches.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          tooltip:
            "Crée un nuage de fumée noire qui dure 4 sec. Les ennemis dans la fumée ne voient pas plus loin que la fumée.<br /><br />Les ennemis touchés par l'impact initial subissent {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et voient leur vitesse de déplacement être réduite de {{ e2 }}% pendant {{ e5 }} sec.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          tooltip:
            "Fonce dans une direction tout en rechargeant une cartouche. Graves gagne <keywordMajor>Nerfs d'acier</keywordMajor> pendant 4 sec. Si Graves fonce vers un champion ennemi, il gagne deux effets <keywordMajor>Nerfs d'acier</keywordMajor> au lieu d'un. <br /><br />Tous les impacts d'attaque de base réduisent le délai de récupération de Ruée vers l'or de {{ e4 }} sec. S'ils touchent autre chose que des sbires, ils actualisent également <keywordMajor>Nerfs d'acier</keywordMajor>.<br /><br /><keywordMajor>Nerfs d'acier</keywordMajor> octroie un bonus de +{{ e5 }} en armure (cumulable {{ e0 }} fois).",
          leveltip: {
            label: ["Armure de Nerfs d'acier", "Délai de récupération"],
            effect: [
              "{{ e5 }} -> {{ e5NL }}",
              "{{ cooldown }} -> {{ cooldownNL }}",
            ],
        ...
        },
        {
          ...
          tooltip:
            "Tire un projectile explosif avec tant de puissance que Graves est projeté en arrière. Le projectile inflige <physicalDamage>{{ damage }}</physicalDamage> pts de dégâts physiques au premier ennemi touché. En touchant un champion ennemi ou en arrivant au bout de sa course, le projectile explose et inflige <physicalDamage>{{ falloffdamage }}</physicalDamage> pts de dégâts physiques dans une zone conique.",
          leveltip: {
            label: [
              "Dégâts initiaux",
              "Dégâts de zone",
      ...
      passive: {
        ...
        description:
          "Le fusil de Graves contient deux cartouches. Après les avoir tirées, Graves doit recharger. Chaque attaque tire plusieurs balles dans une zone conique. Frapper un ennemi avec plusieurs balles inflige des dégâts supplémentaires. Ces balles ne traversent pas les unités.",
        image: {
