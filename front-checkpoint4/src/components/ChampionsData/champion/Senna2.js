...
const Senna2 = {
  ...
  data: {
    Senna: {
      ...
      skins: [
        { id: "235000", num: 0, name: "default", chromas: false },
        { id: "235001", num: 1, name: "True Damage Senna", chromas: true },
        {
          id: "235009",
          num: 9,
          name: "True Damage Senna édition prestige",
          chromas: false,
        },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Le canon en pierre-relique de Senna tire un rayon de lumière et d'ombre à travers sa cible. Ce rayon soigne les alliés et blesse les ennemis.",
          tooltip:
            "Senna tire un rayon d'ombre perforante à travers un allié ou un ennemi. Les ennemis subissent <physicalDamage>{{ totaldamage }} pts de dégâts physiques</physicalDamage>. Les champions alliés touchés récupèrent <healing>{{ totalheal }}</healing> PV. <br /><br /><rules>Les attaques de base réduisent le délai de récupération d'Ombre perforante de {{ cdreductiononhit }} sec.</rules>",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Senna projette une vague de Brume noire. Si elle touche un ennemi, la Brume s'accroche à lui. La cible ainsi que tous les ennemis proches sont immobilisés après un court délai.",
          tooltip:
            "Senna projette une vague de Brume noire qui inflige <physicalDamage>{{ damage }} pts de dégâts physiques</physicalDamage> au premier ennemi touché. Après {{ delaytime }} sec, la cible et tous les ennemis proches sont immobilisés pendant {{ rootduration }} sec.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Senna relâche la Brume accumulée dans son arme pour créer une tempête autour d'elle, ce qui la transforme en spectre. Les alliés qui entrent dans cette zone sont camouflés et prennent l'apparence d'un spectre. Les spectres ne peuvent pas être identifiés, ne peuvent pas être sélectionnés et profitent d'un bonus en vitesse de déplacement.",
          tooltip:
            'Senna se transforme en nuage de Brume pendant {{ buffduration }} sec et devient un <span class="color90b2ee">spectre</span>. Les champions alliés qui entrent dans la Brume sont <span class="colorcd90ee">camouflés</span> et se transforment en <span class="color90b2ee">spectre</span> lorsqu\'ils en sortent. Les <span class="color90b2ee">spectres</span> ont une vitesse de déplacement augmentée de {{ totalms }}. Ils ne peuvent pas être sélectionnés ou identifiés tant qu\'aucun champion ennemi n\'est proche. ',
          leveltip: {
            label: ["Durée", "Délai de récupération"],
            effect: [
        ...
        },
        {
          ...
          description:
            "Senna invoque les pierres-reliques de Sentinelles déchues, ouvrant son canon en pierre-relique pour former un éventail sacré d'ombre et de lumière. Elle tire alors un rayon à portée illimitée qui octroie un bouclier aux alliés touchés et inflige des dégâts aux ennemis pris dans son centre.",
          tooltip:
            'Senna tire un rayon de lumière à portée illimitée. Les champions ennemis touchés subissent <physicalDamage>{{ totaldamage }} pts de dégâts physiques</physicalDamage>. Les champions alliés touchés dans une plus grande zone reçoivent un bouclier pouvant absorber {{ totalshield }} pts de dégâts pendant {{ shieldduration }} sec. Les PV du bouclier augmentent avec la quantité de <span class="color0bf7de">Brume</span> récupérée par Senna.',
          leveltip: {
          ...
          blocks: [
            {
              ...
              hiddenWithAnyOf: [""],
              items: [
                { id: "3862", count: 1, hideCount: false },
                { id: "2003", count: 2, hideCount: false },
