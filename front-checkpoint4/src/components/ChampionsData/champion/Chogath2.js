  ...
  data: {
    Chogath: {
      ...
      skins: [
        ...
        { id: "31001", num: 1, name: "Cho'Gath du cauchemar", chromas: false },
        { id: "31002", num: 2, name: "Cho'Gath gentleman", chromas: false },
        { id: "31003", num: 3, name: "Cho'Gath du Loch Ness", chromas: false },
        { id: "31004", num: 4, name: "Cho'Gath jurassique", chromas: false },
        { id: "31005", num: 5, name: "Proto Cho'Gath Prime", chromas: true },
        { id: "31006", num: 6, name: "Cho'Gath préhistorique", chromas: false },
        {
          id: "31007",
          num: 7,
      ...
      spells: [
        {
          ...
          name: "Rupture",
          description:
            "Fracasse le sol de la zone ciblée et envoie les ennemis dans les airs, leur infligeant des dégâts et les ralentissant.",
          tooltip:
            "Fracasse le sol de la zone ciblée. Les ennemis dans cette zone sont projetés dans les airs pendant {{ e5 }} sec, subissent {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et sont ralentis de {{ e2 }}% pendant {{ e3 }} sec.",
        ...
        },
        {
          ...
          name: "Cri sauvage",
          description:
            "Cho'Gath pousse un cri terrible dans une zone conique, infligeant des dégâts magiques et réduisant les ennemis au silence pendant quelques secondes.",
          tooltip:
            "Réduit au silence les ennemis dans une zone conique pendant {{ e2 }} sec et leur inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Les attaques de Cho'Gath lancent des piques mortelles qui blessent et ralentissent tous les ennemis devant lui.",
          tooltip:
            "Les 3 prochaines attaques de base de Cho'Gath lanceront des piques qui infligeront des dégâts magiques équivalents à {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> plus {{ f1 }}% des PV max des ennemis. Ces piques appliqueront aussi un ralentissement de {{ e2 }}% qui diminue en {{ e3 }} sec.<br /><br /><rules>Plus Cho'Gath cumule d'effets Festin, plus les piques grossissent.<br />Chaque effet Festin cumulé augmente encore les dégâts de 0,5% des PV max des ennemis.<br />Contre les sbires et les monstres, les dégâts selon les PV max sont limités à {{ e8 }}.</rules>",
          leveltip: {
        ...
        },
        {
          ...
          name: "Festin",
          description:
            "Dévore une unité ennemie, infligeant d'importants dégâts bruts. Si la cible est tuée, Cho'Gath grandit et voit ses PV max augmenter.",
          tooltip:
            "Mord sauvagement un ennemi, infligeant {{ rdamage }} pts de dégâts bruts à un champion ou {{ rmonsterdamage }} pts de dégâts bruts à un sbire ou à un monstre. Si l'unité ennemie est tuée par Festin, Cho'Gath gagne un effet Festin, ce qui le fait grandir et augmente ses PV max de {{ rhealthperstack }}.<br /><br /><rules>Seuls {{ rminionmaxstacks }} effets Festin au total peuvent être gagnés en tuant des sbires et des monstres non épiques. <keywordMajor>(Total actuel : {{ f3 }}/{{ rminionmaxstacks }})</keywordMajor></rules>",
          leveltip: {
            label: ["Dégâts aux champions", "PV par effet cumulé"],
            effect: [
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                { id: "3742", count: 1, hideCount: false },
                { id: "4010", count: 1, hideCount: false },
