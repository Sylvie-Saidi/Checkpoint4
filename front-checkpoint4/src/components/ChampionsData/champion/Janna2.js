const Janna2 = {
  ...
  data: {
    Janna: {
      ...
      skins: [
        { id: "40000", num: 0, name: "default", chromas: false },
        { id: "40001", num: 1, name: "Janna des tempêtes", chromas: false },
        { id: "40002", num: 2, name: "Janna Hextech", chromas: false },
        { id: "40003", num: 3, name: "Janna reine de givre", chromas: false },
        {
          id: "40004",
          num: 4,
        ...
        { id: "40005", num: 5, name: "Janna miss météo", chromas: false },
        { id: "40006", num: 6, name: "Fnatic Janna", chromas: false },
        {
          id: "40007",
          num: 7,
        ...
        { id: "40008", num: 8, name: "Janna à l'épée sacrée", chromas: true },
        { id: "40013", num: 13, name: "Janna sorcière", chromas: true },
        {
          id: "40020",
          num: 20,
          name: "Janna gardienne des sables",
          chromas: true,
        },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Vent hurlant",
          description:
            "En modifiant localement la pression et la température, Janna peut créer une petite tornade qui croît en taille avec le temps. Elle peut activer une nouvelle fois le sort pour libérer la tornade. Elle fonce alors dans la direction de l'invocation, projetant en l'air les ennemis sur son passage et leur infligeant des dégâts.",
          tooltip:
            "Invoque une tornade qui inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis sur son chemin, tout en les projetant en l'air pendant {{ e4 }} sec.<br /><br />La tornade peut être chargée pendant {{ e6 }} sec au maximum. Pour chaque seconde de charge, la tornade :<ul><li>Inflige {{ e2 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts supplémentaires.</li><li>Projette les ennemis en l'air pendant {{ e5 }} sec de plus.</li><li>Va {{ e3 }}% plus loin.</li></ul>Vent hurlant atteint toujours sa destination en {{ e8 }} sec.<br /><br /><rules><span class=\"color8c8c8c\">Réactivez la compétence pour lancer la tornade plus tôt.</span></rules>",
          leveltip: {
            label: [
              "Dégâts",
          ...
          vars: [
            ...
            { link: "spelldamage", coeff: 0.1, key: "a2" },
          ],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
          range: [1700, 1700, 1700, 1700, 1700],
          rangeBurn: "1700",
          image: {
        ...
        },
        {
          ...
          name: "Alizé",
          description:
            "Janna invoque un élémentaire d'air qui, passivement, améliore sa vitesse de déplacement et lui permet de traverser les unités. Elle peut aussi activer la compétence pour infliger des dégâts et ralentir la vitesse de déplacement d'un ennemi. La propriété passive est perdue pendant le délai de récupération de cette compétence.",
          tooltip:
            "<spellPassive>Passive :</spellPassive> quand Alizé n'est pas en récupération, Janna augmente sa vitesse de déplacement de {{ e1 }}% <scaleAP>(+{{ f1 }}%)</scaleAP> et peut traverser les unités.<br /><br /><spellPassive>Active : </spellPassive>inflige {{ e2 }} <scaleAP>(+{{ a1 }})</scaleAP> <keywordMajor>(+{{ f3 }})</keywordMajor> pts de dégâts magiques à un ennemi et réduit sa vitesse de déplacement de {{ e3 }}% <scaleAP>(+{{ f2 }}%)</scaleAP> pendant {{ e4 }} sec.",
          leveltip: {
            label: [
              "Vitesse de déplacement passive",
              "Dégâts",
              "Ralentissement",
              "Coût en @AbilityResourceName@",
          ...
          vars: [
            { link: "spelldamage", coeff: 0.02, key: "f1" },
            { link: "spelldamage", coeff: 0.5, key: "a1" },
            { link: "spelldamage", coeff: 0.06, key: "f2" },
          ],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
        ...
        },
        {
          ...
          name: "Œil du cyclone",
          description:
            "Janna invoque une tempête défensive qui protège un champion allié ou une tourelle alliée contre les dégâts et qui augmente ses dégâts d'attaque.",
          tooltip:
            "Confère à un champion allié ou à une tourelle alliée un bouclier qui se désagrège en {{ e3 }} sec. Le bouclier absorbe jusqu'à {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts et octroie un bonus de {{ e2 }} <scaleAP>(+{{ a2 }})</scaleAP> dégâts d'attaque à sa cible jusqu'à ce que le bouclier soit brisé ou épuisé.<br /><br /><rules>Chaque compétence de Janna qui ralentit ou projette en l'air un champion ennemi réduit de {{ ecdrefundforcc*100 }}% le délai de récupération d'Œil du cyclone.</rules>",
          leveltip: {
            label: [
              "PV du bouclier",
              "Dégâts d'attaque",
        ...
        },
        {
          ...
          name: "Mousson",
          description:
            "Janna s'entoure d'une puissante tempête magique, repoussant au loin les ennemis. Quand la tempête est terminée, les dernières brises soignent les alliés proches tant que la compétence est active.",
          tooltip:
            "Fait appel à la puissance du vent pour repousser les ennemis proches et rendre {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> PV par seconde aux alliés proches pendant {{ e3 }} sec.",
          leveltip: {
            label: ["Soins par seconde", "Délai de récupération"],
            effect: [
              "{{ e1 }} -> {{ e1NL }}",
              "{{ cooldown }} -> {{ cooldownNL }}",
            ],
      ...
      passive: {
        name: "Zéphyr",
        description:
          "Janna augmente passivement sa vitesse de déplacement de 8%, et les champions alliés proches gagnent ce bonus quand ils vont vers elle.<br><br>De plus, les attaques de base de Janna infligent des dégâts magiques supplémentaires selon sa vitesse de déplacement supplémentaire.",
        image: {
