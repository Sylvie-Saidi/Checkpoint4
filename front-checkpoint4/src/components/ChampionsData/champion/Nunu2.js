const Nunu2 = {
  ...
  data: {
    Nunu: {
      ...
      skins: [
        { id: "20000", num: 0, name: "default", chromas: false },
        {
          id: "20001",
          num: 1,
        ...
        { id: "20004", num: 4, name: "Nunu et Bot Willump", chromas: false },
        {
          id: "20005",
          num: 5,
        ...
        { id: "20006", num: 6, name: "TPA Nunu et Willump", chromas: false },
        {
          id: "20007",
          num: 7,
          name: "Nunu et Willump zombies",
          chromas: false,
        },
        { id: "20008", num: 8, name: "Nunu et Willump origami", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Voracité",
          description:
            "Willump mord un sbire, un monstre ou un champion ennemi, lui infligeant d'importants dégâts et récupérant des PV.",
          tooltip:
            "Willump mord un ennemi, lui infligeant des dégâts et récupérant des PV.  Les PV récupérés augmentent de {{ lowhealthhealingscalar*100 }}% quand Willump a moins de {{ lowhealththreshhold*100 }}% de ses PV max.<br /><br /><spellActive>Monstres et sbires </spellActive>: inflige <trueDamage>{{ monsterminiondamage }} pts de dégâts bruts</trueDamage> et récupère {{ monsterhealing }} PV.<br /><br /><spellActive>Champions </spellActive>: inflige <magicDamage>{{ totalchampiondamage }} pts de dégâts magiques</magicDamage> et récupère {{ championhealing }} PV.",
          leveltip: {
            label: [
              "Dégâts aux monstres",
          ...
          resource: "{{ cost }} pts de mana",
        },
        {
          id: "NunuW",
          name: "Boule de neige géante !",
          description:
            "Willump crée une boule de neige qui grossit et accélère à mesure qu'il la fait rouler.  La boule de neige blesse et projette en l'air les ennemis.",
          tooltip:
            "Willump fait rouler une boule de neige qui grossit et accélère.  Quand la boule de neige percute un champion ennemi, un grand monstre ou un mur, elle explose, infligeant jusqu'à <magicDamage>{{ maximumsnowballdamage }} pts de dégâts magiques</magicDamage> aux ennemis proches et les projetant dans les airs pendant {{ maximumstunduration }} sec.<br /> <br />Réactiver la compétence lance la boule de neige sur une ligne droite.<br /><br /><rules>Tourner continuellement dans la même direction permet à Willump de tourner plus rapidement dans cette direction.</rules>",
          leveltip: {
            label: ["Dégâts de base", "Coût en @AbilityResourceName@"],
            effect: [
          ...
          maxammo: "-1",
          range: [7500, 7500, 7500, 7500, 7500],
          rangeBurn: "7500",
          image: {
            full: "NunuW.png",
            sprite: "spell8.png",
        ...
        },
        {
          ...
          description:
            "Nunu lance plusieurs boules de neige qui blessent les ennemis.  Ensuite, Willump immobilise les champions et les grands monstres qui ont été touchés par une boule de neige.",
          tooltip:
            'Nunu lance 3 boules de neige.  Rafale de boules de neige peut être lancée deux fois de plus pour lancer encore plus de boules de neige.  Les ennemis touchés subissent <magicDamage>{{ totalsnowballdamage }} pts de dégâts magiques</magicDamage> par boule de neige.  Les ennemis touchés par 3 boules de neige consécutives sont ralentis de {{ slowamount*-100 }}% pendant {{ slowduration }} sec.  Les champions et les grands monstres sont marqués par <span class="color4AA8E2">Lien glacé</span>.<br /><br /><spellActive>Tour de Willump </spellActive>: au bout de {{ totalspellduration }} sec, tous les ennemis marqués par <span class="color4AA8E2">Lien glacé</span> à portée de Willump subissent <magicDamage>{{ totalrootdamage }} pts de dégâts magiques</magicDamage> et sont immobilisés pendant <scaleLevel>{{ rootduration }}</scaleLevel> sec.<br />',
          leveltip: {
            label: [
              "Dégâts",
              "Coût en mana",
        ...
        },
        {
          ...
          name: "Zéro absolu",
          description:
            "Nunu et Willump créent un puissant blizzard dans une zone, ce qui ralentit les ennemis et inflige d'importants dégâts à la fin du sort.",
          tooltip:
            "Willump canalise le sort pendant {{ channelduration }} sec, créant un puissant blizzard. Les ennemis dans le blizzard sont ralentis de {{ slowstartamount*-100 }}%, et ce ralentissement augmente à {{ maxslowamount*-100 }}% sur la durée. Nunu et Willump reçoivent un bouclier qui absorbe {{ totalshieldamount }} pts de dégâts et qui se désagrège en {{ shielddecayduration }} sec à la fin du blizzard.<br /><br />À la fin du blizzard, les ennemis pris dans la zone subissent jusqu'à <magicDamage>{{ maximumdamage }} pts de dégâts magiques</magicDamage>, selon la durée du blizzard.",
          leveltip: {
            label: ["Dégâts", "PV du bouclier", "Délai de récupération"],
            effect: [
              "{{ basedamage }} -> {{ basedamageNL }}",
      ...
      passive: {
        ...
        description:
          "Nunu augmente les vitesses d'attaque et de déplacement de Willump et d'un allié proche, et les attaques de base de Willump infligent des dégâts aux ennemis proches de la cible.",
        image: {
          ...
          blocks: [
            {
              ...
              hideIfSummonerSpell: "",
              items: [
                { id: "3112", count: 1, hideCount: false },
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              hideIfSummonerSpell: "",
              items: [
                { id: "3711", count: 1, hideCount: false },
                { id: "3751", count: 1, hideCount: false },
                { id: "1001", count: 1, hideCount: false },
              ],
            },
            {
              ...
              hideIfSummonerSpell: "",
              items: [
                { id: "1409", count: 1, hideCount: false },
                { id: "3047", count: 1, hideCount: false },
                { id: "3110", count: 1, hideCount: false },
              ],
            },
            {
              type: "defensivejungle",
              recMath: false,
              recSteps: false,
              minSummonerLevel: -1,
              maxSummonerLevel: -1,
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              hiddenWithAnyOf: [""],
              items: [
                { id: "2055", count: 1, hideCount: false },
                { id: "2138", count: 1, hideCount: true },
              ],
            },
          ],
