...
const Rammus2 = {
  ...
  data: {
    Rammus: {
      ...
      skins: [
        { id: "33000", num: 0, name: "default", chromas: false },
        { id: "33001", num: 1, name: "Roi Rammus", chromas: false },
        { id: "33002", num: 2, name: "Rammus de chrome", chromas: false },
        { id: "33003", num: 3, name: "Rammus fondu", chromas: false },
        { id: "33004", num: 4, name: "Rammus de Freljord", chromas: false },
        { id: "33005", num: 5, name: "Rammus ninja", chromas: false },
        { id: "33006", num: 6, name: "Full Metal Rammus", chromas: false },
        {
          id: "33007",
          num: 7,
          name: "Rammus gardien des sables",
          chromas: false,
        },
        { id: "33008", num: 8, name: "Rammus libéro", chromas: true },
        { id: "33016", num: 16, name: "Rammus Hextech", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          tooltip:
            "Rammus accélère sous forme de boule, gagnant jusqu'à <scaleLevel>{{ f2 }}%</scaleLevel> de vitesse de déplacement en {{ e4 }} sec. Il s'arrête en touchant un ennemi, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis proches, les repoussant et les ralentissant de {{ e2 }}% pendant {{ e3 }} sec.<br /><br /><rules><span class=\"color8c8c8c\">La compétence peut être réactivée pour mettre fin à l'effet plus tôt et lancer le délai de récupération de Démolisseur.<br />Démolisseur est un sort canalisé et peut donc être interrompu par les sorts qui empêchent les canalisations.<br />Activer Démolisseur annule Boule défensive et le met en récupération.</span></rules>",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Rammus prend une posture défensive. Son armure et sa résistance magique sont grandement augmentées, les dégâts de Carapace cloutée sont augmentés et Rammus renvoie des dégâts aux ennemis qui lui lancent des attaques de base, mais il est ralenti.",
          tooltip:
            'Rammus prend une posture défensive pendant un maximum de {{ e3 }} sec, augmentant son armure de {{ e1 }} plus {{ e6 }}% <scaleArmor>({{ f1 }})</scaleArmor> et sa résistance magique de {{ e8 }} plus {{ e7 }}% <span class="colorFF00FF">({{ f2 }})</span>, mais devenant ralenti de {{ e5 }}%.<br /><br />Pendant cette durée, Carapace cloutée inflige {{ e4 }}% de dégâts et inflige aussi ses dégâts aux ennemis qui lancent des attaques de base sur Rammus.<br /><br /><rules><span class="color8c8c8c">La compétence peut être réactivée pour mettre fin à l\'effet plus tôt et lancer le délai de récupération de Boule défensive.<br />Activer Boule défensive annule Démolisseur et le met en récupération.</span></rules>',
          leveltip: {
            label: ["Bonus en armure", "Bonus en résistance magique"],
            effect: ["{{ e6 }}% -> {{ e6NL }}%", "{{ e7 }}% -> {{ e7NL }}%"],
          },
          maxrank: 5,
          cooldown: [6, 6, 6, 6, 6],
          cooldownBurn: "6",
          ...
          vars: [{ link: "armor", coeff: 0.1, key: "f1" }],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
          range: [300, 300, 300, 300, 300],
          rangeBurn: "300",
        ...
        },
        {
          ...
          tooltip:
            "Rammus provoque un champion ennemi ou un monstre pendant {{ e1 }} sec et gagne {{ e2 }}% de vitesse d'attaque pendant la même durée.<br /><br />Quand tout autre sort de Rammus est actif, le bonus de Provocation frénétique en vitesse d'attaque est actualisé.",
          leveltip: {
            label: ["Durée", "Vitesse d'attaque", "Délai de récupération"],
            effect: [
              "{{ e1 }} -> {{ e1NL }}",
              "{{ e2 }}% -> {{ e2NL }}%",
              "{{ cooldown }} -> {{ cooldownNL }}",
        ...
        },
        {
          ...
          name: "Secousses",
          description:
            "Rammus fait trembler le sol, infligeant des dégâts aux ennemis proches et les ralentissant. Les tourelles subissent le double des dégâts.",
          tooltip:
            "Rammus fait trembler le sol pendant {{ duration }} sec, infligeant {{ damagecalc }} pts de dégâts magiques aux ennemis proches et les ralentissant de {{ slowperstack*100 }}% pendant {{ slowduration }} sec (cumulable {{ numberofpulses }} fois).<br /><br />Secousses inflige {{ turretdamagemodifier*100 }}% de dégâts aux tourelles.",
          leveltip: {
            label: [
              "Dégâts par secousse",
