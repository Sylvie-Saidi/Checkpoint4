const Kalista2 = {
  ...
  data: {
    Kalista: {
      ...
      skins: [
        { id: "429000", num: 0, name: "default", chromas: false },
        { id: "429001", num: 1, name: "Kalista lune de sang", chromas: false },
        { id: "429002", num: 2, name: "Kalista du championnat", chromas: true },
        { id: "429003", num: 3, name: "SKT T1 Kalista", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Perforation",
          description:
            "Kalista projette une lance rapide qui traverse les ennemis ainsi tués.",
          tooltip:
            'Projette une lance fine et rapide qui inflige {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques. Déclenche <span class="colorFFFFFF"><i>Maintien martial</i> (P)</span>, <span class="colorFFFFFF"><i>Sentinelle</i> (Z)</span> et <span class="colorFFFFFF"><i>Extirpation</i> (E)</span>.<br /><br /><scaleArmor>Si la lance tue une cible, </scaleArmor><span class="colorFFFFFF"><i>Perforation</i></span><span class="colorFFFF00"> continue sur sa trajectoire, transférant tous les effets <span class="colorFFFFFF"><i>Extirpation</i></span> à la cible suivante.</span>',
          leveltip: {
            label: ["Coût en @AbilityResourceName@", "Dégâts"],
            effect: ["{{ cost }} -> {{ costNL }}", "{{ e1 }} -> {{ e1NL }}"],
          },
          maxrank: 5,
          cooldown: [8, 8, 8, 8, 8],
          cooldownBurn: "8",
          ...
          vars: [{ link: "attackdamage", coeff: 1, key: "a1" }],
        ...
        },
        {
          ...
          name: "Sentinelle",
          description:
            "Inflige des dégâts supplémentaires quand Kalista et son pactisant frappent la même cible. <br><br>Activez pour envoyer une âme patrouiller le long d'une route, révélant la zone devant elle.",
          tooltip:
            "<spellPassive>Passive : </spellPassive>quand Kalista et son <i>pactisant</i> lancent une attaque de base sur la même cible, Kalista inflige des dégâts magiques équivalents à {{ e2 }}% des PV max de la cible. {{ e7 }} sec de récupération par cible.<br /><br /><spellPassive>Active : </spellPassive>envoie une âme patrouiller dans une zone non explorée. La patrouille révèle pendant 4 sec les champions aperçus. La patrouille dure 3 trajets.<br /><br />Kalista gagne une charge de Sentinelle toutes les {{ e4 }} sec.",
          leveltip: {
            label: ["Dégâts", "Recharge des munitions"],
            effect: ["{{ e2 }}% -> {{ e2NL }}%", "{{ e4 }} -> {{ e4NL }}"],
          },
          maxrank: 5,
          ...
          costType: " {{ abilityresourcename }}",
          maxammo: "2",
          range: [5000, 5000, 5000, 5000, 5000],
          rangeBurn: "5000",
          image: {
            full: "KalistaW.png",
            sprite: "spell5.png",
        ...
        },
        {
          ...
          name: "Extirpation",
          description:
            "Les attaques plantent des lances dans leurs cibles. Activez pour extirper les lances, ralentissant les ennemis et leur infligeant des dégâts augmentés.",
          tooltip:
            '<spellPassive>Passive : </spellPassive>les lances de Kalista se plantent dans leur cible pendant 4 sec.<br /><br /><spellPassive>Active : </spellPassive>arrache les lances des cibles proches, infligeant {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques et réduisant leur vitesse de déplacement de {{ e2 }}% pendant {{ e6 }} sec.<br /><br />Chaque lance supplémentaire inflige {{ e9 }} <scaleAD>(+{{ f4 }})</scaleAD> pts de dégâts physiques.<br /><br /><scaleArmor>Si </scaleArmor><span class="colorFFFFFF"><i>Extirpation</i></span><span class="colorFFFF00"> tue au moins une cible, son délai de récupération est annulé et Kalista récupère <scaleMana>{{ e8 }}</scaleMana> pts de mana.</span><br /><br /><rules>Extirpation inflige {{ epicmonsterdamagemod*100 }}% de dégâts aux monstres épiques.</rules>',
          leveltip: {
            label: [
              "Dégâts",
              "Ralentissement",
          ...
          vars: [{ link: "attackdamage", coeff: 0.6, key: "a1" }],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
        ...
        },
        {
          ...
          description:
            "Kalista téléporte le pactisant allié auprès d'elle. Le pactisant peut ensuite charger vers une position pour repousser tous les champions ennemis proches.",
          tooltip:
            "Attire vers Kalista son <i>pactisant</i>. Pendant 4 sec max, le pactisant ne peut pas être ciblé et est pacifié.<br /><br />Le pactisant peut cliquer pour voler vers l'endroit ciblé et il s'arrête au premier champion ennemi touché, repoussant tous les ennemis dans un petit rayon.<br /><br />Le pactisant de Kalista ne doit pas être à plus de 1100 unités d'elle pour que cette compétence soit disponible.",
          leveltip: {
            label: ["Délai de récupération", "Durée de la projection"],
            effect: [
              "{{ cooldown }} -> {{ cooldownNL }}",
              "{{ e2 }} -> {{ e2NL }}",
            ],
      ...
      passive: {
        ...
        description:
          "Donnez un ordre de déplacement pendant l'animation de l'attaque de base ou de la Perforation de Kalista pour bondir sur une petite distance dans cette direction après avoir lancé l'attaque.",
        image: {
