  ...
  data: {
    RekSai: {
      ...
      skins: [
        ...
        { id: "421001", num: 1, name: "Rek'Sai eternum", chromas: false },
        { id: "421002", num: 2, name: "Requ'Sai", chromas: true },
        {
          id: "421009",
          num: 9,
      ...
      spells: [
        {
          ...
          description:
            "Les 3 prochaines attaques de base de Rek'Sai infligent des dégâts physiques supplémentaires aux ennemis proches.<br><br>Enfouie, Rek'Sai tire un projectile chargé en énergie du Néant qui inflige des dégâts physiques aux ennemis touchés, en plus de les révéler.",
          tooltip:
            "<scaleAD>En surface :</scaleAD> les 3 prochaines attaques de base de Rek'Sai dans les 5 sec infligent {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques supplémentaires aux ennemis proches.<br /><br /><scaleAD>Enfouie :</scaleAD> Rek'Sai tire un projectile chargé en énergie du Néant qui explose sur le premier ennemi touché, infligeant {{ e4 }} <scaleAP>(+{{ a2 }})</scaleAP> <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques et révélant pendant {{ e6 }} sec les ennemis non furtifs. Si le projectile touche un champion, Rek'Sai génère aussi <keywordMajor>25 pts de Fureur</keywordMajor>.",
          leveltip: {
            label: [
              "Dégâts de Courroux de la reine",
              "Dégâts de Sondeur explosif",
              "Délai de récupération de Sondeur explosif",
            ],
            effect: [
              "{{ e1 }} -> {{ e1NL }}",
              "{{ e4 }} -> {{ e4NL }}",
          ...
          vars: [
            { link: "bonusattackdamage", coeff: 0.5, key: "a1" },
        ...
        },
        {
          ...
          description:
            "Rek'Sai plonge sous terre, gagnant de nouvelles compétences et augmentant sa vitesse de déplacement. La portée de sa vision est réduite et elle ne peut plus lancer d'attaque de base.<br><br>Enfouie, Rek'Sai peut utiliser Jaillissement pour projeter en l'air et blesser les ennemis proches.",
          tooltip:
            "<scaleAD>En surface :</scaleAD> Rek'Sai plonge sous terre. <br /><br /><scaleAD>Enfouie :</scaleAD> Rek'Sai jaillit du sol, infligeant {{ e2 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques et projetant en l'air l'ennemi le plus proche pendant {{ e5 }} sec. Tous les autres ennemis proches sont repoussés. Un ennemi projeté en l'air ne peut plus être affecté par Jaillissement pendant {{ e6 }} sec.<br /><br /><scaleAD>Effets d'Enfouissement :</scaleAD> nouvelles compétences, <scaleLevel>+{{ f1 }}</scaleLevel> vitesse de déplacement, portée de vue réduite, attaques de base impossibles et gain de <span class=\"color993299\">Sens tellurique</span> : les ennemis proches qui se déplacent dans le brouillard de guerre sont révélés à Rek'Sai et ses alliés.",
          leveltip: {
            label: ["Dégâts de Jaillissement"],
            effect: ["{{ e2 }} -> {{ e2NL }}"],
          },
          maxrank: 5,
          cooldown: [4, 4, 4, 4, 4],
          ...
          vars: [{ link: "bonusattackdamage", coeff: 0.8, key: "a1" }],
          costType: "Pas de coût",
          maxammo: "-1",
        ...
        },
        {
          ...
          description:
            "Rek'Sai mord sa cible, infligeant le double de dégâts et des dégâts bruts si sa jauge de Fureur est pleine.<br><br>Enfouie, Rek'Sai crée un tunnel durable et réutilisable. Les ennemis peuvent le détruire en se tenant sur l'une des entrées.",
          tooltip:
            "<scaleAD>En surface :</scaleAD> Rek'Sai mord une cible et lui inflige {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques. Si la jauge de Fureur est pleine, les dégâts sont doublés et deviennent bruts.<br /><br />Dégâts max : <scaleLevel>{{ f2 }}</scaleLevel><br /><br /><scaleAD>Enfouie :</scaleAD> Rek'Sai creuse un tunnel et crée ainsi deux <span class=\"color993299\">entrées de tunnel</span> connectées. Cliquer sur une <span class=\"color993299\">entrée de tunnel</span> permet à Rek'Sai de ressortir par l'autre entrée.<br /><br />Les <span class=\"color993299\">entrées de tunnel</span> durent {{ e5 }} minutes et peuvent être détruites par les ennemis. Rek'Sai peut avoir jusqu'à {{ e6 }} tunnels simultanément. Les tunnels ont un délai de récupération de {{ e8 }} sec à l'utilisation.",
          leveltip: {
            label: [
              "Dégâts de Morsure féroce",
          ...
          vars: [{ link: "bonusattackdamage", coeff: 0.85, key: "a1" }],
          costType: "Pas de coût",
          maxammo: "-1",
        ...
        },
        {
          ...
          name: "Rush du Néant",
          description:
            "Rek'Sai marque passivement ses cibles en leur infligeant des dégâts. Elle peut activer cette compétence pour devenir brièvement impossible à cibler et bondir sur une cible marquée, infligeant d'importants dégâts selon les PV manquants de cette cible.",
          tooltip:
            '<span class="colorFF8C00">Passive :</span> infliger des dégâts à des champions ennemis les marque pendant {{ preymarkduration }} sec.<br /><br /><span class="colorFF8C00">Active :</span> Rek\'Sai pousse un hurlement avant de s\'enfouir dans le sol en cherchant une cible marquée. Quelques instants plus tard, Rek\'Sai jaillit du sol, infligeant {{ rbasedamagecalc }} pts de dégâts physiques plus {{ percentmissinghealthdamage }}% des PV manquants de la cible.',
          leveltip: {
            label: [
              "Dégâts",
      ...
      passive: {
        ...
        description:
          "Quand Rek'Sai est en surface, ses attaques de base et ses sorts génèrent de la Fureur. Quand elle s'enfouit, Rek'Sai consomme sa Fureur pour récupérer des PV.",
        image: {
