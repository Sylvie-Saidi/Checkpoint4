...
const Nami2 = {
  ...
  data: {
    Nami: {
      ...
      skins: [
        { id: "267000", num: 0, name: "default", chromas: false },
        { id: "267001", num: 1, name: "Koi Nami", chromas: true },
        { id: "267002", num: 2, name: "Nami naïade", chromas: false },
        { id: "267003", num: 3, name: "Urf le Nami-tin", chromas: false },
        { id: "267007", num: 7, name: "Nami des abysses", chromas: false },
        { id: "267008", num: 8, name: "SKT T1 Nami", chromas: false },
        { id: "267009", num: 9, name: "Programme Nami", chromas: true },
        {
          id: "267015",
          num: 15,
      ...
      spells: [
        {
          ...
          name: "Prison aqueuse",
          description:
            "Envoie une bulle sur la zone ciblée, infligeant des dégâts et étourdissant tous les ennemis à l'impact.",
          tooltip:
            "Envoie une bulle sur la zone ciblée, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis et les étourdissant pendant {{ e2 }} sec.",
          leveltip: {
        ...
        },
        {
          ...
          tooltip:
            'Projette un flux d\'eau qui rebondit sur les champions alliés et sur les champions ennemis visibles.<br /><br /><span class="colorCCFF99">Sur un allié : </span>rend {{ e3 }} <scaleAP>(+{{ a2 }})</scaleAP> PV et rebondit vers un champion ennemi visible à proximité.<br /><br /><span class="colorFF9999">Sur un ennemi : </span>inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et rebondit vers un champion allié proche.<br /><br />Ne peut rebondir qu\'une seule fois sur chaque cible, et peut toucher jusqu\'à {{ e2 }} cibles. Les soins et dégâts sont modifiés de <scaleAP>({{ f1 }}%)</scaleAP> à chaque rebond. ',
          leveltip: {
            label: ["Soins", "Dégâts", "Coût en @AbilityResourceName@"],
            effect: [
              "{{ e3 }} -> {{ e3NL }}",
              "{{ e1 }} -> {{ e1NL }}",
              "{{ cost }} -> {{ costNL }}",
        ...
        },
        {
          ...
          description:
            "Renforce un champion allié pendant un court instant, permettant à ses attaques de base et à ses sorts d'infliger des dégâts magiques supplémentaires et de ralentir sa cible.",
          tooltip:
            "Renforce les {{ e4 }} prochains sorts et attaques de base d'un champion allié, leur permettant de ralentir leur cible de {{ e2 }}% <scaleAP>(+{{ a2 }}%)</scaleAP> pendant {{ e3 }} sec et d'infliger {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques supplémentaires. Dure {{ e5 }} sec.<br /><br /><rules><br />Les sorts à effet de zone renforcés infligent {{ aoemod }} pts de dégâts aux non-champions.<br /></rules>",
          leveltip: {
            label: [
              "Dégâts",
              "Ralentissement",
        ...
        },
        {
          ...
          name: "Raz-de-marée",
          description:
            "Invoque un énorme raz-de-marée qui projette tous les ennemis touchés en l'air, les ralentit et les blesse. Les alliés touchés gagnent le double de l'effet de Déferlantes.",
          tooltip:
            "Invoque un raz-de-marée qui part de Nami. La vague projette les ennemis en l'air et les ralentit de {{ e4 }}%, en plus de leur infliger {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques. La durée du ralentissement augmente avec la distance parcourue par le raz-de-marée ({{ e3 }} sec minimum, {{ e5 }} sec maximum).<br /><br />Les alliés touchés gagnent le double de l'effet de Déferlantes.",
          leveltip: {
