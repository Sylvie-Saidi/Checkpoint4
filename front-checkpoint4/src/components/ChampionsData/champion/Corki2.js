const Corki2 = {
  ...
  data: {
    Corki: {
      ...
      skins: [
        { id: "42000", num: 0, name: "default", chromas: false },
        { id: "42001", num: 1, name: "Corki OVNI", chromas: false },
        { id: "42002", num: 2, name: "Corki toboggan", chromas: false },
        { id: "42003", num: 3, name: "Corki le baron rouge", chromas: false },
        { id: "42004", num: 4, name: "Corki Hot Rod", chromas: false },
        { id: "42005", num: 5, name: "Corki Urfrider", chromas: false },
        { id: "42006", num: 6, name: "Corki ailes du dragon", chromas: true },
        { id: "42007", num: 7, name: "Fnatic Corki", chromas: false },
        { id: "42008", num: 8, name: "Corki arcade", chromas: true },
        { id: "42018", num: 18, name: "Corki corgi", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Corki tire une bombe éclairante à l'endroit visé, infligeant des dégâts magiques aux ennemis dans la zone. Cette attaque révèle pendant un temps les unités dans la zone.",
          tooltip:
            "Corki lance une bombe, infligeant {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis dans la zone ciblée. De plus, l'explosion révèle la zone et les champions touchés pendant {{ e2 }} sec (ne révèle pas les unités furtives).",
          leveltip: {
        ...
        },
        {
          ...
          name: "Valkyrie",
          description:
            "Corki franchit une courte distance, lâchant des bombes et créant une traînée de feu qui inflige des dégâts aux ennemis.",
          tooltip:
            "<spellPassive>Active :</spellPassive> Corki franchit une courte distance, infligeant <magicDamage>{{ totaldamagepersecond }} pts de dégâts magiques</magicDamage> par seconde aux ennemis pris dans les flammes qu'il laisse derrière lui.<br /><br /><spellPassive>Livraison spéciale :</spellPassive> Corki franchit une grande distance, larguant des bombes qui laissent une traînée brûlante pendant {{ spell.carpetbombmega:trailduration }} sec. La traînée de feu ralentit les ennemis de {{ spell.carpetbombmega:slowamount*100 }}% et leur inflige une brûlure de <magicDamage>{{ spell.carpetbombmega:totaldamagepersecond }} pts de dégâts magiques</magicDamage> par seconde.<br /><br />Les ennemis touchés directement sont repoussés sur le côté, mais sont ralentis et brûlés pendant au moins {{ spell.carpetbombmega:directburnduration }} sec.",
          leveltip: {
            label: ["Dégâts par seconde", "Délai de récupération"],
            effect: [
        ...
        },
        {
          ...
          name: "Gatling",
          description:
            "La mitrailleuse de Corki tire rapidement dans une zone conique face à lui, infligeant des dégâts et réduisant l'armure et la résistance magique de l'ennemi.",
          tooltip:
            "Corki mitraille les ennemis devant lui pendant {{ e2 }} sec, infligeant jusqu'à {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts et réduisant l'armure et la résistance magique des ennemis de {{ e4 }} au maximum.<br /><br /><span class=\"color919191\"><i>{{ e7 }}% des dégâts de Gatling sont physiques, et {{ e8 }}% sont magiques.<br />La réduction des défenses dure {{ e6 }} sec après avoir été touché pour la dernière fois par Gatling.</i></span>",
          leveltip: {
            label: ["Dégâts", "Réduction des défenses"],
            effect: [
              "{{ e1 }} -> {{ e1NL }}",
          ...
          vars: [{ link: "bonusattackdamage", coeff: 1.6, key: "a1" }],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
          range: [600, 600, 600, 600, 600],
          rangeBurn: "600",
        ...
        },
        {
          ...
          description:
            "Corki tire un projectile dans une direction. Il explose à l'impact et inflige des dégâts aux ennemis dans la zone. Corki stocke des projectiles sur la durée, jusqu'à un maximum donné. Un projectile sur 3 est une grosse Bertha qui inflige plus de dégâts.",
          tooltip:
            "<spellPassive>Active :</spellPassive> Corki tire un projectile qui explose contre le premier ennemi touché, infligeant {{ rsmallmissiledamage }} pts de dégâts magiques à tous les ennemis proches.<br /><br />Corki peut stocker jusqu'à 7 projectiles. Un projectile sur 3 est une grosse Bertha qui inflige {{ rbigonemultiplier*100 }}% de dégâts ({{ rbigmissiledamage }}).",
          leveltip: {
            label: ["Dégâts", "Vitesse d'attaque", "Délai de rechargement"],
            effect: [
      ...
      passive: {
        ...
        description:
          "Les attaques de base de Corki infligent un pourcentage de leurs dégâts physiques sous forme de dégâts magiques. Régulièrement, le Paquet est déposé dans la base de Corki. Si celui-ci le récupère, il reçoit un bonus en vitesse de déplacement en dehors des combats et améliore Valkyrie en Livraison spéciale.",
        image: {
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              hiddenWithAnyOf: [""],
              items: [
                { id: "3008", count: 1, hideCount: false },
