...
const Malphite2 = {
  ...
  data: {
    Malphite: {
      ...
      skins: [
        { id: "54000", num: 0, name: "default", chromas: false },
        { id: "54001", num: 1, name: "Malphite aux trèfles", chromas: false },
        { id: "54002", num: 2, name: "Malphite corallien", chromas: false },
        { id: "54003", num: 3, name: "Malphite de marbre", chromas: false },
        { id: "54004", num: 4, name: "Malphite d'obsidienne", chromas: false },
        { id: "54005", num: 5, name: "Malphite glacial", chromas: false },
        { id: "54006", num: 6, name: "Mecha Malphite", chromas: true },
        { id: "54007", num: 7, name: "Malphite flibustier", chromas: false },
        { id: "54016", num: 16, name: "Malphite de l'Odyssée", chromas: true },
        {
          id: "54023",
          num: 23,
        ...
        },
        {
          id: "54024",
          num: 24,
          name: "Malphite du pulsar sombre édition prestige",
          chromas: false,
        },
        { id: "54025", num: 25, name: "FPX Malphite", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Éclat sismique",
          description:
            "Utilisant sa magie élémentaire primale, Malphite envoie un éclat de terre à son ennemi à travers le sol, infligeant des dégâts à l'impact et lui dérobant sa vitesse de déplacement pendant 3 sec.",
          tooltip:
            "Inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et vole {{ e2 }}% de la vitesse de déplacement de la cible pendant 3 sec.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Malphite attaque avec tant de force qu'il crée des bangs supersoniques. Pendant quelques secondes, ses attaques produisent des ondes de choc devant lui.",
          tooltip:
            "<spellPassive>Passive : </spellPassive>l'armure de Malphite est augmentée de {{ e1 }}% (<scaleArmor>{{ f1 }}</scaleArmor>). Cet effet est triplé quand Bouclier de granit est actif.<br /><br /><spellPassive>Active : </spellPassive>pendant 5 sec, les attaques de base de Malphite produisent des ondes de choc infligeant {{ thunderclapsplash }} pts de dégâts physiques dans une zone conique.  Sa première attaque après l'activation de Coup de tonnerre inflige {{ totalbonusdamage }} pts de dégâts physiques supplémentaires à sa cible.",
          leveltip: {
            label: [
              "Armure",
              "Dégâts",
              "Dégâts de zone des ondes de choc",
              "Coût en @AbilityResourceName@",
            ],
            effect: [
        ...
        },
        {
          ...
          name: "Choc au sol",
          description:
            "Malphite frappe le sol, déclenchant une onde de choc qui inflige des dégâts magiques en fonction de son armure et qui réduit la vitesse d'attaque des ennemis un court instant.",
          tooltip:
            "Malphite frappe le sol, infligeant {{ e2 }} <scaleArmor>(+{{ f1 }})</scaleArmor> <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis proches, en plus de réduire leur vitesse d'attaque de {{ e1 }}% pendant {{ e4 }} sec.<br /><br />Cette compétence inflige des dégâts supplémentaires équivalents à {{ e3 }}% de l'armure de Malphite.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          tooltip:
            "Malphite charge vers la zone ciblée. En bout de course, il inflige {{ e2 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis proches et les propulse dans les airs pendant {{ e3 }} sec.",
          leveltip: {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                { id: "3118", count: 1, hideCount: false },
              ],
            },
          ],
        },
