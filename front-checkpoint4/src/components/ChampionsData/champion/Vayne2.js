...
const Vayne2 = {
  ...
  data: {
    Vayne: {
      ...
      skins: [
        { id: "67000", num: 0, name: "default", chromas: false },
        { id: "67001", num: 1, name: "Vayne justicière", chromas: false },
        { id: "67002", num: 2, name: "Vayne aristocrate", chromas: false },
        { id: "67003", num: 3, name: "Vayne tueuse de dragons", chromas: true },
        { id: "67004", num: 4, name: "Vayne cœur-de-cible", chromas: false },
        { id: "67005", num: 5, name: "SKT T1 Vayne", chromas: false },
        {
          id: "67006",
          num: 6,
        ...
        { id: "67010", num: 10, name: "Vayne voleuse d'âmes", chromas: false },
        { id: "67011", num: 11, name: "PROJET : Vayne", chromas: false },
        {
          id: "67012",
          num: 12,
        ...
        },
        {
          id: "67013",
          num: 13,
          name: "Vayne pyrotechnicienne édition prestige",
          chromas: false,
        },
        { id: "67015", num: 15, name: "FPX Vayne", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          tooltip:
            "Vayne fait une roulade sur une courte distance. Dans les {{ duration }} sec qui suivent, sa prochaine attaque de base inflige <scaleAD>{{ adratiobonus }}</scaleAD> pts de dégâts physiques supplémentaires. <br /><br /><rules>Les dégâts supplémentaires de Roulade sont équivalents à {{ totaladratio*100 }}% des dégâts d'attaque de Vayne.</rules>",
          leveltip: {
            label: ["Délai de récupération", "Ratio de dégâts d'attaque"],
            effect: [
              "{{ cooldown }} -> {{ cooldownNL }}",
        ...
        },
        {
          ...
          tooltip:
            "La troisième attaque ou compétence consécutive contre un ennemi inflige des dégâts bruts supplémentaires équivalents à {{ maxhealthratio*100 }}% des PV max de l'ennemi (minimum : {{ damagefloor }}).<br /><br /><rules>Carreaux d'argent n'inflige pas plus de {{ damagemaxvsmonsters }} pts de dégâts aux monstres.</rules>",
          leveltip: {
            label: ["Pourcentage de dégâts bruts", "Dégâts minimum"],
            effect: [
        ...
        },
        {
          ...
          tooltip:
            "Tire un carreau qui repousse une cible et lui inflige {{ totaldamage }} pts de dégâts. Si la cible percute le décor, les dégâts sont augmentés de {{ stundamage*100 }}% et la cible est étourdie pendant {{ stunduration }} sec. ",
          leveltip: {
        ...
        },
        {
          ...
          name: "Combat ultime",
          description:
            "Vayne se prépare à un combat épique ; ses dégâts d'attaque augmentent, elle devient invisible pendant Roulade, le délai de récupération de Roulade est réduit et le bonus de vitesse de Chasseur nocturne est augmenté.",
          tooltip:
            "Vayne augmente ses dégâts d'attaque de {{ bonusattackdamage }} et améliore Chasseur nocturne et Roulade pendant {{ baseduration }} sec. La durée de Combat ultime est augmentée de {{ durationtoadd }} sec chaque fois qu'un champion blessé par Vayne meurt dans les {{ damagedmarkerduration }} sec qui suivent. <br /><br /><span class=\"colorF0F0F0\">Chasseur nocturne </span>: le bonus en vitesse de déplacement passe à {{ movementspeed }}.<br /><span class=\"colorF0F0F0\">Roulade </span>: le délai de récupération est réduit de {{ tumblecdreduction }}% et Vayne devient <keywordStealth>invisible</keywordStealth> pendant {{ tumblestealthduration }} sec quand elle effectue une Roulade.<br /><br /><rules><keywordStealth>Furtivité - Invisibilité :</keywordStealth> Vayne ne peut être révélée que par les tourelles ennemies proches ou la <keywordStealth>vision pure</keywordStealth>.<br />L'augmentation de la durée de Combat ultime ne permet pas de dépasser la durée maximum d'origine.</rules>",
          leveltip: {
            label: [
              "Délai de récupération",
              "Durée",
              "Dégâts d'attaque supplémentaires",
              "Réduction du délai de récupération de Roulade",
            ],
            effect: [
              "{{ cooldown }} -> {{ cooldownNL }}",
      ...
      passive: {
        ...
        description:
          "Vayne traque sans relâche les êtres malfaisants, augmentant sa vitesse de déplacement de 30 vers les champions ennemis proches.",
        image: {
