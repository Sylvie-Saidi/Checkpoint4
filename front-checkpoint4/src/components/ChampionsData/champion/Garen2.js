const Garen2 = {
  ...
  data: {
    Garen: {
      ...
      skins: [
        { id: "86000", num: 0, name: "default", chromas: true },
        { id: "86001", num: 1, name: "Garen sanguin", chromas: false },
        { id: "86002", num: 2, name: "Garen soldat du désert", chromas: false },
        { id: "86003", num: 3, name: "Garen commando", chromas: false },
        {
          id: "86004",
          num: 4,
        ...
        { id: "86005", num: 5, name: "Garen vagabond", chromas: false },
        {
          id: "86006",
          num: 6,
        ...
        { id: "86010", num: 10, name: "Garen amiral renégat", chromas: false },
        {
          id: "86011",
          num: 11,
        ...
        { id: "86013", num: 13, name: "Dieu-roi Garen", chromas: false },
        { id: "86014", num: 14, name: "Garen Demacia Vice", chromas: true },
        {
          id: "86022",
          num: 22,
        ...
        },
        {
          id: "86023",
          num: 23,
          name: "Garen du royaume des mechas édition prestige",
          chromas: false,
        },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Coup décisif",
          description:
            "Garen reçoit un bonus en vitesse de déplacement et purge tous les ralentissements qui l'affectent. Sa prochaine attaque frappe un point vital de son adversaire, infligeant des dégâts supplémentaires et le réduisant au silence.",
          tooltip:
            "Garen purge tous les ralentissements qui l'affectent et augmente sa vitesse de déplacement de {{ movementspeedamount*100 }}% pendant {{ movementspeedduration }} sec.<br /><br />Sa prochaine attaque de base dans les {{ attackwindow }} sec inflige <physicalDamage>{{ totaldamage }} pts de dégâts physiques</physicalDamage> et réduit la cible au silence pendant {{ silenceduration }} sec.",
          leveltip: {
            label: ["Dégâts", "Durée du bonus en vitesse de déplacement"],
            effect: [
        ...
        },
        {
          ...
          tooltip:
            '<span class="colorFF9900">Passive :</span> tuer des unités augmente définitivement l\'armure et la résistance magique de {{ resistgainonkill }}, jusqu\'à un maximum de {{ resistmax }}. Au maximum d\'effets cumulés, Garen augmente son armure et sa résistance magique supplémentaires de {{ percentbonus*100 }}%. <br />Bonus actuel : <scaleArmor>{{ f1 }} + {{ f2.0 }}</scaleArmor> armure et <span class="colorFF00FF">{{ f1 }} + {{ f3.0 }}</span> résistance magique. <br /><br /><span class="colorFF9900">Active : </span>Garen rassemble tout son courage pendant {{ drduration }} sec, réduisant de {{ drpercent*100 }}% les dégâts qui le ciblent. Pendant les {{ upfrontduration }} premières secondes, il gagne aussi un bouclier pouvant bloquer {{ totalshield }} pts de dégâts et il augmente sa Ténacité de {{ upfronttenacity*100 }}%.',
          leveltip: {
            label: ["Durée", "Délai de récupération", "PV du bouclier"],
            effect: [
        ...
        },
        {
          ...
          tooltip:
            "Garen donne des coups d'épée tourbillonnants pendant {{ duration }} sec, infligeant <physicalDamage>{{ totaldamage }} pts de dégâts physiques</physicalDamage> {{ f1 }} fois, et les dégâts augmentent à <physicalDamage>{{ totaldamagenearest }}</physicalDamage> contre l'ennemi le plus proche (le nombre de coups augmente avec la vitesse d'attaque venant des objets et des gains de niveau).<br /><br />Les champions ennemis touchés par {{ stackstoshred }} rotations perdent {{ shredamount*100 }}% de leur armure pendant {{ shredduration }} sec.",
          leveltip: {
            label: [
              "Dégâts par rotation",
              "Ratio de dégâts d'attaque par rotation",
            ],
            effect: [
        ...
        },
        {
          ...
          description:
            "Garen en appelle à la puissance de Demacia pour tenter d'exécuter un champion ennemi.",
          tooltip:
            "Garen en appelle à la puissance de Demacia pour tenter d'exécuter un champion ennemi, infligeant des dégâts bruts équivalents à {{ basedamage }} plus {{ executedamage*100 }}% des PV manquants de la cible.",
          leveltip: {
            label: [
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              maxSummonerLevel: -1,
              showIfSummonerSpell: "",
              hideIfSummonerSpell: "SummonerPoroThrow",
              appendAfterSection: "",
              visibleWithAllOf: [""],
              hiddenWithAnyOf: [""],
              items: [
