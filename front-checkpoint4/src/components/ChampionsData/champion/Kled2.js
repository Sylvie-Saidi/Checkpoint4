...
const Kled2 = {
  ...
  data: {
    Kled: {
      ...
      skins: [
        { id: "240000", num: 0, name: "default", chromas: false },
        { id: "240001", num: 1, name: "Sir Kled", chromas: false },
        { id: "240002", num: 2, name: "Comte Kledula", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Kled lance un piège à ours qui inflige des dégâts et s'accroche à un champion ennemi. Si la cible reste accrochée pendant un court instant, elle subit des dégâts physiques supplémentaires et est tirée vers Kled.<br><br>Si Kled est désarçonné, la compétence devient Pistolet de poche, un tir à distance qui projette Kled en arrière et restaure du courage.",
          tooltip:
            'Kled lance un piège à ours qui inflige {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques et s\'accroche au premier champion ennemi ou grand monstre touché, octroyant une <span class="coloree91d7">vision pure</span> de la cible. Inflige 150% de dégâts aux sbires traversés.<br /><br />Si Kled reste près d\'un ennemi accroché pendant {{ e3 }} sec, il tire l\'ennemi vers lui, lui inflige {{ e1 }}<scaleAD> (+{{ charbonusphysical*2 }})</scaleAD> pts de dégâts physiques, le ralentit de {{ slowamount*-100 }}% pendant {{ slowduration }} sec et réduit les soins reçus par la cible de {{ grievousamount*-100 }}% pendant {{ grievousduration }} sec.<br /><br /><scaleAD>Désarçonné :</scaleAD> devient Pistolet de poche, une compétence à distance qui restaure du <span class="coloreae57e">courage</span>.',
          leveltip: {
            label: [
              "Dégâts du lancer",
        ...
        },
        {
          ...
          description:
            "Kled augmente grandement sa vitesse d'attaque le temps de quatre attaques. La quatrième attaque inflige plus de dégâts.",
          tooltip:
            "<scaleAD>Passive :</scaleAD> quand Kled lance des attaques de base, il devient frénétique et augmente sa vitesse d'attaque de {{ e2 }}% le temps de quatre attaques ou pendant {{ e6 }} sec. Penchant pour la violence entre ensuite en récupération.<br /><br />Le quatrième coup inflige des dégâts physiques supplémentaires équivalents à {{ e4 }} plus {{ e1 }}% <scaleAD>(+{{ f1 }}%)</scaleAD> des PV max de la cible ({{ e7 }} pts de dégâts max contre les monstres).",
          leveltip: {
            label: [
              "Dégâts fixes",
        ...
        },
        {
          ...
          name: "Joute",
          description:
            "Kled fonce dans une direction, infligeant des dégâts physiques et bénéficiant d'un bref bonus en vitesse de déplacement. Kled peut réactiver cette compétence pour foncer en sens inverse à travers sa cible initiale, infligeant les mêmes dégâts.",
          tooltip:
            'Kled fonce dans une direction, infligeant {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques aux ennemis sur son chemin. Ne permet pas de franchir les murs.<br /><br />Si Joute touche un champion ennemi ou un grand monstre, Kled augmente sa vitesse de déplacement de {{ e5 }}% pendant {{ e4 }} sec et obtient une <span class="coloree91d7">vision pure</span> de la cible. Il peut réactiver cette compétence dans les {{ e6 }} sec pour foncer une fois de plus sur la même cible, infligeant les mêmes dégâts.',
          leveltip: {
        ...
        },
        {
          ...
          name: "Chaaaaaaaargez !!!",
          description:
            "Kled et Skaarl chargent vers la zone ciblée en s'entourant d'un bouclier et en laissant derrière eux une traînée qui augmente la vitesse des alliés. Skaarl fonce sur le premier champion ennemi qu'il rencontre.",
          tooltip:
            "Kled charge vers une zone, laissant derrière lui une traînée qui augmente la vitesse de déplacement des alliés. Pendant la charge, Kled s'entoure d'un bouclier dont les PV augmentent sur la durée, jusqu'à un maximum de {{ e4 }} <scaleAD>(+{{ a1 }})</scaleAD> PV. Le bouclier dure encore 2 sec après la fin de la charge.<br /><br />Skaarl fonce sur le premier champion ennemi rencontré, infligeant jusqu'à {{ f5 }}% <scaleAD>(+{{ f1*3 }}%)</scaleAD> des PV max de la cible sous forme de dégâts physiques en fonction de la distance parcourue.",
          leveltip: {
            label: [
              "Dégâts maximum",
              "PV max du bouclier",
          ...
          vars: [{ link: "bonusattackdamage", coeff: 3, key: "a1" }],
          costType: "Pas de coût",
          maxammo: "-1",
