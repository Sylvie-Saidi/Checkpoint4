const Zoe = {
  ...
  data: {
    Zoe: {
      ...
      skins: [
        { id: "142000", num: 0, name: "default", chromas: false },
        { id: "142001", num: 1, name: "Zoé cyberpop", chromas: false },
        { id: "142002", num: 2, name: "Zoé du petit bain", chromas: true },
        {
          id: "142009",
          num: 9,
      ...
      spells: [
        {
          ...
          name: "Astro-pong !",
          description:
            "Zoé lance un projectile qu'elle peut rediriger en vol. Les dégâts augmentent avec la distance parcourue en ligne droite.",
          tooltip:
            'Lance un projectile qui inflige des dégâts augmentant avec la distance parcourue : <scaleLevel>{{ f1 }}</scaleLevel> <scaleAP>(+{{ a1 }})</scaleAP> à <scaleLevel>{{ f2 }}</scaleLevel> <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts magiques. Les ennemis proches de la première cible touchée subissent {{ e4 }}% des dégâts.<span class="size5"><br /><br /><br /></span>Réactivez pour rediriger le projectile vers un autre point proche de Zoé.<br /><br /><rules>Les dégâts d\'Astro-pong ! dépendent du rang de cette compétence et du niveau de Zoé. </rules>',
          leveltip: {
            label: [
              "Dégâts de base",
          ...
          vars: [
            ...
            { link: "spelldamage", coeff: 1.5, key: "a2" },
          ],
        ...
        },
        {
          ...
          description:
            "Zoé peut ramasser les vestiges des sorts d'invocateur et des propriétés actives d'objets utilisés par les ennemis, puis les utiliser elle-même. Quand Zoé utilise un sort d'invocateur, elle tire aussi trois projectiles sur l'ennemi le plus proche.",
          tooltip:
            "Quand un ennemi utilise un sort d'invocateur ou la propriété active d'un objet, un fragment de sort apparaît pendant 40 sec. Certains sbires lâchent également des fragments de sort quand ils sont tués par Zoé.<br /><br /><spellPassive>Active : </spellPassive>ramasser un fragment de sort vous octroie le droit de lancer une fois ce sort ou cette propriété active d'objet.<br />                 ____________________________________________ <span class=\"size8\"><br /><br /></span><spellPassive>Passive : </spellPassive>quand Zoé utilise un sort d'invocateur ou Voleuse de sorts, elle augmente brièvement sa vitesse de déplacement de {{ e9 }}% pendant {{ e0 }} sec et lance jusqu'à 3 projectiles sur la cible de son attaque, infligeant {{ e8 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques au total. Chaque projectile peut appliquer Plus d'étincelles !<br /><br /><rules>Le bonus en vitesse de déplacement et les dégâts des projectiles augmentent avec le rang du sort.</rules>",
          leveltip: {
            label: [
              "Dégâts",
          ...
          rangeBurn: "3000/4500/6000/3000/3000",
          image: {
            full: "ZoeW.png",
            sprite: "spell14.png",
            group: "spell",
        ...
        },
        {
          ...
          description:
            "La cible devient somnolente, puis s'endort. La première attaque qui réveille la cible inflige deux fois plus de dégâts, jusqu'à un montant max.",
          tooltip:
            "Lance une bulle qui inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques, et qui se change en piège si elle ne touche rien. La portée de la bulle est augmentée si elle passe par-dessus un mur.<br /><br />Après un délai, la cible s'endort pendant 2 sec. Les attaques et les compétences réveillent la cible, mais infligent deux fois plus de dégâts (max : {{ e6 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts bruts supplémentaires).",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Téléporte Zoé à un endroit proche pendant 1 sec, avant de la faire revenir à son point de départ.",
          tooltip:
            "Téléporte Zoé à un endroit proche pendant 1 sec, avant de la faire revenir à son point de départ.<br /><br /><rules>Zoé peut utiliser ses compétences et attaquer pendant la téléportation, mais elle ne peut pas se déplacer. Elle peut également voir au-delà des murs.</rules>",
          leveltip: {
      ...
      passive: {
        ...
        description:
          "Après avoir lancé une compétence, la prochaine attaque de base de Zoé inflige des dégâts magiques supplémentaires.",
        image: {
          full: "Zoe_P.png",
          sprite: "passive4.png",
          group: "passive",
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                { id: "3020", count: 1, hideCount: false },
                { id: "3090", count: 1, hideCount: false },
                { id: "3100", count: 1, hideCount: false },
              ],
            },
            {
