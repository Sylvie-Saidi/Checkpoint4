...
const Fiora2 = {
  ...
  data: {
    Fiora: {
      ...
      skins: [
        { id: "114000", num: 0, name: "default", chromas: false },
        { id: "114001", num: 1, name: "Fiora garde royal", chromas: false },
        { id: "114002", num: 2, name: "Fiora oiseau nocturne", chromas: false },
        { id: "114003", num: 3, name: "Proviseur Fiora", chromas: true },
        { id: "114004", num: 4, name: "PROJET : Fiora", chromas: true },
        {
          id: "114005",
          num: 5,
          name: "Fiora starlette des plages",
          chromas: true,
        },
        {
          id: "114022",
        ...
        { id: "114023", num: 23, name: "Fiora percecœur", chromas: true },
        { id: "114031", num: 31, name: "iG Fiora", chromas: false },
        { id: "114041", num: 41, name: "Fiora Pulsefire", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Fente",
          description:
            "Fiora se fend dans une direction et frappe un ennemi proche, infligeant des dégâts physiques et appliquant ses effets à l'impact.",
          tooltip:
            "Fiora se fend dans une direction et frappe un ennemi proche, infligeant {{ e1 }} <scaleAD>(+{{ f1 }})</scaleAD> pts de dégâts physiques et appliquant ses effets à l'impact. Cette attaque vise en priorité les <span class=\"colorD4BD22\">points faibles</span> et les ennemis qu'elle peut tuer.<br /><br />Si cette compétence touche un ennemi, son délai de récupération est réduit de {{ e4 }}%.",
          leveltip: {
            label: [
              "Dégâts",
          ...
          vars: [{ link: "bonusattackdamage", coeff: 0.6, key: "f1" }],
        ...
        },
        {
          ...
          name: "Riposte",
          description:
            "Fiora pare tous les dégâts et toutes les entraves qui la ciblent pendant un court instant, après quoi elle donne un coup d'estoc dans une direction. Ce coup d'estoc ralentit le premier champion ennemi touché. Si Fiora a paré un effet immobilisant, elle étourdit le premier champion ennemi touché.",
          tooltip:
            "Fiora pare tous les dégâts et toutes les entraves qui la ciblent pendant {{ e2 }} sec, après quoi elle donne un coup d'estoc dans la direction ciblée.<br /><br />Ce coup d'estoc inflige {{ e1 }} <scaleAP>(+{{ f1 }})</scaleAP> pts de dégâts magiques au premier champion ennemi touché et réduit de {{ e4 }}% les vitesses de déplacement et d'attaque de cet ennemi pendant {{ e3 }} sec.<br /><br />Si Fiora pare un effet immobilisant, Riposte étourdit au lieu de ralentir.",
          leveltip: {
        ...
        },
        {
          ...
          name: "Botte secrète",
          description:
            "Fiora augmente sa vitesse d'attaque pour ses deux prochaines attaques. La première attaque ralentit la cible et la seconde inflige un coup critique.",
          tooltip:
            "Fiora augmente sa vitesse d'attaque de {{ e4 }}% pour ses deux prochaines attaques. La première ne peut pas infliger de coup critique, mais elle applique un ralentissement de {{ e3 }}% pendant {{ e2 }} sec. La deuxième est forcément un coup critique et inflige {{ f4 }}% des dégâts <scaleAD>({{ f3 }})</scaleAD>.",
          leveltip: {
            label: [
              "Dégâts critiques",
              "Délai de récupération",
        ...
        },
        {
          ...
          name: "Défi suprême",
          description:
            "Fiora révèle les quatre points faibles d'un champion ennemi et augmente sa vitesse de déplacement à proximité de ce champion. Si Fiora frappe les 4 points faibles ou si l'adversaire meurt après qu'elle en a frappé au moins un, Fiora et ses alliés dans la zone sont soignés pendant quelques secondes.",
          tooltip:
            'Fiora révèle les 4 <span class="colorD4BD22">points faibles</span> du champion ciblé pour potentiellement lui infliger des dégâts bruts équivalents à {{ spell.fiorapassive:rdamagetotal }} de ses PV max. De plus, Fiora gagne le bonus de Danse de la duelliste en vitesse de déplacement ({{ spell.fiorar:percentms }}%) quand elle est proche de la cible.<br /><br />Si Fiora frappe les 4 <span class="colorD4BD22">points faibles</span> en moins de {{ markduration }} sec ou si l\'ennemi meurt après qu\'elle en a frappé au moins un, Fiora et ses alliés dans la zone récupèrent {{ healpersecondcalc }} PV chaque seconde pendant {{ minhealduration }} à {{ healduration }} sec, selon le nombre de points faibles frappés.',
          leveltip: {
            label: [
              "Délai de récupération",
      ...
      passive: {
        ...
        description:
          "Fiora défie les champions ennemis proches de l'esquiver. Elle annonce la direction dans laquelle elle va essayer d'attaquer. Si elle remporte son propre défi, elle reçoit un petit bonus et annonce une nouvelle direction.",
        image: {
          full: "Fiora_P.png",
          sprite: "passive0.png",
          group: "passive",
