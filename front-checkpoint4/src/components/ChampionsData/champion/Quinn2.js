...
const Quinn2 = {
  ...
  data: {
    Quinn: {
      ...
      skins: [
        { id: "133000", num: 0, name: "default", chromas: false },
        { id: "133001", num: 1, name: "Quinn phénix", chromas: false },
        {
          id: "133002",
          num: 2,
        ...
        { id: "133003", num: 3, name: "Quinn corsaire", chromas: false },
        { id: "133004", num: 4, name: "Quinn cœur-de-cible", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Quinn fait appel à Valor pour marquer un ennemi et limiter sa vision avant de blesser tous les ennemis proches.",
          tooltip:
            "Valor vole en ligne droite et marque le premier ennemi touché, le rendant <keywordMajor>vulnérable</keywordMajor> et réduisant grandement son champ de vision pendant {{ e3 }} sec.<br />Il inflige ensuite {{ e1 }} <scaleAD>(+{{ f2 }})</scaleAD> <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts physiques à tous les ennemis proches.<br /><br />Si la cible principale n'est pas un champion, elle ne peut pas attaquer pendant {{ e3 }} sec.",
          leveltip: {
            label: [
              "Dégâts",
          ...
          maxammo: "-1",
          range: [1025, 1025, 1025, 1025, 1025],
          rangeBurn: "1025",
          image: {
            full: "QuinnQ.png",
            sprite: "spell9.png",
        ...
        },
        {
          ...
          name: "Œil d'aigle",
          description:
            "Confère passivement de plus grandes vitesses d'attaque et de déplacement à Quinn lorsqu'elle a attaqué un ennemi <font color='#FFF673'>vulnérable</font>. Activer pour que Valor révèle une large zone proche.",
          tooltip:
            "<spellPassive>Passive : </spellPassive>attaquer une cible <keywordMajor>vulnérable</keywordMajor> augmente la vitesse d'attaque de Quinn de {{ e2 }}% et sa vitesse de déplacement de {{ e3 }}% pendant {{ e1 }} sec.<br /><br /><spellActive>Active : </spellActive>Valor révèle une large zone proche pendant {{ e5 }} sec.",
          leveltip: {
            label: [
              "Vitesse d'attaque",
          ...
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
          range: [2100, 2100, 2100, 2100, 2100],
          rangeBurn: "2100",
          image: {
            full: "QuinnW.png",
            sprite: "spell9.png",
        ...
        },
        {
          ...
          name: "Salto",
          description:
            "Quinn charge un ennemi, lui infligeant des dégâts physiques et réduisant sa vitesse de déplacement. Après avoir atteint sa cible, elle prend appui sur celle-ci, l'interrompt brièvement et se projette en arrière sur une distance équivalente à sa portée d'attaque max.",
          tooltip:
            "Quinn charge un ennemi, lui infligeant {{ e2 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques tandis que Valor le rend <keywordMajor>vulnérable</keywordMajor>.<br /><br />Après avoir atteint sa cible, Quinn rebondit sur elle, la déplaçant et la ralentissant brièvement de {{ e1 }}% (le ralentissement se dissipe progressivement en {{ e3 }} sec).",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Quinn et Valor s'unissent pour voler à grande vitesse. Mettre fin à la compétence lance Volée fatale, qui inflige des dégâts aux ennemis proches et rend les champions vulnérables.",
          tooltip:
            "Quinn demande à Valor de venir l'aider. Après 2 sec de canalisation, ils s'unissent, ce qui augmente leur vitesse de déplacement totale de {{ movementspeedmod*100 }}% et leur donne la possibilité de lancer Volée fatale en relançant En territoire ennemi ou en effectuant une action offensive.<br /><br /><span class=\"colorC8BA82\">Volée fatale</span> : Quinn et Valor infligent <physicalDamage>{{ damage }} pts de dégâts physiques</physicalDamage> aux ennemis proches et rendent les champions <keywordMajor>vulnérables</keywordMajor>. Lancer Volée fatale ou effectuer une action offensive met fin à En territoire ennemi.<br /><br /><rules>Être blessé par des unités autres que les sbires supprime le bonus en vitesse de déplacement pendant {{ slowduration }} sec.</rules> ",
          leveltip: {
            label: ["Vitesse de déplacement", "Coût en mana"],
            effect: [
      ...
      passive: {
        name: "Busard",
        description:
          "Valor, l'aigle demacien de Quinn, marque périodiquement des ennemis, les rendant <font color='#FFF673'>vulnérables</font>. La première attaque de base de Quinn contre une cible <font color='#FFF673'>vulnérable</font> inflige des dégâts physiques supplémentaires.",
        image: {
