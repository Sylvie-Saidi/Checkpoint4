...
const Camille2 = {
  ...
  data: {
    Camille: {
      ...
      skins: [
        { id: "164000", num: 0, name: "default", chromas: false },
        { id: "164001", num: 1, name: "Programme Camille", chromas: false },
        { id: "164002", num: 2, name: "Camille de l'assemblée", chromas: true },
        { id: "164010", num: 10, name: "iG Camille", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "La prochaine attaque de Camille infligera des dégâts supplémentaires et lui octroiera un bonus en vitesse de déplacement. Cette compétence peut être relancée pendant un court instant, et Camille inflige des dégâts beaucoup plus importants si elle attend entre les deux attaques.",
          tooltip:
            'La prochaine attaque de base de Camille infligera <scaleAD>{{ f1 }}</scaleAD> pts de dégâts physiques supplémentaires et augmentera sa vitesse de déplacement de {{ e4 }}% pendant {{ e5 }} sec. Cette compétence peut être relancée gratuitement dans les {{ e0 }} sec qui suivent.<br /><br />Si la deuxième attaque de Protocole de précision frappe au moins {{ e1 }} sec après la première, les dégâts supplémentaires sont augmentés de {{ e8 }}% (<scaleAD>{{ f2 }}</scaleAD>) et <scaleLevel>{{ f3 }}%</scaleLevel> des dégâts sont convertis en dégâts bruts.<br /><br /><span class="size16 colorFFEB7F">Protocole de précision</span> <rules>ne peut pas infliger de coup critique.</rules>',
          leveltip: {
            label: [
        ...
        },
        {
          ...
          description:
            "Après un délai, Camille frappe dans une zone conique, infligeant des dégâts. Les ennemis pris dans la moitié extérieure du cône sont ralentis, subissent des dégâts supplémentaires et rendent des PV à Camille.",
          tooltip:
            'Après un délai, Camille lance une attaque tranchante dans une direction, infligeant {{ e1 }} <scaleAD>(+{{ f1 }})</scaleAD> pts de dégâts physiques aux ennemis touchés.<br /><br />Les ennemis touchés dans la moitié extérieure du cône subissent un ralentissement de {{ e4 }}% qui diminue en {{ e2 }} sec. Ils subissent aussi des dégâts physiques supplémentaires équivalents à {{ e5 }}% (<scaleAD>+{{ f2 }}</scaleAD>%) de leurs PV max, et Camille récupère des PV équivalents à {{ e9 }}% des dégâts supplémentaires infligés aux champions.<br /><br /><span class="size16 colorFFEB7F">Balayage tactique</span> <rules>inflige {{ e8 }}% de dégâts en moins aux monstres non épiques.</rules>',
          leveltip: {
            label: [
        ...
        },
        {
          ...
          name: "Grappin",
          description:
            "Camille se propulse vers un mur et bondit, projetant en l'air tous les champions ennemis à l'atterrissage.",
          tooltip:
            "<scaleAD>Première activation :</scaleAD> tire un grappin qui s'accroche au terrain, ce qui propulse Camille dans sa direction et lui permet de relancer Grappin dans la seconde qui suit.<br /><br /><scaleAD>Deuxième activation :</scaleAD> Camille bondit en prenant appui sur le mur et percute le premier champion ennemi touché. À l'atterrissage, elle inflige {{ e3 }} <scaleAD>(+{{ f1 }})</scaleAD> pts de dégâts physiques aux ennemis et étourdit les champions ennemis proches pendant {{ e1 }} sec. Les bonds vers les champions ennemis vont deux fois plus loin et, à l'impact, augmentent sa vitesse d'attaque de {{ e2 }}% pendant {{ e5 }} sec.",
          leveltip: {
            label: ["Délai de récupération", "Dégâts", "Vitesse d'attaque"],
            effect: [
              "{{ cooldown }} -> {{ cooldownNL }}",
              "{{ e3 }} -> {{ e3NL }}",
        ...
        },
        {
          ...
          description:
            "Camille fonce vers le champion ciblé et l'emprisonne dans une zone. Ses attaques de base infligent aussi des dégâts magiques supplémentaires à la cible.",
          tooltip:
            "Camille devient brièvement impossible à cibler et bondit sur un champion ennemi, interrompant les canalisations et emprisonnant l'ennemi dans une zone dont il ne peut pas sortir pendant {{ rduration }} sec. Les autres ennemis proches sont repoussés. Ses attaques de base contre l'ennemi piégé infligent des dégâts magiques supplémentaires équivalents à {{ ronhitdamage }} plus {{ rpercentcurrenthpdamage }}% des PV actuels de l'ennemi.<br /><br /><span class=\"size16 colorFFEB7F\">L'Ultimatum Hextech</span> <span class=\"size16 color8C8C8C\">prend fin si Camille quitte la zone.</span>",
          leveltip: {
            label: [
              "Durée",
              "Délai de récupération",
      ...
      passive: {
        ...
        description:
          "Les attaques de base contre les champions octroient à Camille un bouclier équivalent à 20% de ses PV max contre le type de dégâts de l'ennemi (physique ou magique) pendant un court moment.",
        image: {
