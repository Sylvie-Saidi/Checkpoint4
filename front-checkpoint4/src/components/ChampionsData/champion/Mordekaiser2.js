...
const Mordekaiser2 = {
  ...
  data: {
    Mordekaiser: {
      ...
      skins: [
        { id: "82000", num: 0, name: "default", chromas: false },
        {
          id: "82001",
          num: 1,
        ...
        { id: "82002", num: 2, name: "Mordekaiser infernal", chromas: false },
        { id: "82003", num: 3, name: "Mordekaiser Pentakill", chromas: false },
        { id: "82004", num: 4, name: "Lord Mordekaiser", chromas: false },
        {
          id: "82005",
          num: 5,
          name: "Mordekaiser roi de trèfle",
          chromas: false,
        },
        {
          id: "82006",
      ...
      spells: [
        {
          ...
          name: "Oblitération",
          description:
            "Mordekaiser frappe le sol avec sa massue, infligeant des dégâts à tous les ennemis touchés. Les dégâts sont augmentés si un seul ennemi est touché.",
          tooltip:
            "Mordekaiser frappe le sol avec Vesper et inflige <magicDamage>{{ qdamage }} pts de dégâts magiques</magicDamage> à tous les ennemis dans la zone. Ces dégâts augmentent de {{ isolationtooltip*100 }}% si un seul ennemi est touché.",
          leveltip: {
            label: [
              "Dégâts sur cible unique",
              "Dégâts",
        ...
        },
        {
          ...
          name: "Indestructible",
          description:
            "Mordekaiser stocke une partie des dégâts qu'il inflige et qu'il subit pour créer un bouclier. Il peut consommer ce bouclier pour récupérer des PV.",
          tooltip:
            'Mordekaiser stocke (<span class="color00BFFF">{{ damageconversion*100 }}%</span>/<span class="colorB30000">{{ damagetakenconversion*100 }}%</span>) de tous les dégâts qu\'il (<span class="color00BFFF">inflige</span>/<span class="colorB30000">subit</span>) pour les convertir en bouclier potentiel.<br /><br /><scaleLevel>Indestructible</scaleLevel> lui octroie un bouclier. Si la compétence est réactivée, Mordekaiser consomme le bouclier pour récupérer des PV équivalents à {{ healingpercent*100 }}% des PV restants du bouclier.',
          leveltip: {
            label: ["Pourcentage de soins", "Délai de récupération"],
            effect: [
        ...
        },
        {
          ...
          description:
            "Mordekaiser attire tous les ennemis qui se trouvent dans une zone.",
          tooltip:
            "<spellPassive>Passive :</spellPassive> Mordekaiser gagne {{ magicpen*100 }}% de pénétration magique.<br /><br /><spellActive>Active :</spellActive> Mordekaiser attire les ennemis qui se trouvent dans la zone ciblée, infligeant <magicDamage>{{ totaldamage }} pts de dégâts magiques.</magicDamage>",
          leveltip: {
            label: [
        ...
        },
        {
          ...
          description:
            "Mordekaiser entraîne sa victime avec lui dans une autre dimension et lui vole une partie de ses stats. S'il la tue, il garde ces stats jusqu'à la réapparition de sa victime.",
          tooltip:
            "Mordekaiser emporte une cible avec lui dans le <keywordMajor>royaume des morts</keywordMajor> pendant {{ spiritrealmduration }} sec, lui volant {{ statstealpercentscalar*100 }}% de ses stats principales pendant la durée du sort.<br /><br />Si Mordekaiser tue sa cible dans le <keywordMajor>royaume des morts</keywordMajor>, il dévore son âme et conserve les stats volées à sa cible jusqu'à la réapparition de celle-ci.",
          leveltip: {
      ...
      passive: {
        ...
        description:
          "Après 3 attaques ou sorts de base contre des champions, Mordekaiser gagne un puissant halo de dégâts et augmente sa vitesse de déplacement.",
        image: {
