...
const Illaoi2 = {
  ...
  data: {
    Illaoi: {
      ...
      skins: [
        { id: "420000", num: 0, name: "default", chromas: false },
        {
          id: "420001",
          num: 1,
        ...
        { id: "420002", num: 2, name: "Illaoi résistante", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Augmente les dégâts infligés par les tentacules. À l'activation, Illaoi fait s'abattre un tentacule qui inflige des dégâts physiques.",
          tooltip:
            '<scaleAD>Passive :</scaleAD> les dégâts des <span class="color85FFAD">cinglements</span> sont augmentés de {{ e6 }}% (<scaleAD>{{ f1 }}</scaleAD>).<br /><br /><scaleAD>Active :</scaleAD> Illaoi balance son idole pour qu\'un tentacule effectue un <span class="color85FFAD">cinglement</span> vers l\'avant.',
          leveltip: {
            label: [
              "Bonus aux cinglements",
        ...
        },
        {
          ...
          name: "Âpre leçon",
          description:
            "Illaoi bondit sur sa cible, infligeant des dégâts physiques et poussant tous les tentacules proches à frapper la cible.",
          tooltip:
            'À sa prochaine attaque de base, Illaoi bondit sur sa cible, infligeant des dégâts physiques supplémentaires équivalents à <scaleAD>{{ f1*100 }}%</scaleAD> des PV max de la cible [{{ e1 }}% + {{ f2*100 }}% tous les 100 dégâts d\'attaque].<br /><br />Quand elle touche sa cible, les tentacules proches <span class="color85FFAD">cinglent</span> la cible.<br /><br /><span class="color919191"><i>Âpre leçon inflige au minimum {{ wmindamage }} pts de dégâts supplémentaires. Contre les monstres, les dégâts supplémentaires sont limités à {{ e3 }}.</i></span>',
          leveltip: {
            label: ["Dégâts", "Dégâts minimum"],
            effect: [
        ...
        },
        {
          ...
          description:
            "Illaoi arrache l'esprit d'un ennemi et l'attire jusqu'à elle. L'esprit transmet un pourcentage des dégâts qu'il subit à la cible originale. S'il est détruit ou si la cible s'éloigne trop de son esprit, la cible devient un <font color='#669900'>réceptacle</font> et commence à faire apparaître des tentacules.",
          tooltip:
            'Illaoi arrache l\'esprit d\'un champion ennemi pendant {{ e3 }} sec. L\'esprit peut être attaqué et il transmet {{ e1 }}% <scaleAD>(+{{ f5 }}%)</scaleAD> des dégâts qu\'il subit à son propriétaire.<br /><br />Si l\'esprit est détruit ou si la cible s\'en éloigne trop, la cible devient un <span class="color669900">réceptacle</span> pendant {{ e2 }} sec et est ralentie de {{ e8 }}% pendant {{ e5 }} sec. Les <span class="color669900">réceptacles</span> font apparaître un tentacule toutes les <scaleLevel>{{ f1 }}</scaleLevel> sec si aucun autre tentacule n\'est proche.<br /><br />Une fois toutes les {{ timebetweenvesseltentacleslams }} sec, les tentacules <span class="color85FFAD">cinglent</span> automatiquement les esprits et les <span class="color669900">réceptacles</span>.',
          leveltip: {
            label: [
              "Dégâts transférés",
              "Délai de récupération",
        ...
        },
        {
          ...
          name: "Acte de foi",
          description:
            "Illaoi écrase son idole au sol, infligeant des dégâts physiques aux ennemis proches. Un tentacule apparaît pour chaque champion ennemi touché.",
          tooltip:
            "Illaoi écrase son idole au sol, infligeant {{ damagecalc }} pts de dégâts physiques aux ennemis proches et faisant apparaître un tentacule pour chaque champion ennemi touché.<br /><br />Pendant {{ duration }} sec, les tentacules sont impossibles à cibler et leurs <span class=\"color85FFAD\">cinglements</span> sont 50% plus rapides, et le délai de récupération d'Âpre leçon n'est plus que de 2 sec.<br /><br /><span class=\"colorcccccc\"><i>''Il existe des dieux doux et miséricordieux. Le mien n'a rien à voir avec eux.''</i></span>",
          leveltip: {
