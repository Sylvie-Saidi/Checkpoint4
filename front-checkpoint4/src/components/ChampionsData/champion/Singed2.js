...
const Singed2 = {
  ...
  data: {
    Singed: {
      ...
      skins: [
        { id: "27000", num: 0, name: "default", chromas: false },
        { id: "27001", num: 1, name: "Singed anti-émeutes", chromas: false },
        { id: "27002", num: 2, name: "Singed Hextech", chromas: false },
        { id: "27003", num: 3, name: "Singed surfeur", chromas: false },
        { id: "27004", num: 4, name: "Singed savant fou", chromas: false },
        { id: "27005", num: 5, name: "Singed techmaturgique", chromas: false },
        { id: "27006", num: 6, name: "Singed des neiges", chromas: false },
        { id: "27007", num: 7, name: "SSW Singed", chromas: false },
        {
          id: "27008",
          num: 8,
          name: "Singed de la peste noire",
          chromas: false,
        },
        { id: "27009", num: 9, name: "Singed apiculteur", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Singed laisse une piste empoisonnée derrière lui, infligeant des dégâts aux ennemis sur la route.",
          tooltip:
            "<spellPassive>Activable/Désactivable : </spellPassive>Singed laisse derrière lui une piste empoisonnée qui inflige {{ e1 }} <scaleAP>(+{{ charabilitypower*4 }})</scaleAP> pts de dégâts magiques par seconde.",
          leveltip: {
            label: ["Dégâts"],
            effect: [
          ...
          resource: "{{ cost }} pts de mana par sec",
        },
        {
          id: "MegaAdhesive",
          name: "Attrape-mouche",
          description:
            "Lance au sol une fiole contenant un puissant adhésif qui ralentit et rend inertes tous les ennemis passant dans la zone d'effet.",
          tooltip:
            "Singed crée une zone collante au sol pendant {{ e2 }} sec. Les ennemis dans la zone sont ralentis de {{ e1 }}% et sont rendus inertes, ce qui les empêche d'utiliser des compétences de déplacement.<br /><br />Si Singed projette une cible dans cette zone, elle est immobilisée.",
          leveltip: {
            label: ["Délai de récupération", "Coût en @AbilityResourceName@"],
            effect: [
              "{{ cooldown }} -> {{ cooldownNL }}",
              "{{ cost }} -> {{ costNL }}",
            ],
        ...
        },
        {
          ...
          name: "Projection",
          description:
            "Blesse l'ennemi et le projette derrière Singed. Si la cible projetée par Singed atterrit dans Attrape-mouche, elle est aussi immobilisée.",
          tooltip:
            "Singed projette un ennemi par-dessus son épaule, infligeant des dégâts magiques équivalents à {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> plus {{ e3 }}% des PV max de la cible. Contre les sbires et les monstres : 300 pts de dégâts supplémentaires max.<br /><br />Si la cible de Projection atterrit dans l'Attrape-mouche de Singed, elle est aussi immobilisée pendant {{ e2 }} sec.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Singed voit plusieurs de ses statistiques largement améliorées grâce à des produits chimiques.",
          tooltip:
            "Singed avale un puissant mélange chimique qui augmente de {{ statamount }} sa puissance, son armure, sa résistance magique, sa vitesse de déplacement et ses régénérations de PV et de mana pendant {{ duration }} sec.",
          leveltip: {
            label: ["Bonus aux stats", "Délai de récupération"],
            effect: [
      ...
      passive: {
        ...
        description:
          "Singed bénéficie de l'aspiration des champions proches, gagnant un bref bonus en vitesse de déplacement quand il les dépasse.",
        image: {
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              maxSummonerLevel: -1,
              showIfSummonerSpell: "",
              hideIfSummonerSpell: "S5_SummonerSmitePlayerGanker",
              appendAfterSection: "",
              visibleWithAllOf: [""],
              hiddenWithAnyOf: [""],
              items: [
