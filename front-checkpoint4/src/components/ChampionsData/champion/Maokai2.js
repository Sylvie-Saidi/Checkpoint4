  ...
  data: {
    Maokai: {
      ...
      skins: [
        ...
        { id: "57001", num: 1, name: "Maokai calciné", chromas: false },
        { id: "57002", num: 2, name: "Maokai totémique", chromas: false },
        { id: "57003", num: 3, name: "Maokai festif", chromas: false },
        { id: "57004", num: 4, name: "Maokai hanté", chromas: false },
        { id: "57005", num: 5, name: "Maokai gardien de but", chromas: false },
        { id: "57006", num: 6, name: "Miaoukai", chromas: true },
        { id: "57007", num: 7, name: "Maokai héros de guerre", chromas: false },
        { id: "57016", num: 16, name: "Maokai brise-monde", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Coup de ronces",
          description:
            "Maokai projette les ennemis proches en arrière avec une onde de choc, leur infligeant des dégâts magiques et les ralentissant.",
          tooltip:
            "Maokai frappe le sol et déclenche une onde de choc. Les ennemis proches sont repoussés. Tous les ennemis touchés subissent {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et sont brièvement ralentis.",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Maokai se transforme en une masse de racines mouvantes, devenant impossible à cibler et fonçant sur la cible. À l'arrivée, il immobilise la cible.",
          tooltip:
            "Maokai se transforme en une masse de racines mouvantes, devient impossible à cibler et fonce vers la cible.<br /><br />À l'arrivée, il inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et immobilise la cible pendant {{ e2 }} sec.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Maokai envoie un arbrisseau qui surveille une zone. Plus efficace dans les hautes herbes.",
          tooltip:
            'Maokai lance un arbrisseau, qui monte la garde pendant {{ f1 }} sec. Les arbrisseaux chassent les ennemis proches et explosent à leur proximité, infligeant des dégâts magiques équivalents à {{ e1 }} <span class="colorCC3300">+{{ e8 }}% <scaleAP>[+{{ a1 }}%]</scaleAP> des PV max de la cible</span> et ralentissant les ennemis touchés de {{ e5 }}% pendant {{ e6 }} sec.<br /><br />Les arbrisseaux placés dans les hautes herbes durent <span class="colorCC3300">{{ f2 }}</span> sec et provoquent une explosion plus large, infligeant le double de dégâts en {{ e6 }} sec à tous les ennemis touchés.<br /><br /><rules><span class="color8c8c8c">Inflige un maximum de {{ e4 }} pts de dégâts aux non-champions, et le double depuis les hautes herbes.</span></rules>',
          leveltip: {
            label: [
              "Dégâts",
          ...
          vars: [{ link: "spelldamage", coeff: 0.01, key: "a1" }],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
        ...
        },
        {
          ...
          description:
            "Maokai invoque un colossal mur de ronces et d'épines qui avance lentement, blessant et immobilisant les ennemis sur son chemin.",
          tooltip:
            "Maokai invoque un mur colossal de ronces et d'épines qui avance lentement, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et immobilisant les ennemis touchés pendant ({{ minrootduration }} à {{ maxrootduration }}) sec, durée augmentant avec la distance parcourue.",
          leveltip: {
            label: ["Dégâts", "Délai de récupération"],
            effect: [
              "{{ e1 }} -> {{ e1NL }}",
      ...
      passive: {
        name: "Sève magique",
        description:
          "L'attaque de base de Maokai a un effet qui lui rend des PV, avec un délai de récupération modéré. Chaque fois que Maokai lance un sort ou est touché par un sort ennemi, ce délai de récupération est réduit.",
        image: {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                { id: "3800", count: 1, hideCount: false },
                { id: "3001", count: 1, hideCount: false },
                { id: "3056", count: 1, hideCount: false },
              ],
            },
            {
              type: "startingjungle",
