const Zed = {
  ...
  data: {
    Zed: {
      ...
      skins: [
        { id: "238000", num: 0, name: "default", chromas: false },
        { id: "238001", num: 1, name: "Zed l'éclair blanc", chromas: true },
        { id: "238002", num: 2, name: "SKT T1 Zed", chromas: false },
        { id: "238003", num: 3, name: "PROJET : Zed", chromas: true },
        { id: "238010", num: 10, name: "Zed du championnat", chromas: true },
        { id: "238011", num: 11, name: "Zed thanatophore", chromas: false },
        { id: "238013", num: 13, name: "Zed fléau galactique", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Zed et ses ombres lancent leurs shurikens.<br><br>Chaque shuriken blesse tous les ennemis touchés.",
          tooltip:
            "Zed et ses ombres lancent leurs shurikens, chacun infligeant <physicalDamage>{{ totaldamage }} pts de dégâts physiques</physicalDamage> au premier ennemi traversé, puis <physicalDamage>{{ passthroughdamage }} pts de dégâts physiques</physicalDamage> à chaque ennemi subséquent.",
          leveltip: {
        ...
        },
        {
          ...
          name: "Ombre vivante",
          description:
            "<font color='#FF9900'>Passive :</font> Zed regagne de l'énergie quand ses ombres et lui frappent un ennemi avec la même compétence. L'énergie ne peut être récupérée qu'une fois par utilisation d'une compétence.<br><br><font color='#FF9900'>Active :</font> l'ombre de Zed fonce vers l'avant et reste sur place pendant quelques secondes. Réactiver Ombre vivante permet à Zed de changer de position avec cette ombre.",
          tooltip:
            "<span class=\"colorFF9900\">Passive :</span> quand Zed et ses ombres frappent un ennemi avec la même compétence, Zed récupère {{ e3 }} pts d'énergie. L'énergie ne peut être récupérée qu'une fois par utilisation d'une compétence.<br /><br /><span class=\"colorFF9900\">Active :</span> l'ombre de Zed fonce vers l'avant et reste sur place pendant {{ e5 }} sec. Réactiver Ombre vivante permet à Zed de changer de position avec cette ombre.",
          leveltip: {
            label: [
              "Énergie récupérée",
        ...
        },
        {
          ...
          description:
            "Zed et ses ombres donnent un coup de taille et blessent les ennemis proches.",
          tooltip:
            "Zed et ses ombres donnent un coup de taille, infligeant <physicalDamage>{{ totaldamage }} pts de dégâts physiques</physicalDamage> aux ennemis proches.<br /><br />Chaque champion ennemi touché par la taillade de Zed réduit le délai de récupération d'Ombre vivante de {{ shadowhitcdr }} sec.<br /><br />Les ennemis touchés par la taillade d'une ombre sont ralentis de {{ movespeedmod*-100 }}% pendant {{ slowduration }} sec. Les ennemis touchés par plusieurs taillades sont ralentis de {{ movespeedmodbonus*-100 }}% mais ne subissent pas de dégâts supplémentaires.",
          leveltip: {
            label: ["Dégâts", "Délai de récupération", "Ralentissement"],
            effect: [
              "{{ basedamage }} -> {{ basedamageNL }}",
              "{{ cooldown }} -> {{ cooldownNL }}",
        ...
        },
        {
          ...
          description:
            "Zed devient impossible à cibler et fonce sur un champion ennemi pour le marquer. Au bout de 3 sec, la marque explose, infligeant de nouveau un pourcentage de tous les dégâts infligés par Zed pendant la durée de la marque.",
          tooltip:
            "Zed devient impossible à cibler et fonce sur un champion ennemi pour le marquer. Au bout de {{ rdeathmarkduration }} sec, la marque explose, infligeant des dégâts physiques équivalents à <physicalDamage>{{ rcalculateddamage }}</physicalDamage> plus {{ rdamageamp*100 }}% de tous les dégâts infligés par Zed à la cible pendant la durée de la marque.<br /><br />En fonçant, Zed laisse une ombre derrière lui pendant {{ rshadowdurationdisplayed }} sec. Réactiver Marque de la mort permet à Zed de changer de position avec cette ombre.",
          leveltip: {
            label: ["Dégâts d'explosion de la marque", "Délai de récupération"],
            effect: [
      ...
      passive: {
        ...
        description:
          "Les attaques de base de Zed infligent des dégâts magiques supplémentaires aux cibles dont les PV sont faibles. Cet effet ne peut se déclencher sur une même cible qu'une fois toutes les quelques secondes.",
        image: {
