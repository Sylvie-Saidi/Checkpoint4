...
const Volibear2 = {
  ...
  data: {
    Volibear: {
      ...
      skins: [
        { id: "106000", num: 0, name: "default", chromas: false },
        { id: "106001", num: 1, name: "Fulguro Volibear", chromas: false },
        { id: "106002", num: 2, name: "Volibear nordique", chromas: false },
        { id: "106003", num: 3, name: "Volibear runique", chromas: false },
        { id: "106004", num: 4, name: "Capitaine Volibear", chromas: false },
        { id: "106005", num: 5, name: "Volibear El Rayo", chromas: false },
      ],
      lore:
        "Le demi-dieu grondant connu sous le surnom de l'Ours aux mille piques est l'esprit guerrier de Freljord. Des milliers d'années de luttes cruelles menées au cœur des hivers les plus froids ont fait de Volibear une force indomptable. Il propulse des éclairs depuis les plus hauts sommets et, quand les tempêtes de neige font rage, c'est le signe qu'il guerroie de nouveau. Quiconque ose l'affronter succombera sous ses griffes ou sera contraint de se joindre à sa féroce armée de guerriers ursins.",
      blurb:
      ...
      spells: [
        {
          ...
          tooltip:
            "Volibear se met à quatre pattes pour pourchasser ses ennemis, augmentant sa vitesse de déplacement de {{ e4 }}% pendant {{ e3 }} sec. Ce bonus augmente à {{ e2 }}% quand il va vers des champions ennemis.<br /><br />La prochaine attaque de Volibear pendant cette durée inflige {{ e1 }} pts de dégâts physiques supplémentaires et projette la cible derrière lui.",
          leveltip: {
            label: [
        ...
        },
        {
          ...
          tooltip:
            "<spellPassive>Passive : </spellPassive>Volibear augmente sa vitesse d'attaque de {{ e1 }}% à chaque attaque. Cumulable {{ e2 }} fois.<br /><br /><spellPassive>Active : </spellPassive>quand Volibear a cumulé {{ e2 }} effets Survoltage, il peut mordre un ennemi pour lui infliger {{ e3 }} <span class=\"colorCC3300\">(+{{ f1 }} [{{ e4 }}% de ses PV supplémentaires])</span> pts de dégâts physiques plus {{ e5 }}% tous les {{ e7 }}% de PV qu'il manque à la cible. Si Volibear mord un sbire ou un monstre, le délai de récupération de Survoltage est réduit de {{ e6 }}%.",
          leveltip: {
            label: ["Vitesse d'attaque", "Dégâts de morsure"],
        ...
        {
          id: "VolibearE",
          name: "Rugissement majestueux",
          description:
            "Volibear pousse un puissant rugissement qui blesse, ralentit et repousse légèrement les ennemis. Les ennemis en l'air ou en pleine ruée subissent des dégâts magiques supplémentaires. Les sbires et les monstres sont en plus effrayés.",
          tooltip:
            "Volibear inflige <magicDamage>{{ damage }} pts de dégâts magiques</magicDamage> aux ennemis proches, les repousse légèrement et les ralentit de {{ movespeedmod*100 }}% pendant {{ slowduration }} sec. Les ennemis en l'air ou en pleine ruée subissent des <magicDamage>dégâts magiques supplémentaires équivalents à <scaleHealth>{{ bonusdamageratio*100 }}% de leurs PV max</scaleHealth></magicDamage>.<br /><br />Les sbires et les monstres sont en plus effrayés pendant 3 sec.",
          leveltip: {
            label: [
              "Dégâts",
              "Ralentissement",
        ...
        },
        {
          ...
          description:
            "Volibear libère une chaîne d'éclairs, blessant un certain nombre d'ennemis proches. La puissance de la tempête permet aux attaques de Volibear de lancer des éclairs rebondissant sur les ennemis proches de sa cible.",
          tooltip:
            'Volibear libère une chaîne d\'éclairs, frappant jusqu\'à {{ e4 }} ennemis proches en leur infligeant {{ e1 }} <span class="color99FF99">(+{{ a1 }})</span> pts de dégâts magiques.<br /><br />Pendant {{ e3 }} sec, la tempête renforce Volibear, ce qui permet à ses attaques de base de lancer des éclairs infligeant {{ e1 }} <span class="color99FF99">(+{{ a1 }})</span> pts de dégâts magiques supplémentaires à {{ e4 }} ennemis proches.',
          leveltip: {
