...
const Syndra2 = {
  ...
  data: {
    Syndra: {
      ...
      skins: [
        { id: "134000", num: 0, name: "default", chromas: false },
        { id: "134001", num: 1, name: "Syndra justicière", chromas: false },
        { id: "134002", num: 2, name: "Syndra de l'Atlantide", chromas: false },
        {
          id: "134003",
          num: 3,
          name: "Syndra dame de carreau",
          chromas: false,
        },
        { id: "134004", num: 4, name: "Syndra des neiges", chromas: false },
        { id: "134005", num: 5, name: "SKT T1 Syndra", chromas: false },
        {
          id: "134006",
          num: 6,
      ...
      spells: [
        {
          ...
          tooltip:
            "Invoque une sphère noire qui inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques. La sphère dure {{ e2 }} sec et peut être manipulée grâce aux autres compétences de Syndra.<br /><br /><scaleAP>Ce sort peut être lancé pendant un déplacement.</scaleAP>",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Syndra saisit et lance une sphère noire ou un sbire ennemi, infligeant des dégâts magiques et réduisant la vitesse de déplacement des ennemis.",
          tooltip:
            "<spellPassive>Première activation :</spellPassive> saisit la sphère noire ou le sbire ennemi ciblé. Si aucune cible n'est sélectionnée, saisit la sphère noire la plus proche.<br /><br /><spellPassive>Deuxième activation :</spellPassive> projette l'unité saisie. Les ennemis touchés subissent {{ e2 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et sont ralentis de <scaleLevel>{{ e1 }}%</scaleLevel> pendant {{ f2 }} sec.<br /><br /><scaleAP>Ce sort peut être lancé pendant un déplacement.</scaleAP>",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Syndra repousse les ennemis et les sphères noires, infligeant des dégâts magiques. Les ennemis frappés par les sphères noires sont étourdis.",
          tooltip:
            "Repousse les ennemis et les sphères noires, leur infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques ainsi qu'aux ennemis avec lesquels ils entrent en collision.<br /><br />Les sphères noires repoussées étourdissent tous les ennemis sur leur chemin pendant {{ e2 }} sec.",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Syndra bombarde un champion ennemi avec toutes ses sphères noires.",
          tooltip:
            "Libère toute la puissance cataclysmique de Syndra pour envoyer des sphères noires infliger des dégâts magiques au champion ennemi ciblé. Déchaînement de puissance manipule les trois sphères noires qui tournent autour de Syndra plus jusqu'à 4 sphères noires déjà créées.<br /><br />Dégâts par sphère : {{ damagecalc }}.<br />Total de dégâts minimum : {{ mindamagecalc }}.",
          leveltip: {
            label: ["Dégâts", "Délai de récupération"],
            effect: [
          ...
          effectBurn: [null, "0", "0", "7", "0", "0", "0", "0", "0", "0", "0"],
          vars: [],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
          range: [675, 675, 675],
      ...
      passive: {
        name: "Transcendance",
        description:
          "Les sorts gagnent des effets supplémentaires au rang max.<br><br><font color='#FF9900'>Sphère noire </font>: inflige 25% de dégâts supplémentaires aux champions.<br><font color='#FF9900'>Force de la volonté </font>: inflige 20% de dégâts bruts supplémentaires.<br><font color='#FF9900'>Dispersion des faibles </font>: le cône d'effet est 50% plus large.<br><font color='#FF9900'>Déchaînement de puissance </font>: la portée est augmentée de 75.",
        image: {
