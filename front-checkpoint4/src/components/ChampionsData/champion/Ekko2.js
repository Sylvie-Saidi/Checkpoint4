const Ekko2 = {
  ...
  data: {
    Ekko: {
      ...
      skins: [
        { id: "245000", num: 0, name: "default", chromas: false },
        { id: "245001", num: 1, name: "Ekko du désert", chromas: true },
        { id: "245002", num: 2, name: "Ekkolier", chromas: false },
        { id: "245003", num: 3, name: "PROJET : Ekko", chromas: false },
        { id: "245011", num: 11, name: "SKT T1 Ekko", chromas: false },
        { id: "245012", num: 12, name: "Ekkorrifiant", chromas: true },
        { id: "245019", num: 19, name: "True Damage Ekko", chromas: true },
        { id: "245028", num: 28, name: "Ekko Pulsefire", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Rétrobang",
          description:
            "Ekko lance une grenade temporelle qui crée un champ de distorsion quand elle touche un champion ennemi, ralentissant toutes les unités prises à l'intérieur et leur infligeant des dégâts. Ensuite, la grenade se contracte et revient vers Ekko, infligeant des dégâts sur sa route.",
          tooltip:
            "Ekko lance un appareil qui inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis traversés. Au premier champion touché, il se dilate pour créer un champ de force ralentissant de {{ e2 }}% tout ce qui se trouve à l'intérieur. Après un temps, l'appareil se contracte et revient vers Ekko, infligeant {{ e3 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts magiques à toutes les cibles sur sa route.",
          leveltip: {
            label: [
              "Dégâts à l'aller",
              "Dégâts au retour",
        ...
        },
        {
          ...
          description:
            "Les attaques de base d'Ekko infligent des dégâts magiques supplémentaires aux champions dont les PV sont bas. Ekko peut lancer Convergence parallèle pour fracturer la ligne temporelle, créant après quelques secondes une anomalie qui ralentit les ennemis pris à l'intérieur. Si Ekko entre dans l'anomalie, il obtient un bouclier et étourdit les ennemis en suspendant dans le temps leur existence.",
          tooltip:
            "<spellPassive>Passive :</spellPassive> contre les ennemis dont les PV sont inférieurs à 30%, les attaques de base d'Ekko infligent des dégâts magiques supplémentaires équivalents à {{ e3 }}% <scaleAP>(+{{ a2 }}%)</scaleAP> de leurs PV manquants. Ces attaques infligent un minimum de {{ e6 }} pts de dégâts, et un maximum de {{ e5 }} pts de dégâts contre les sbires et les monstres.<br /><br /><spellPassive>Active :</spellPassive> après un délai de 3 sec, Ekko crée une chronosphère éphémère à l'endroit ciblé, ralentissant de {{ e0 }}% les ennemis qui la traversent. Si Ekko entre dans la sphère, elle explose et lui fournit un bouclier pouvant absorber jusqu'à {{ e4 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts pendant 2 sec. Les ennemis pris dans l'explosion sont étourdis pendant {{ e2 }} sec.",
          leveltip: {
            label: [
              "PV du bouclier",
              "Délai de récupération",
          ...
          vars: [
            { link: "spelldamage", coeff: 0.03, key: "a2" },
            { link: "spelldamage", coeff: 1.5, key: "a1" },
          ],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
          range: [1600, 1600, 1600, 1600, 1600],
          rangeBurn: "1600",
          image: {
            full: "EkkoW.png",
            sprite: "spell2.png",
        ...
        },
        {
          ...
          tooltip:
            "Ekko fonce sur une courte distance dans la direction ciblée. Sa prochaine attaque infligera {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques supplémentaires et elle le téléportera près de sa cible.",
          leveltip: {
            label: [
              "Dégâts",
              "Délai de récupération",
        ...
        },
        {
          ...
          tooltip:
            "Ekko remonte le temps, ce qui le rend brièvement impossible à cibler et invulnérable. Il se téléporte là où il était 4 sec plus tôt et inflige <magicDamage>{{ totaldamage }} pts de dégâts magiques</magicDamage> aux ennemis proches à l'arrivée. Ekko récupère également <healing>{{ totalbaseheal }}</healing> PV, plus {{ percenthealampperpercentmissinghealth }}% tous les 1% de PV perdus pendant les 4 dernières secondes.",
          leveltip: {
