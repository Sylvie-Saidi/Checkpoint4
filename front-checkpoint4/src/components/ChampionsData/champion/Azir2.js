...
const Azir2 = {
  ...
  data: {
    Azir: {
      ...
      skins: [
        { id: "268000", num: 0, name: "default", chromas: false },
        { id: "268001", num: 1, name: "Azir galactique", chromas: false },
        { id: "268002", num: 2, name: "Azir nécromancien", chromas: false },
        { id: "268003", num: 3, name: "SKT T1 Azir", chromas: false },
        {
          id: "268004",
          num: 4,
      ...
      spells: [
        {
          ...
          description:
            "Azir envoie tous les soldats de sable vers une zone. Les soldats infligent des dégâts magiques aux ennemis qu'ils traversent et appliquent un ralentissement pendant 1 seconde.",
          tooltip:
            'Azir envoie tous les <span class="colorEED6AF">soldats de sable</span> vers une zone. Les <span class="colorEED6AF">soldats de sable</span> infligent {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis qu\'ils traversent et appliquent un ralentissement de {{ e2 }}% pendant 1 sec.<br /><br />Les ennemis touchés par plusieurs <span class="colorEED6AF">soldats de sable</span> ne subissent pas de dégâts supplémentaires.',
          leveltip: {
        ...
        },
        {
          ...
          name: "Dresse-toi !",
          description:
            "Azir invoque un soldat de sable qui attaque les cibles proches à sa place. Ses attaques infligent des dégâts magiques aux ennemis sur une même ligne. De plus, Dresse-toi ! augmente passivement la vitesse d'attaque d'Azir et de ses soldats de sable.",
          tooltip:
            "<spellPassive>Passive :</spellPassive> Azir gagne {{ e3 }}% de vitesse d'attaque. Quand Azir a au moins {{ e6 }} <span class=\"colorEED6AF\">soldats de sable</span>, il gagne {{ e7 }}% de vitesse d'attaque supplémentaires pendant {{ e8 }} sec.<br /><br /><spellPassive>Active :</spellPassive> Azir invoque un <span class=\"colorEED6AF\">soldat de sable</span> pendant {{ e1 }} sec. Quand Azir attaque un ennemi à portée du soldat, le soldat attaque à sa place, infligeant <scaleLevel>{{ f2 }}</scaleLevel> <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques. Si d'autres ennemis sont touchés par l'attaque du soldat, ils subissent <scaleLevel>{{ f7 }}%</scaleLevel> des dégâts de l'attaque.<br /><br />Azir peut stocker jusqu'à {{ maxammo }} <span class=\"colorEED6AF\">soldats de sable</span> et en prépare un nouveau toutes les <scaleLevel>{{ ammorechargetime }}</scaleLevel> sec.<br /><br /><span class=\"color919191\"><i>Les soldats de sable qui attaquent la même cible n'infligent que {{ e9 }}% des dégâts après le premier coup.<br />Les soldats de sable peuvent attaquer les cibles qui sont hors de portée d'Azir.<br />Les soldats de sable expirent deux fois plus vite quand ils sont à proximité d'une tourelle ennemie.</i></span>",
          leveltip: {
            label: [
        ...
        },
        {
          ...
          description:
            "Azir s'entoure brièvement d'un bouclier et fonce vers un de ses soldats de sable, blessant les ennemis touchés. S'il touche un champion ennemi, il prépare instantanément un nouveau soldat de sable et la ruée s'arrête.",
          tooltip:
            "Azir s'entoure d'un bouclier pendant {{ e6 }} sec, bloquant jusqu'à {{ e4 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts, et fonce vers un de ses <span class=\"colorEED6AF\">soldats de sable</span>, infligeant {{ e3 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis touchés.<br /><br />Si Azir touche un champion ennemi, il s'arrête et prépare instantanément un nouveau <span class=\"colorEED6AF\">soldat de sable</span>.",
          leveltip: {
            label: ["PV du bouclier", "Dégâts", "Délai de récupération"],
            effect: [
              "{{ e4 }} -> {{ e4NL }}",
              "{{ e3 }} -> {{ e3NL }}",
              "{{ cooldown }} -> {{ cooldownNL }}",
        ...
        },
        {
          ...
          description:
            "Azir invoque un mur de soldats qui chargent vers l'avant, repoussant et blessant les ennemis.",
          tooltip:
            "Azir invoque un mur de soldats dotés de boucliers qui chargent vers l'avant, repoussant les ennemis et infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques. Les soldats conservent leur formation en mur pendant {{ e4 }} sec.<br /><br />Azir et ses alliés peuvent traverser librement le mur de Partition impériale.<br /><br /><span class=\"color919191\"><i>Partition impériale n'interagit pas avec les sorts et les attaques de base d'Azir.</i></span>",
          leveltip: {
            label: ["Dégâts", "Nombre de soldats", "Délai de récupération"],
            effect: [
              "{{ e1 }} -> {{ e1NL }}",
              "{{ e3 }} -> {{ e3NL }}",
              "{{ cooldown }} -> {{ cooldownNL }}",
      ...
      passive: {
        ...
        description:
          "Azir peut invoquer le Disque solaire depuis les ruines des tourelles ennemies ou alliées.",
        image: {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                { id: "2004", count: 1, hideCount: false },
                { id: "2044", count: 1, hideCount: false },
              ],
            },
          ],
        },
