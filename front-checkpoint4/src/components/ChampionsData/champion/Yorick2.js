const Yorick2 = {
  ...
  data: {
    Yorick: {
      ...
      skins: [
        { id: "83000", num: 0, name: "default", chromas: false },
        { id: "83001", num: 1, name: "Yorick ensevelisseur", chromas: false },
        { id: "83002", num: 2, name: "Yorick Pentakill", chromas: false },
        { id: "83003", num: 3, name: "Yorick à la pelle pure", chromas: false },
        { id: "83004", num: 4, name: "Miaourick", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "La prochaine attaque de Yorick infligera des dégâts supplémentaires et le soignera. Si la cible meurt, cela crée une tombe.",
          tooltip:
            "La prochaine attaque de base de Yorick infligera {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques et lui rendra {{ f1 }} PV (montant doublé s'il a moins de la moitié de ses PV). Si Yorick tue sa cible avec Derniers sacrements, il crée une tombe.<br /><br />S'il y a au moins trois tombes à proximité et si Derniers sacrements a été utilisé, Yorick peut lancer Exhumation pour faire sortir des Goules de Brume des tombes.",
          leveltip: {
          ...
          vars: [{ link: "attackdamage", coeff: 1.4, key: "a1" }],
        ...
        },
        {
          ...
          name: "Sombre cortège",
          description:
            "Yorick invoque à l'endroit ciblé un mur destructible qui bloque les déplacements des ennemis.",
          tooltip:
            "Yorick invoque à l'endroit ciblé un mur d'esprits destructible possédant {{ e5 }} PV et durant {{ e1 }} sec. Les alliés peuvent traverser le mur librement.",
          leveltip: {
            label: ["PV", "Délai de récupération"],
            effect: [
              "{{ e5 }} -> {{ e5NL }}",
              "{{ cooldown }} -> {{ cooldownNL }}",
            ],
        ...
        },
        {
          ...
          description:
            "Yorick lance un globe de Brume noire qui blesse, ralentit et marque les ennemis.",
          tooltip:
            "Yorick lance un globe de Brume noire qui inflige des dégâts magiques équivalents à {{ e7 }}% des PV actuels de l'ennemi (minimum : {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP>), qui ralentit les ennemis de {{ e3 }}% pendant {{ e6 }} sec et qui marque les champions et les monstres pendant {{ e2 }} sec.<br /><br />Yorick et ses sbires se déplacent {{ e5 }}% plus vite en direction de la marque.",
          leveltip: {
            label: [
              "Dégâts minimum",
        ...
        },
        {
          ...
          description:
            "Yorick invoque la Vierge de la Brume. Les attaques de Yorick contre la cible de la Vierge infligent des dégâts supplémentaires. La Vierge transforme automatiquement les ennemis morts en Goules de Brume.",
          tooltip:
            "Yorick invoque la Vierge de la Brume et {{ rghoulnumbers }} Goules de Brume. La Vierge a {{ yorickbigghoulhealth }} PV, inflige {{ yorickbigghouldamage }} pts de dégâts magiques et transforme en Goules de Brume les ennemis qui meurent à proximité.<br /><br />Quand Yorick blesse la cible de la Vierge, il inflige des dégâts magiques supplémentaires équivalents à {{ rmarkdamagepercent }}% des PV max de la cible ({{ rproccd }} sec de récupération).<br /><br />Yorick peut réactiver cette compétence pour libérer la Vierge et l'envoyer sur la voie la plus proche.",
          leveltip: {
            label: [
              "PV",
              "Dégâts",
      ...
      passive: {
        ...
        description:
          "<font color='#FF9900'>Horde maudite :</font> Yorick peut invoquer des Goules de Brume pour attaquer les ennemis proches.",
        image: {
          full: "Yorick_P.png",
          sprite: "passive4.png",
          group: "passive",
