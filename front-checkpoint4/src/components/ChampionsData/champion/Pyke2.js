...
const Pyke2 = {
  ...
  data: {
    Pyke: {
      ...
      skins: [
        { id: "555000", num: 0, name: "default", chromas: false },
        {
          id: "555001",
          num: 1,
        ...
        { id: "555009", num: 9, name: "Pyke lune de sang", chromas: true },
        { id: "555016", num: 16, name: "PROJET : Pyke", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Harponnage",
          description:
            "Pyke poignarde un ennemi devant lui ou attire un ennemi vers lui.",
          tooltip:
            "<scaleAD>Appuyer :</scaleAD> Pyke donne un coup de poignard dans une direction, infligeant des dégâts à l'ennemi le plus proche (champions en priorité).<br /><br /><scaleAD>Maintenir : </scaleAD>Pyke lance son harpon et attire le premier ennemi touché vers lui.<br /><br />Il lui inflige {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques et le ralentit de {{ e9 }}% pendant {{ e8 }} sec.",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Pyke se camoufle et obtient un important bonus en vitesse de déplacement qui diminue sur la durée.",
          tooltip:
            "Pyke <keywordStealth>se camoufle</keywordStealth> et augmente sa vitesse de déplacement de {{ e1 }}% <scaleLethality>(+{{ f7 }}%)</scaleLethality> pendant {{ e0 }} sec (bonus diminuant sur la durée).<br /><br /><rules><keywordStealth><u>Furtivité - Camouflage</u> :</keywordStealth> les champions ennemis hors du rayon de détection de Pyke ne peuvent pas le voir. Attaquer ou lancer des sorts met fin au camouflage.</rules>",
          leveltip: {
        ...
        },
        {
          ...
          name: "Ressac fantôme",
          description:
            "Pyke fonce dans une direction et laisse derrière lui un fantôme de noyé qui reviendra vers lui en étourdissant les champions ennemis sur son passage.",
          tooltip:
            "Pyke fonce dans une direction en laissant derrière lui un fantôme de noyé. Après un court délai, le fantôme retourne vers Pyke et frappe les champions ennemis sur son passage, les étourdissant pendant {{ e2 }} <scaleLethality>(+{{ f10.01 }})</scaleLethality> sec. Les champions touchés subissent aussi {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques.",
        ...
        },
        {
          ...
          description:
            "Pyke fonce sur les ennemis qui ont peu de PV et les exécute, ce qui lui permet de relancer ce sort et d'octroyer des PO supplémentaires à un allié qui l'assiste.",
          tooltip:
            "Pyke frappe tous les champions ennemis dans une zone en X, exécutant les cibles qui ont moins de {{ rbasedamage }} <scaleAD>(+{{ raddamage }})</scaleAD> <scaleLethality>(+{{ rlethalitydamage }})</scaleLethality> PV. Les ennemis qui ne sont pas exécutés subissent à la place des dégâts physiques équivalents à {{ reduceddamage*100 }}% de ce seuil de PV.<br /><br />Quand n'importe quelle source de dégâts tue un champion ennemi dans la zone en X, Pyke et un allié qui a effectué une assistance reçoivent une <gold>part d'or</gold> supplémentaire équivalente à la totalité des PO de l'élimination, et Pyke peut relancer Exécution abyssale dans les {{ rrecastduration }} sec.<br /><br /><rules>Total des PO partagées avec des alliés : <gold>{{ f9 }}</gold><br />Total des PO gardées pour vous : <gold>{{ f10 }}</gold></rules>",
          leveltip: {
      ...
      passive: {
        name: "Don des noyés",
        description:
          "Quand Pyke n'est pas vu par les ennemis, il régénère les dégâts que les champions lui ont récemment infligés. Par ailleurs, Pyke ne peut pas augmenter ses PV max ; tous ses PV supplémentaires sont convertis en dégâts d'attaque.",
        image: {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                { id: "3142", count: 1, hideCount: false },
                { id: "3074", count: 1, hideCount: false },
                { id: "4004", count: 1, hideCount: false },
              ],
            },
            {
              type: "defensive",
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              maxSummonerLevel: -1,
              showIfSummonerSpell: "SummonerSmite",
              hideIfSummonerSpell: "OdinTrinketRevive",
              appendAfterSection: "",
              visibleWithAllOf: [""],
              hiddenWithAnyOf: [""],
              items: [
