const JarvanIV2 = {
  ...
  data: {
    JarvanIV: {
      ...
      skins: [
        { id: "59000", num: 0, name: "default", chromas: false },
        { id: "59001", num: 1, name: "Jarvan IV commando", chromas: false },
        {
          id: "59002",
          num: 2,
          name: "Jarvan IV tueur de dragons",
          chromas: false,
        },
        { id: "59003", num: 3, name: "Jarvan IV ténébreux", chromas: false },
        {
          id: "59004",
          num: 4,
          name: "Jarvan IV héros de guerre",
          chromas: false,
        },
        {
          id: "59005",
        ...
        { id: "59006", num: 6, name: "Fnatic Jarvan IV", chromas: false },
        {
          id: "59007",
          num: 7,
        ...
        { id: "59008", num: 8, name: "SSG Jarvan IV", chromas: false },
        { id: "59009", num: 9, name: "Jarvan IV Hextech", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Jarvan IV allonge sa lance, infligeant des dégâts physiques et réduisant l'armure des ennemis sur son chemin. En outre, cela peut ramener Jarvan à son Étendard demacien, projetant les ennemis dans les airs au passage.",
          tooltip:
            "Allonge la lance de Jarvan IV, infligeant {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques aux ennemis touchés et réduisant leur armure de {{ e2 }}% pendant {{ e3 }} sec.<br /><br />Si la lance entre en contact avec Étendard demacien, Jarvan IV est ramené vers l'étendard et projette dans les airs les ennemis sur son passage. Cet effet peut être déclenché même quand Jarvan IV est immobilisé.",
          leveltip: {
            label: [
              "Dégâts",
          ...
          vars: [{ link: "bonusattackdamage", coeff: 1.2, key: "a1" }],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
          range: [770, 770, 770, 770, 770],
          rangeBurn: "770",
          image: {
        ...
        },
        {
          ...
          tooltip:
            'Octroie un bouclier absorbant {{ e1 }} (<span class="colorCC3300">+{{ f1 }}</span> [{{ e6 }}% de vos PV max] par champion ennemi proche) pts de dégâts pendant {{ e4 }} sec et ralentit les ennemis proches de {{ e2 }}% pendant {{ e5 }} sec.',
          leveltip: {
            label: ["PV du bouclier", "Ralentissement"],
        ...
        },
        {
          ...
          tooltip:
            "<spellPassive>Passive :</spellPassive> augmente la vitesse d'attaque de {{ e3 }}%.<br /><br /><spellPassive>Active :</spellPassive> plante un étendard dans une zone proche, infligeant {{ e2 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis. L'étendard dure {{ e4 }} sec et augmente de {{ e3 }}% la vitesse d'attaque des champions alliés proches.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          name: "Cataclysme",
          description:
            "Jarvan IV bondit héroïquement sur une cible avec une telle force qu'il transforme la zone autour de lui en une arène. Les ennemis proches sont blessés lors de l'impact.",
          tooltip:
            "Bondit héroïquement sur un champion ennemi, infligeant {{ damagecalc }} pts de dégâts physiques aux ennemis proches et créant une arène infranchissable autour de la cible pendant {{ wallduration }} sec.<br /><br />Activer de nouveau pour que le mur s'effondre.",
          leveltip: {
      ...
      passive: {
        ...
        description:
          "La première attaque de base de Jarvan IV sur un ennemi inflige des dégâts physiques supplémentaires selon un pourcentage des PV actuels de la cible. Cet effet ne peut ensuite plus être infligé au même ennemi pendant quelques secondes.",
        image: {
