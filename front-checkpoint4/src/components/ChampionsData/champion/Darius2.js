...
const Darius2 = {
  ...
  data: {
    Darius: {
      ...
      skins: [
        { id: "122000", num: 0, name: "default", chromas: true },
        { id: "122001", num: 1, name: "Lord Darius", chromas: false },
        { id: "122002", num: 2, name: "Darius biosoldat", chromas: false },
        { id: "122003", num: 3, name: "Darius roi du Nord", chromas: false },
        { id: "122004", num: 4, name: "Darius roi du dunk", chromas: true },
        { id: "122008", num: 8, name: "Darius redoublant", chromas: false },
        { id: "122014", num: 14, name: "Darius nova d'effroi", chromas: false },
        { id: "122015", num: 15, name: "Dieu-roi Darius", chromas: false },
        { id: "122016", num: 16, name: "Darius de l'Ouest", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Décimation",
          description:
            "Darius tend tous ses muscles et donne un coup circulaire avec sa hache. Les ennemis touchés par la lame subissent plus de dégâts que ceux touchés par la hampe. Darius récupère des PV en fonction du nombre de champions ennemis et de grands monstres touchés par la lame.",
          tooltip:
            "Après un court délai, Darius donne un coup circulaire avec sa hache, frappant tous les ennemis sur la trajectoire. Les ennemis touchés par la lame de la hache subissent {{ e2 }} <scaleAD>(+{{ f1 }})</scaleAD> pts de dégâts physiques. Les ennemis touchés par la hampe subissent {{ e6 }}% des dégâts (n'applique pas Plaie béante).<br /><br />Darius récupère <scaleHP>{{ e5 }}% de ses PV manquants</scaleHP> par champion ennemi ou grand monstre touché par la lame (max : {{ e7 }}%).",
          leveltip: {
            label: [
              "Dégâts",
          ...
          vars: [{ link: "bonusattackdamage", coeff: 1.05, key: "f1" }],
        ...
        },
        {
          ...
          name: "Estropiaison",
          description:
            "La prochaine attaque de Darius tranche une artère vitale de l'ennemi. Le saignement réduit la vitesse de déplacement de la cible.",
          tooltip:
            "La prochaine attaque de base de Darius inflige <scaleAD>{{ f1 }}</scaleAD> pts de dégâts physiques et ralentit la cible de {{ e2 }}% pendant {{ e5 }} sec.<br /><br />Si Estropiaison tue la cible, son coût en mana est annulé et son délai de récupération est réduit de {{ e3 }}%.",
          leveltip: {
            label: [
              "Ratio de dégâts d'attaque totaux",
              "Délai de récupération",
        ...
        },
        {
          ...
          name: "Crampon",
          description:
            "Darius aiguise sa hache, ce qui permet à ses dégâts physiques d'ignorer passivement un pourcentage de l'armure de la cible. À l'activation, Darius attire ses ennemis avec sa hache.",
          tooltip:
            '<span class="colorFF9900">Passive : </span>Darius gagne {{ e1 }}% de pénétration d\'armure.<br /><br /><span class="colorFF9900">Active : </span>Darius attire tous les ennemis devant lui et les ralentit de {{ e2 }}% pendant {{ e3 }} sec.',
          leveltip: {
            label: [
        ...
        },
        {
          ...
          description:
            "Darius saute sur un champion ennemi et donne un coup fatal, infligeant des dégâts bruts. Plus vous cumulez de Plaies béantes sur la cible, plus les dégâts augmentent. Si Guillotine noxienne tue la cible, son délai de récupération est annulé pendant un court moment.",
          tooltip:
            'Darius saute sur le champion ennemi ciblé et assène un coup terrible, infligeant <trueDamage>{{ damage }}</trueDamage> pts de dégâts bruts. Pour chaque effet Plaie béante sur la cible, Guillotine noxienne inflige {{ rdamagepercentperhemostack*100 }}% de dégâts supplémentaires.<span class="size8 colorFF9900"><br /><br /></span><span class="colorF50F00">Dégâts max : {{ f1 }}</span><span class="size8"><br /><br /></span>Si Guillotine noxienne tue la cible, elle peut être réutilisée dans les {{ rrecastduration }} sec sans coût.<span class="size8"><br /><br /></span>Au rang 3, Guillotine noxienne est <span class="colorFFFF66"><i>déverrouillée</i></span> : elle n\'a plus de coût en mana et, si elle tue la cible, son délai de récupération est complètement annulé.',
          leveltip: {
          ...
          vars: [{ link: "bonusattackdamage", coeff: 0.75, key: "f1" }],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
          range: [460, 460, 460],
          rangeBurn: "460",
      ...
      passive: {
        name: "Plaie béante",
        description:
          "Les attaques de Darius et ses compétences infligeant des dégâts font saigner les ennemis, ce qui leur inflige des dégâts physiques en 5 sec (cumulable 5 fois).",
        image: {
          ...
          blocks: [
            {
              ...
              hiddenWithAnyOf: [""],
              items: [
                { id: "1036", count: 2, hideCount: false },
