...
const Shen2 = {
  ...
  data: {
    Shen: {
      ...
      skins: [
        { id: "98000", num: 0, name: "default", chromas: false },
        { id: "98001", num: 1, name: "Shen glacé", chromas: false },
        { id: "98002", num: 2, name: "Shen au manteau jaune", chromas: false },
        { id: "98003", num: 3, name: "Shen chirurgien", chromas: false },
        { id: "98004", num: 4, name: "Shen lune de sang", chromas: false },
        { id: "98005", num: 5, name: "Samouraï Shen", chromas: true },
        { id: "98006", num: 6, name: "TPA Shen", chromas: false },
        { id: "98015", num: 15, name: "Shen Pulsefire", chromas: true },
        { id: "98016", num: 16, name: "Shen infernal", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Shen rappelle sa lame spirituelle pour attaquer avec elle, infligeant des dégâts basés sur les PV max de sa cible. Les attaques sont grandement renforcées si la lame touche un champion ennemi. Tous les ennemis touchés par la lame sont ralentis quand ils s'éloignent de Shen.",
          tooltip:
            'Shen rappelle sa <span class="colorBB77FF">lame spirituelle</span> et la dégaine. Les ennemis qu\'elle touche sont ralentis de {{ e4 }}% quand ils s\'éloignent de Shen pendant les {{ e5 }} prochaines secondes.<br /><br />Les {{ e3 }} prochaines attaques de Shen infligent des dégâts magiques supplémentaires équivalents à <scaleLevel>{{ f1 }}</scaleLevel> plus {{ e2 }} <scaleAP>(+{{ charabilitypower*.01 }})</scaleAP>% des PV max de la cible. Si la <span class="colorBB77FF">lame spirituelle</span> a touché un champion ennemi, les dégâts de ces attaques passent à <scaleLevel>{{ f2 }}</scaleLevel> plus {{ e6 }} <scaleAP>(+{{ charabilitypower2*.01 }})</scaleAP>% et la vitesse d\'attaque de Shen augmente de {{ e9 }}%.<br /><br /><rules>Chaque attaque inflige {{ e1 }}% de dégâts supplémentaires aux monstres (max : {{ e7 }}).</rules>',
          leveltip: {
            label: [
              "Pourcentage des dégâts de base",
        ...
        },
        {
          ...
          description:
            "Les attaques qui ciblent Shen ou ses alliés sont bloquées quand ils sont près de la lame spirituelle.",
          tooltip:
            "La <span class=\"colorBB77FF\">lame spirituelle</span> de Shen crée une zone défensive pendant {{ e1 }} sec, dans laquelle les attaques de base qui ciblent Shen ou un champion allié sont bloquées.<br /><br />S'il n'y a personne à protéger dans la zone lorsqu'elle apparaît, la <span class=\"colorBB77FF\">lame spirituelle</span> s'active quand un champion y pénètre ou au bout de {{ e2 }} sec.",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Shen fonce dans une direction en provoquant les ennemis sur son passage.",
          tooltip:
            '<spellPassive>Passive :</spellPassive> infliger des dégâts avec Rush des ombres ou Assaut crépusculaire vous rend <scaleLevel>{{ f1 }}</scaleLevel> pts d\'énergie.<br /><br /><spellPassive>Active :</spellPassive> Shen fonce dans une direction, infligeant {{ e2 }} <span class="colorCC3300">[+{{ f2 }}]</span> pts de dégâts physiques aux champions ennemis et aux monstres neutres sur son passage et les provoquant pendant {{ e1 }} sec.',
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Shen offre un bouclier absorbant les dégâts à un champion allié, puis se téléporte jusqu'à lui.",
          tooltip:
            "Shen offre à un champion allié un bouclier qui dure {{ shieldduration }} sec et peut absorber de {{ shield }} à {{ maxshield }} pts de dégâts, selon les PV manquants de l'allié. Après {{ channelduration }} sec de canalisation, Shen et sa <span class=\"colorBB77FF\">lame spirituelle</span> se téléportent près de l'allié.",
          leveltip: {
            label: [
              "PV min du bouclier",
              "PV max du bouclier",
      ...
      passive: {
        name: "Barrière de ki",
        description:
          "Shen reçoit un bouclier après avoir lancé un sort. Affecter d'autres champions réduit le délai de récupération de cet effet.",
        image: {
