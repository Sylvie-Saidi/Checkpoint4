const Alistar2 = {
  ...
  data: {
    Alistar: {
      ...
      skins: [
        { id: "12000", num: 0, name: "default", chromas: false },
        { id: "12001", num: 1, name: "Alistar noir", chromas: false },
        { id: "12002", num: 2, name: "Alistar doré", chromas: false },
        { id: "12003", num: 3, name: "Alistar matador", chromas: false },
        { id: "12004", num: 4, name: "Alistar longhorn", chromas: false },
        { id: "12005", num: 5, name: "Alistar déchaîné", chromas: false },
        { id: "12006", num: 6, name: "Alistar infernal", chromas: false },
        { id: "12007", num: 7, name: "Alistar libéro", chromas: false },
        { id: "12008", num: 8, name: "Alistar maraudeur", chromas: false },
        { id: "12009", num: 9, name: "SKT T1 Alistar", chromas: false },
        { id: "12010", num: 10, name: "Alistar meuh-meuh", chromas: true },
        { id: "12019", num: 19, name: "Alistar Hextech", chromas: false },
        { id: "12020", num: 20, name: "Alistar conquérant", chromas: true },
        {
          id: "12022",
          num: 22,
          name: "Alistar des glaces noires",
          chromas: true,
        },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Atomisation",
          description:
            "Alistar frappe le sol, infligeant des dégâts magiques aux ennemis proches et les projetant dans les airs.",
          tooltip:
            "Alistar frappe le sol, infligeant {{ e2 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et projetant dans les airs les unités ennemies proches pendant {{ e3 }} sec.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          tooltip:
            "Alistar charge un ennemi, lui infligeant {{ e2 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et le repoussant.",
          leveltip: {
            label: [
              "Dégâts",
              "Délai de récupération",
        ...
        },
        {
          ...
          name: "Piétinement",
          description:
            "Alistar piétine les unités ennemies proches, ignorant les collisions avec les unités et gagnant un effet s'il blesse un champion ennemi. Au maximum d'effets cumulés, la prochaine attaque de base d'Alistar contre un champion ennemi infligera des dégâts magiques supplémentaires et étourdira la cible.",
          tooltip:
            'Alistar piétine les ennemis sur son passage, ignorant les collisions avec les unités et infligeant {{ f1 }} <scaleAP>(+{{ f2 }})</scaleAP> pts de dégâts magiques en {{ e3 }} sec aux ennemis proches. Chaque pulsation qui blesse au moins un champion ennemi octroie un effet <span class="colorFF6E1C">Piétinement</span> à Alistar.<br /><br />À {{ e5 }} effets <span class="colorFF6E1C">Piétinement</span> cumulés, Alistar renforce sa prochaine attaque de base contre un champion ennemi pour lui infliger <scaleLevel>{{ f3 }}</scaleLevel> pts de dégâts magiques supplémentaires et l\'étourdir pendant {{ e6 }} sec.',
          leveltip: {
            label: [
              "Délai de récupération",
              "Coût en @AbilityResourceName@",
        ...
        },
        {
          ...
          tooltip:
            "Dissipe toutes les entraves qui affectent Alistar. Pendant {{ rduration }} sec, Alistar subit {{ rdamagereduction }}% de dégâts physiques et magiques en moins.",
          leveltip: {
      ...
      passive: {
        name: "Cri triomphant",
        description:
          "Alistar charge son cri en étourdissant ou en déplaçant des champions ennemis ou quand des ennemis proches meurent. Quand le cri est pleinement chargé, Alistar se soigne et soigne tous les champions alliés proches.",
        image: {
          full: "Alistar_E.png",
          sprite: "passive0.png",
          group: "passive",
