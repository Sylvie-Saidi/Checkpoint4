...
const Karthus2 = {
  ...
  data: {
    Karthus: {
      ...
      skins: [
        { id: "30000", num: 0, name: "default", chromas: false },
        { id: "30001", num: 1, name: "Karthus fantôme", chromas: false },
        { id: "30002", num: 2, name: "Statue de Karthus", chromas: false },
        { id: "30003", num: 3, name: "Karthus faucheur", chromas: true },
        { id: "30004", num: 4, name: "Karthus Pentakill", chromas: false },
        { id: "30005", num: 5, name: "Fnatic Karthus", chromas: false },
        {
          id: "30009",
          num: 9,
      ...
      spells: [
        {
          ...
          name: "Dévastation",
          description:
            "Karthus crée une explosion à retardement, infligeant des dégâts aux ennemis proches.",
          tooltip:
            "Crée une explosion à retardement à l'endroit du curseur de Karthus, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques à tous les ennemis proches.<br /><br />Les dégâts sont doublés si une seule unité est touchée.",
          leveltip: {
        ...
        },
        {
          ...
          name: "Mur de douleur",
          description:
            "Karthus crée un mur d'énergie. Les ennemis franchissant le mur voient leur vitesse de déplacement et leur résistance magique temporairement réduites.",
          tooltip:
            "Crée un mur qui dure {{ e4 }} sec. Les ennemis traversant le mur voient leur résistance magique être réduite de {{ e1 }}% et leur vitesse de déplacement être réduite de {{ e3 }}% pendant {{ e5 }} sec (leur vitesse de déplacement revient lentement à la normale).",
          leveltip: {
            label: ["Largeur du mur", "Réduction de la vitesse de déplacement"],
        ...
        },
        {
          ...
          name: "Souillure",
          description:
            "Karthus vole passivement l'énergie de ses victimes, gagnant du mana à chaque élimination. Karthus peut aussi s'immerger dans les âmes de ses proies, infligeant des dégâts aux ennemis proches mais au prix d'une grande perte de mana.",
          tooltip:
            "<spellPassive>Passive : </spellPassive>lorsque Karthus tue une unité, il regagne {{ e2 }} pts de mana.<br /><br /><spellPassive>Active : </spellPassive>Souillure draine {{ cost }} pts de mana pour infliger {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis proches chaque seconde.",
          leveltip: {
            label: ["Dégâts par seconde", "Restauration du mana"],
        ...
        },
        {
          ...
          name: "Requiem",
          description:
            "Après une canalisation de 3 secondes, Karthus inflige des dégâts à tous les champions ennemis.",
          tooltip:
            "Après une canalisation de 3 sec, Karthus inflige <magicDamage>{{ totaldamage }} pts de dégâts magiques</magicDamage> à tous les champions ennemis où qu'ils soient. ",
          leveltip: {
      ...
      passive: {
        name: "Déni de mort",
        description:
          "Lorsqu'il meurt, Karthus prend une forme spirituelle qui lui permet de continuer à lancer des sorts pendant 7 sec.",
        image: {
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              visibleWithAllOf: [""],
              hiddenWithAnyOf: [""],
              items: [{ id: "2139", count: 1, hideCount: false }],
            },
          ],
        },
      ],
