const Xayah2 = {
  ...
  data: {
    Xayah: {
      ...
      skins: [
        { id: "498000", num: 0, name: "default", chromas: false },
        {
          id: "498001",
          num: 1,
        ...
        { id: "498002", num: 2, name: "Xayah cœur tendre", chromas: false },
        { id: "498003", num: 3, name: "SSG Xayah", chromas: false },
        {
          id: "498004",
          num: 4,
      ...
      spells: [
        {
          ...
          description:
            "Xayah jette deux dagues qui infligent des dégâts et qui laissent des plumes qu'elle peut rappeler.",
          tooltip:
            'Xayah lance deux couteaux, infligeant <physicalDamage>{{ totaldamage }} pts de dégâts physiques</physicalDamage> chacun et laissant deux <span class="colorC200E1">plumes</span>. Les ennemis touchés au-delà de la première cible subissent {{ multihitratio*100 }}% de dégâts.',
          leveltip: {
        ...
        },
        {
          ...
          name: "Plumage mortel",
          description:
            "Xayah crée une tempête de lames qui augmente sa vitesse d'attaque de base et ses dégâts, tout en augmentant sa vitesse de déplacement si elle attaque un champion.",
          tooltip:
            'Xayah crée une tempête de lames pendant {{ e2 }} sec, ce qui augmente sa vitesse d\'attaque de {{ e1 }}% et permet à ses attaques de base de frapper une fois de plus pour infliger {{ e5 }}% de dégâts supplémentaires. <br /><br />Si Plumage mortel frappe un champion ennemi, les alliés affectés par Plumage mortel gagnent un bonus de {{ e3 }}% en vitesse de déplacement pendant {{ e4 }} sec.<br /><br /><span class="colore5c100">Si Rakan est proche, il profite lui aussi des effets de Plumage mortel.</span>',
          leveltip: {
            label: [
              "Vitesse d'attaque",
        ...
        },
        {
          ...
          description:
            "Xayah rappelle toutes les plumes qu'elle a posées, infligeant des dégâts et immobilisant les ennemis.",
          tooltip:
            'Xayah rappelle toutes les <span class="colorC200E1">plumes</span>, infligeant <physicalDamage>{{ featherdamage }} pts de dégâts physiques</physicalDamage> aux ennemis qu\'elles traversent.<br /><br />Les ennemis touchés par {{ featherthreshold }} <span class="colorC200E1">plumes</span> sont immobilisés pendant {{ rootduration }} sec.<br /><br />Appel des lames inflige {{ minionmultiplier*100 }}% de dégâts aux sbires.<br /><br /><rules>Les <span class="colorFF5802">chances de coup critique</span> multiplient les dégâts des plumes.</rules>',
          leveltip: {
            label: ["Dégâts", "Délai de récupération"],
            effect: [
              "{{ basedamage }} -> {{ basedamageNL }}",
          ...
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
          range: [2000, 2000, 2000, 2000, 2000],
          rangeBurn: "2000",
          image: {
            full: "XayahE.png",
            sprite: "spell14.png",
        ...
        },
        {
          ...
          description:
            "Xayah bondit dans les airs, devenant impossible à cibler et lançant des dagues qui laissent des plumes qu'elle peut rappeler.",
          tooltip:
            'Xayah bondit dans les airs et devient impossible à cibler. Elle fait ensuite tomber une pluie de dagues qui infligent <physicalDamage>{{ damage }}</physicalDamage> pts de dégâts physiques et laissent une ligne de <span class="colorC200E1">plumes</span>.<br /><br />Xayah peut se déplacer dans les airs.',
          leveltip: {
            label: ["Dégâts", "Délai de récupération"],
            effect: [
      ...
      passive: {
        ...
        description:
          "Après avoir utilisé une compétence, les prochaines attaques de base de Xayah frapperont toutes les cibles sur leur passage et laisseront une <font color='#C200E1'>plume</font>.",
        image: {
