...
const Kayle2 = {
  ...
  data: {
    Kayle: {
      ...
      skins: [
        { id: "10000", num: 0, name: "default", chromas: false },
        { id: "10001", num: 1, name: "Kayle d'argent", chromas: false },
        { id: "10002", num: 2, name: "Kayle viridienne", chromas: true },
        { id: "10003", num: 3, name: "Kayle transcendée", chromas: false },
        { id: "10004", num: 4, name: "Kayle spadassin", chromas: false },
        { id: "10005", num: 5, name: "Kayle jugement", chromas: false },
        {
          id: "10006",
          num: 6,
        ...
        { id: "10007", num: 7, name: "Kayle anti-émeutes", chromas: false },
        {
          id: "10008",
          num: 8,
          name: "Kayle inquisitrice aveugle",
          chromas: false,
        },
        { id: "10009", num: 9, name: "Kayle Pentakill", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Incandescence",
          description:
            "Kayle fait apparaître un portail pour tirer une épée céleste qui traverse les ennemis touchés, les ralentissant, les blessant et réduisant leurs résistances.",
          tooltip:
            "Kayle invoque une épée céleste qui s'arrête au premier ennemi touché. <br /><br />L'épée inflige <magicDamage>{{ totaldamage }} pts de dégâts magiques</magicDamage> à la cible et aux ennemis derrière elle, ainsi qu'un ralentissement de {{ slowpercent }}% pendant {{ slowduration }} sec et {{ shredpercent }}% de réduction d'armure et de résistance magique pendant {{ shredduration }} sec. Incandescence rend {{ manarefundpercent*100 }}% de son coût en mana par champion touché.",
          leveltip: {
            label: [
              "Dégâts",
              "Ralentissement",
        ...
        },
        {
          ...
          description:
            "Kayle se soigne et soigne l'allié le plus proche, et tous les deux reçoivent un bonus en vitesse de déplacement.",
          tooltip:
            "Kayle et le champion allié ciblé récupèrent <healing>{{ totalheal }} PV</healing> et reçoivent un bonus de +{{ totalhaste }} en vitesse de déplacement pendant {{ hasteduration }} sec.",
          leveltip: {
            label: [
              "Soins",
        ...
        },
        {
          ...
          description:
            "Passive : l'épée céleste de Kayle, Vertu, inflige des dégâts magiques supplémentaires aux ennemis qu'elle attaque.<br><br>Active : la prochaine attaque de Kayle déchaîne le feu céleste sur sa cible, infligeant des dégâts supplémentaires en fonction des PV manquants de la cible.",
          tooltip:
            "<spellPassive>Passive :</spellPassive> les attaques de Kayle infligent <magicDamage>{{ epassivetotaldamage }} pts de dégâts magiques supplémentaires</magicDamage>.<br /><br /><spellActive>Active :</spellActive> la prochaine attaque de Kayle devient une attaque à distance et inflige des <magicDamage>dégâts magiques</magicDamage> supplémentaires équivalents à <magicDamage>{{ activetotalexecutedamage }}</magicDamage> des PV manquants de la cible. Cette attaque s'améliore quand Kayle atteint le <scaleLevel>niveau {{ spell.kaylepassive:levelforpassiverank2 }}</scaleLevel>, ce qui lui permet d'exploser au contact de sa cible et d'infliger des dégâts aux ennemis proches.",
          leveltip: {
            label: [
              "Dégâts passifs",
        ...
        },
        {
          ...
          name: "Jugement divin",
          description:
            "Kayle rend un allié invulnérable et fait appel aux anciennes Manifestations de la Justice pour faire tomber une pluie d'épées purificatrices autour de sa cible.",
          tooltip:
            "Kayle rend invulnérable un champion allié pendant {{ invulnduration }} sec.<br /><br />Après le temps d'incantation, elle purifie la zone autour de cet allié, infligeant <magicDamage>{{ totaldamage }} pts de dégâts magiques</magicDamage> aux ennemis proches.",
          leveltip: {
            label: [
              "Dégâts",
              "Durée de l'immunité",
      ...
      passive: {
        ...
        description:
          "Les attaques de Kayle sont renforcées par les cieux au fur et à mesure qu'elle gagne des niveaux et dépense des points de compétence. Ses ailes s'enflamment tandis qu'elle gagne progressivement de la vitesse d'attaque, de la vitesse de déplacement, de la portée d'attaque et des vagues de feu sur ses attaques.",
        image: {
          full: "Kayle_P.png",
          sprite: "passive1.png",
          group: "passive",
      ...
      recommended: [
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              hiddenWithAnyOf: [""],
              items: [
                { id: "1042", count: 2, hideCount: false },
