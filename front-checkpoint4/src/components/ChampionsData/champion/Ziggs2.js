...
const Ziggs2 = {
  ...
  data: {
    Ziggs: {
      ...
      skins: [
        { id: "115000", num: 0, name: "default", chromas: false },
        { id: "115001", num: 1, name: "Ziggs savant fou", chromas: false },
        { id: "115002", num: 2, name: "Commandant Ziggs", chromas: false },
        { id: "115003", num: 3, name: "Ziggs bombe à eau", chromas: false },
        { id: "115004", num: 4, name: "Ziggs des neiges", chromas: false },
        {
          id: "115005",
          num: 5,
        ...
        { id: "115006", num: 6, name: "Ziggs boss de combat", chromas: false },
        { id: "115007", num: 7, name: "Ziggs de l'Odyssée", chromas: true },
        { id: "115014", num: 14, name: "Ziggs folie sucrée", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Ziggs lance une bombe rebondissante qui inflige des dégâts magiques.",
          tooltip:
            "Ziggs lance une bombe rebondissante qui inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Ziggs jette une charge explosive qui explose au bout de 4 sec ou quand vous réactivez cette compétence. L'explosion inflige des dégâts magiques aux ennemis et les repousse. Ziggs aussi est repoussé mais il ne subit aucun dégât. Ziggs peut utiliser cette charge pour hexploser les tourelles ennemies vulnérables.",
          tooltip:
            'Ziggs jette une charge explosive qui explose au bout de {{ e2 }} sec, ou quand vous réactivez cette compétence. L\'explosion inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis et les repousse. Ziggs aussi est repoussé, mais il ne subit aucun dégât.<br /><br />Charge explosive fait <span class="colorD41919">hexploser</span> les tourelles qui ont moins de {{ f1*100 }}% de leurs PV.',
          leveltip: {
            label: [
              "Dégâts",
              "Délai de récupération",
        ...
        },
        {
          ...
          description:
            "Ziggs disperse des mines de proximité qui explosent au contact des ennemis, leur infligeant des dégâts magiques et les ralentissant. Quand un ennemi déclenche une mine, les mines supplémentaires lui infligent des dégâts réduits.",
          tooltip:
            "Ziggs disperse des mines de proximité qui explosent au contact des ennemis, leur infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques. Les ennemis touchés sont ralentis de {{ e2 }}% pendant {{ e4 }} sec.<br /><br />Quand un ennemi déclenche une mine, les mines supplémentaires lui infligent {{ e5 }}% des dégâts. Les mines sont désamorcées automatiquement au bout de {{ e3 }} sec.",
          leveltip: {
            label: [
              "Dégâts de la mine",
              "Ralentissement",
        ...
        },
        {
          ...
          description:
            "Ziggs déploie sa création ultime, la Méga bombe infernale, et la lance de très loin. Les ennemis dans la zone d'impact principale subissent plus de dégâts que les ennemis plus éloignés.",
          tooltip:
            "Ziggs déploie sa création ultime, la Méga bombe infernale, et la lance de très loin. Les ennemis dans la zone d'impact principale subissent {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques. Les ennemis plus éloignés subissent {{ e5 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts magiques.",
          leveltip: {
            label: [
              "Dégâts",
          ...
          vars: [
            { link: "spelldamage", coeff: 1.1, key: "a1" },
            { link: "spelldamage", coeff: 0.7333, key: "a2" },
          ],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
      ...
      passive: {
        name: "Mèche courte",
        description:
          "Périodiquement, la prochaine attaque de base de Ziggs inflige des dégâts magiques supplémentaires. Ce délai est réduit quand Ziggs utilise une compétence.",
        image: {
