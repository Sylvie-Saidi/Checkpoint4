...
const Hecarim2 = {
  ...
  data: {
    Hecarim: {
      ...
      skins: [
        { id: "120000", num: 0, name: "default", chromas: false },
        {
          id: "120001",
          num: 1,
        ...
        { id: "120002", num: 2, name: "Hecarim faucheur", chromas: false },
        { id: "120003", num: 3, name: "Hecarim sans tête", chromas: false },
        { id: "120004", num: 4, name: "Hecarim arcade", chromas: false },
        { id: "120005", num: 5, name: "Hecarim sylvestre", chromas: false },
        { id: "120006", num: 6, name: "Hecarim brise-monde", chromas: false },
        { id: "120007", num: 7, name: "Hecarim Lancier Zéro", chromas: false },
        { id: "120008", num: 8, name: "Hecarim de l'Ouest", chromas: true },
      ],
      lore:
      ...
      spells: [
        ...
        },
        {
          ...
          description:
            "Hecarim inflige des dégâts magiques aux ennemis proches pendant un court instant. Il regagne un nombre de PV équivalent à un pourcentage de tous les dégâts subis par ces ennemis.",
          tooltip:
            "Hecarim inflige {{ e2 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques en {{ e3 }} sec à tous les ennemis proches. Hecarim récupère des PV équivalents à {{ e1 }}% des dégâts subis par ces ennemis, toutes sources confondues.<br /><br />Hecarim ne peut pas récupérer plus de {{ e4 }} PV provenant des sbires ou des monstres.",
          leveltip: {
            label: [
              "Dégâts",
              "PV soignés max",
        ...
        },
        {
          ...
          description:
            "La vitesse de déplacement d'Hecarim augmente et il peut traverser les unités pendant un court instant. Sa prochaine attaque repousse la cible et inflige des dégâts physiques supplémentaires en fonction de la distance parcourue depuis l'activation de la compétence.",
          tooltip:
            "La vitesse de déplacement d'Hecarim augmente et il peut traverser les unités pendant {{ e5 }} sec. Sa prochaine attaque repousse la cible, lui infligeant de {{ e4 }} <scaleAD>(+{{ a1 }})</scaleAD> à {{ e3 }}<scaleAD> (+{{ a2 }})</scaleAD> pts de dégâts physiques selon la distance parcourue par Hecarim pendant Charge dévastatrice (la distance de repoussement augmente aussi).<br /><br /><rules>La durée restante de Charge dévastatrice est mise en pause pendant Légion des ombres.</rules>",
          leveltip: {
            label: [
              "Dégâts minimum",
              "Dégâts maximum",
          ...
          vars: [
            ...
            { link: "bonusattackdamage", coeff: 1, key: "a2" },
          ],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
        ...
        },
        {
          ...
          description:
            "Hecarim invoque des cavaliers fantomatiques et charge devant lui, infligeant des dégâts magiques sur une ligne. À la fin de sa charge, Hecarim crée une onde de choc qui effraie les ennemis proches.",
          tooltip:
            "Hecarim invoque des cavaliers fantomatiques et charge devant lui, infligeant {{ basedamage }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis touchés. <br /><br />Hecarim libère une onde de choc à la fin de sa charge, faisant fuir les ennemis proches de lui pendant {{ feardurationmin }} à {{ feardurationmax }} sec (augmente avec la distance de la charge).<br /><br /><rules>Hecarim se déplace uniquement vers la zone ciblée. Les cavaliers parcourent toujours la totalité de la distance.</rules>",
          leveltip: {
      ...
      passive: {
        name: "Galop",
        description:
          "Les dégâts d'attaque d'Hecarim augmentent d'un montant égal à un pourcentage de sa vitesse de déplacement bonus.",
        image: {
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              minSummonerLevel: -1,
              maxSummonerLevel: -1,
              showIfSummonerSpell: "SummonerSiegeChampSelect2",
              hideIfSummonerSpell: "",
              appendAfterSection: "",
              visibleWithAllOf: [""],
              hiddenWithAnyOf: [""],
