...
const Shaco2 = {
  ...
  data: {
    Shaco: {
      ...
      skins: [
        { id: "35000", num: 0, name: "default", chromas: false },
        { id: "35001", num: 1, name: "Shaco le fou", chromas: false },
        { id: "35002", num: 2, name: "Shaco royal", chromas: false },
        { id: "35003", num: 3, name: "Shac-noisettes", chromas: false },
        { id: "35004", num: 4, name: "Shaco mécanique", chromas: false },
        { id: "35005", num: 5, name: "Shaco aliéné", chromas: false },
        { id: "35006", num: 6, name: "Shaco masqué", chromas: false },
        { id: "35007", num: 7, name: "Shaco joker", chromas: false },
        { id: "35008", num: 8, name: "Shaco du pulsar sombre", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Tromperie",
          description:
            "Shaco devient invisible et se téléporte vers la position ciblée.<br><br>Sa première attaque en étant invisible est renforcée : elle inflige des dégâts supplémentaires et, si Shaco frappe dans le dos d'un ennemi, un coup critique.",
          tooltip:
            'Shaco se téléporte à proximité et devient <span class="color91d7ee">invisible</span> pendant {{ stealthduration }} sec. Shaco reste <span class="color91d7ee">invisible</span> même s\'il utilise Boîte surprise ou Hallucination. <br /><br />Sa prochaine attaque de base pendant l\'<span class="color91d7ee">invisibilité</span> inflige <physicalDamage>{{ totaldamage }}</physicalDamage> pts de dégâts physiques supplémentaires (ces dégâts peuvent être critiques). Si Shaco frappe dans le dos d\'un ennemi, cette attaque devient un coup critique infligeant {{ f1 }}% de dégâts.<br /><br /><u><span class="size16 color91d7ee">Furtivité - Invisibilité</span></u><span class="size16 colorb3b3b3"> : Shaco ne peut être révélé que par les tourelles ennemies proches ou la <span class="size16 coloree91d7">vision pure</span>.</span>',
          leveltip: {
            label: ["Dégâts", "Durée de la furtivité", "Délai de récupération"],
            effect: [
        ...
        },
        {
          ...
          tooltip:
            "Shaco crée une boîte surprise qui se cache au bout de {{ e5 }} sec. Elle réapparaît quand un ennemi approche ou quand une balise ou une relique la découvre, faisant fuir les ennemis proches très lentement pendant {{ e3 }} sec ({{ minionfearduration }} sec pour les sbires et les monstres).<br /><br />La boîte surprise attaque tous les ennemis proches en leur infligeant {{ aoedamage }} pts de dégâts magiques, et les dégâts augmentent à {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> si elle n'attaque qu'un seul ennemi. Sa durée est de {{ e4 }} <scaleAP>(+{{ a2 }})</scaleAP> sec quand elle est cachée ou 5 sec une fois activée. ",
          leveltip: {
            label: ["Dégâts", "Durée de peur", "Coût en @AbilityResourceName@"],
            effect: [
              "{{ e1 }} -> {{ e1NL }}",
              "{{ e3 }} -> {{ e3NL }}",
              "{{ cost }} -> {{ costNL }}",
          ...
          vars: [
            ...
            { link: "spelldamage", coeff: 0.05, key: "a2" },
          ],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
        ...
        },
        {
          ...
          name: "Poison double",
          description:
            "Passivement, Shaco empoisonne les cibles qu'il touche, réduisant leur vitesse de déplacement. Shaco peut lancer son arme pour infliger des dégâts et empoisonner sa cible. Le poignard lancé inflige des dégâts supplémentaires si la cible a moins de 30% de ses PV.",
          tooltip:
            "<spellPassive>Passive :</spellPassive> quand Poison double peut être lancé, les attaques de base de Shaco réduisent la vitesse de déplacement de la cible de {{ slowamount*-100 }}% pendant {{ slowdurationpassive }} sec.<br /><br /><spellActive>Active :</spellActive> Shaco lance un poignard qui inflige {{ totaldamage }} pts de dégâts magiques et qui réduit la vitesse de déplacement de la cible de {{ slowamount*-100 }}% pendant {{ slowdurationactive }} sec. Si la cible a moins de {{ executehealththreshold*100 }}% de ses PV, le poignard inflige {{ executedamagepercent*100 }}% de dégâts (total : {{ totalexecutedamage }}).",
          leveltip: {
        ...
        },
        {
          ...
          name: "Hallucination",
          description:
            "Shaco crée un double de lui-même à ses côtés qui peut attaquer les ennemis proches (inflige des dégâts réduits aux tourelles). En mourant, il explose, faisant apparaître trois mini-boîtes surprises et blessant les ennemis à portée.",
          tooltip:
            "Shaco disparaît brièvement et réapparaît avec un clone. Le clone dure jusqu'à {{ clonelifetime }} sec et explose quand il meurt, infligeant <magicDamage>{{ explosiontotaldamage }} pts de dégâts magiques</magicDamage> aux ennemis proches et faisant apparaître trois mini-boîtes surprises qui se déclenchent immédiatement. <br /><br /><ul><li>Les mini-boîtes infligent {{ aoedamage }} pts de dégâts ({{ stdamage }} si elles n'attaquent qu'un seul ennemi) et font fuir les ennemis pendant {{ boxfearduration }} sec.</li><li>Le clone inflige {{ cloneaadamagepercent*100 }}% des dégâts de Shaco et subit des dégâts augmentés de {{ cloneincomingdamagepercent*100 }}%.</li></ul><br /><scaleAP>Le clone peut être contrôlé en maintenant la touche Alt et en cliquant avec le bouton droit de la souris, ou en réactivant cette compétence.</scaleAP>",
          leveltip: {
            label: [
              "Dégâts en mourant",
          ...
          effectBurn: [null, "0", "0", "0", "0", "6", "0", "0", "0", "0", "0"],
          vars: [],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
          range: [200, 200, 200],
      ...
      passive: {
        name: "Traîtrise",
        description:
          "Les attaques de base et la compétence Poison double de Shaco infligent des dégâts supplémentaires lorsqu'elles frappent dans le dos d'un ennemi.",
        image: {
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              showIfSummonerSpell: "",
              hideIfSummonerSpell: "",
              items: [{ id: "2140", count: 1, hideCount: true }],
            },
          ],
        },
        {
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                { id: "3026", count: 1, hideCount: false },
                { id: "3181", count: 1, hideCount: false },
                { id: "3031", count: 1, hideCount: false },
              ],
            },
            {
