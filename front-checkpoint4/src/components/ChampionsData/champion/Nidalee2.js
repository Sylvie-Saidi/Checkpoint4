...
const Nidalee2 = {
  ...
  data: {
    Nidalee: {
      ...
      skins: [
        { id: "76000", num: 0, name: "default", chromas: false },
        {
          id: "76001",
          num: 1,
        ...
        { id: "76002", num: 2, name: "Nidalee léopard", chromas: false },
        { id: "76003", num: 3, name: "Nidalee servante", chromas: false },
        { id: "76004", num: 4, name: "Pharaon Nidalee", chromas: false },
        { id: "76005", num: 5, name: "Nidalee sorcière", chromas: false },
        {
          id: "76006",
          num: 6,
        ...
        { id: "76008", num: 8, name: "Nidalee challenger", chromas: true },
        {
          id: "76009",
          num: 9,
      ...
      spells: [
        {
          ...
          tooltip:
            '<span class="size18 colorFF9900">Forme humaine : </span>Nidalee lance un javelot qui inflige {{ e1 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts magiques. Si le javelot va plus loin que sa portée d\'attaque de base, les dégâts augmentent avec la distance parcourue, jusqu\'à un maximum de {{ e2 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts.<br /><br /><span class="size18 colorFF9900">Forme de Couguar : </span>la prochaine attaque de Nidalee inflige des dégâts supplémentaires, et encore plus aux cibles dont les PV sont faibles.',
          leveltip: {
            label: [
              "Dégâts min du javelot",
        ...
        },
        {
          ...
          tooltip:
            '<span class="size18 colorFF9900">Forme humaine : </span>Nidalee pose un piège invisible qui dure jusqu\'à 2 minutes. Le piège se déclenche quand un ennemi marche dessus, révélant la victime et lui infligeant {{ e7 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts magiques en 4 sec.<br /><br /><scaleLevel>{{ f4 }}</scaleLevel> pièges peuvent être actifs simultanément. (Ce nombre augmente aux niveaux 6, 11 et 16.)<br /><br /><span class="size18 colorFF9900">Forme de Couguar : </span>Nidalee bondit dans la direction ciblée, infligeant des dégâts aux ennemis proches.',
          leveltip: {
            label: [
              "Dégâts du piège",
          ...
          vars: [{ link: "spelldamage", coeff: 0.2, key: "a2" }],
          costType: " {{ abilityresourcename }}",
          maxammo: "0",
        ...
        },
        {
          ...
          description:
            "Dans sa forme humaine, Nidalee canalise l'esprit du Couguar pour soigner ses alliés et leur conférer temporairement un bonus en vitesse d'attaque. Sous la forme d'un Couguar, elle donne un coup de griffes aux ennemis devant elle.",
          tooltip:
            '<span class="size18 colorFF9900">Forme humaine : </span>Nidalee rend de {{ e1 }} <scaleAP>(+{{ a2 }})</scaleAP> à {{ e2 }} <scaleAP>(+{{ f3 }})</scaleAP> PV au champion allié ciblé, en fonction de ses PV manquants, et lui confère un bonus de {{ e4 }}% en vitesse d\'attaque pendant 7 sec.<br /><br /><span class="size18 colorFF9900">Forme de Couguar : </span> Nidalee griffe les ennemis dans la direction ciblée.',
          leveltip: {
            label: [
              "Soins de Charge primale",
          ...
          vars: [{ link: "spelldamage", coeff: 0.325, key: "a2" }],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
        ...
        },
        {
          ...
          description:
            "Nidalee prend la forme d'un Couguar, ce qui lui confère de nouvelles compétences.",
          tooltip:
            '<span class="size18 colorFF9900">Forme humaine : </span>Nidalee prend la forme d\'un Couguar dont les compétences de base deviennent Mise à terre, Bond et Taillade.<br /><br /><span class="size18 colorFF9900">Forme de Couguar : </span>Nidalee reprend sa forme humaine. En forme humaine, déclencher la <keywordMajor>chasse</keywordMajor> met fin au délai de récupération d\'Aspect du Couguar.',
          leveltip: {
            label: [
              "Dégâts de Mise à terre",
          ...
          effectBurn: [null, "0", "0", "0", "0", "0", "6", "0", "10", "0", "0"],
          vars: [],
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                { id: "1410", count: 1, hideCount: false },
              ],
            },
            {
              type: "offensive",
