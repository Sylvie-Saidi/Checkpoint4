const Kassadin2 = {
  ...
  data: {
    Kassadin: {
      ...
      skins: [
        { id: "38000", num: 0, name: "default", chromas: false },
        { id: "38001", num: 1, name: "Kassadin du Festival", chromas: false },
        {
          id: "38002",
          num: 2,
          name: "Kassadin des profondeurs",
          chromas: false,
        },
        { id: "38003", num: 3, name: "Kassadin humain", chromas: false },
        { id: "38004", num: 4, name: "Kassadin héraut", chromas: false },
        {
          id: "38005",
          num: 5,
        ...
        { id: "38006", num: 6, name: "Comte Kassadin", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Orbe du Néant",
          description:
            "Kassadin tire un orbe d'énergie du Néant sur sa cible, infligeant des dégâts et interrompant les canalisations. Le surplus d'énergie lui confère un bouclier temporaire qui absorbe les dégâts magiques.",
          tooltip:
            "Kassadin tire un orbe d'énergie du Néant qui inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et interrompt les canalisations.<br /><br />Le surplus d'énergie lui confère un bouclier pendant {{ e4 }} sec, absorbant jusqu'à {{ e3 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts magiques.",
          leveltip: {
            label: [
              "Dégâts",
              "PV du bouclier",
        ...
        },
        {
          ...
          name: "Lame éthérée",
          description:
            "Passive : les attaques de base de Kassadin infligent des dégâts magiques supplémentaires. Active : la prochaine attaque de base de Kassadin inflige d'importants dégâts magiques supplémentaires et lui rend du mana.",
          tooltip:
            "<spellPassive>Passive : </spellPassive>les attaques de base de Kassadin tirent leur énergie du Néant, infligeant {{ e2 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques supplémentaires.<br /><br /><spellPassive>Active : </spellPassive>Kassadin charge sa lame, ce qui permet à sa prochaine attaque de base d'infliger {{ e3 }} <scaleAP>(+{{ a2 }})</scaleAP> pts de dégâts magiques supplémentaires et de lui rendre <scaleMana>{{ e1 }}% de son mana manquant</scaleMana> (<scaleMana>{{ e4 }}%</scaleMana> si la cible est un champion).",
          leveltip: {
            label: [
              "Dégâts actifs",
              "Mana rendu de base",
          ...
          vars: [
            { link: "spelldamage", coeff: 0.1, key: "a1" },
        ...
        },
        {
          ...
          name: "Pulsation",
          description:
            "Kassadin tire de l'énergie des sorts lancés près de lui. Après avoir tiré assez d'énergie, Kassadin peut utiliser Pulsation pour blesser et ralentir les ennemis dans une zone en forme de cône devant lui.",
          tooltip:
            "Kassadin exploite l'énergie de la magie qui l'entoure, gagnant une charge à chaque fois que l'on incante un sort près de lui.<br /><br />Au bout de 6 charges, Kassadin peut utiliser Pulsation pour infliger {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et ralentir de {{ e2 }}% pendant {{ e3 }} sec les ennemis dans une zone en forme de cône devant lui.",
          leveltip: {
            label: [
              "Dégâts",
              "Ralentissement",
        ...
        },
        {
          ...
          name: "Fissure",
          description:
            "Kassadin se téléporte vers une destination proche, blessant les ennemis se trouvant à proximité. Chaque utilisation de Fissure dans une courte période augmente le coût en mana et les dégâts de la Fissure suivante.",
          tooltip:
            "Kassadin se téléporte dans une zone proche et inflige {{ e1 }} <scaleMana>(+{{ f2 }})</scaleMana> <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux unités ennemies proches.<br /><br />Chaque nouvelle Fissure dans les {{ e2 }} sec suivantes double le coût en mana, mais inflige {{ e3 }} <scaleMana>(+{{ f1 }})</scaleMana> <scaleAP>(+{{ f3 }})</scaleAP> pts de dégâts magiques supplémentaires par effet (cumulable jusqu'à {{ e6 }} fois).",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              maxSummonerLevel: -1,
              showIfSummonerSpell: "",
              hideIfSummonerSpell: "SummonerOdinPromote",
              items: [
                { id: "2003", count: 1, hideCount: true },
