const Ivern2 = {
  ...
  data: {
    Ivern: {
      ...
      skins: [
        { id: "427000", num: 0, name: "default", chromas: false },
        { id: "427001", num: 1, name: "Ivern roi des bonbons", chromas: false },
        { id: "427002", num: 2, name: "Ivern roi du dunk", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Enracinement",
          description:
            "Ivern projette une racine, infligeant des dégâts et immobilisant les cibles ennemies touchées. Les alliés d'Ivern peuvent foncer vers la cible immobilisée.",
          tooltip:
            "Ivern projette une racine, infligeant {{ e5 }} <scaleAP>(+{{ f1 }})</scaleAP> pts de dégâts magiques et immobilisant le premier ennemi touché pendant {{ e1 }} sec. Les alliés peuvent cliquer sur l'ennemi immobilisé pour foncer se mettre à portée d'attaque.",
          leveltip: {
            label: [
        ...
        },
        {
          ...
          name: "Main verte",
          description:
            "Dans les hautes herbes, les attaques d'Ivern infligent des dégâts magiques supplémentaires. Ivern peut activer cette compétence pour créer une parcelle d'herbes hautes.",
          tooltip:
            "<spellPassive>Passive :</spellPassive> dans les hautes herbes, les attaques d'Ivern infligent {{ e5 }} <scaleAP>(+{{ f2 }})</scaleAP> pts de dégâts magiques supplémentaires.<br /><br /><spellPassive>Active :</spellPassive> Ivern fait pousser une parcelle d'herbes hautes pendant {{ e1 }} sec. Pendant 3 sec, la zone dans et autour de cette parcelle est révélée.",
          leveltip: {
            label: [
              "Dégâts magiques supplémentaires",
              "Rechargement des hautes herbes",
            ],
            effect: ["{{ e5 }} -> {{ e5NL }}", "{{ e4 }} -> {{ e4NL }}"],
          },
          maxrank: 5,
        ...
        },
        {
          ...
          description:
            "Ivern offre à un allié un bouclier qui explose après un court instant, ralentissant et blessant les ennemis.",
          tooltip:
            "Ivern offre à un allié un bouclier qui absorbe jusqu'à {{ e1 }} <scaleAP>(+{{ f3 }})</scaleAP> pts de dégâts.<br />Au bout de 2 sec, le bouclier explose, infligeant {{ e2 }} <scaleAP>(+{{ f4 }})</scaleAP> pts de dégâts magiques et ralentissant les ennemis de {{ e3 }}% pendant {{ e4 }} sec.<br /><br /><rules><scaleArmor>Peut aussi être lancé sur Marguerite.</scaleArmor></rules>",
          leveltip: {
            label: [
              "PV du bouclier",
              "Dégâts",
        ...
        },
        {
          ...
          name: "Marguerite !",
          description:
            "Ivern invoque son amie Marguerite, une sentinelle, pour qu'elle combatte à ses côtés. Marguerite envoie une onde de choc si elle attaque le même champion trois fois de suite.",
          tooltip:
            "Ivern invoque son amie Marguerite, une sentinelle, pendant {{ f6 }} sec. Si Marguerite attaque le même champion trois fois de suite, elle lance une onde de choc qui projette les ennemis en l'air pendant 1 sec (3 sec de récupération). Marguerite a :<ul><li>PV : {{ totaldaisyhp }}</li><li>Armure et résistance magique : {{ totalbonusresists }}</li><li>Dégâts d'attaque : {{ totaldaisyad }}</li></ul><br /><rules><scaleArmor>Réactiver cette compétence permet de diriger manuellement Marguerite.</scaleArmor></rules>",
          leveltip: {
            label: [
              "Délai de récupération",
      ...
      passive: {
        ...
        description:
          "Ivern ne peut pas attaquer ou être attaqué par les monstres non épiques. Ivern peut créer des bosquets magiques qui se développent progressivement sur les camps de monstres. Quand le bosquet est pleinement développé, Ivern peut libérer les monstres pour recevoir des PO et de l'expérience. Passé le niveau 5, Ivern peut partager les enchantements de la jungle avec ses alliés.",
        image: {
          full: "IvernP.png",
          sprite: "passive1.png",
          group: "passive",
