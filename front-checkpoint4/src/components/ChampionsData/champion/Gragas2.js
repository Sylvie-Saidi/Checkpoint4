...
const Gragas2 = {
  ...
  data: {
    Gragas: {
      ...
      skins: [
        { id: "79000", num: 0, name: "default", chromas: false },
        { id: "79001", num: 1, name: "Gragas plongeur", chromas: false },
        { id: "79002", num: 2, name: "Gragas péon", chromas: false },
        { id: "79003", num: 3, name: "Père Gragas", chromas: false },
        { id: "79004", num: 4, name: "Gragas la classe", chromas: false },
        { id: "79005", num: 5, name: "Gragas Vandale", chromas: false },
        { id: "79006", num: 6, name: "Gragas Oktoberfest", chromas: false },
        { id: "79007", num: 7, name: "Gragas superfan", chromas: false },
        { id: "79008", num: 8, name: "Fnatic Gragas", chromas: false },
        {
          id: "79009",
          num: 9,
          name: "Gragas brasseur solaire",
          chromas: false,
        },
        { id: "79010", num: 10, name: "Gragas arctique", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          tooltip:
            "Gragas fait rouler son fût jusqu'à l'endroit indiqué. Quand vous réactivez la compétence ou au bout de {{ e4 }} sec, le fût explose, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis proches et réduisant leur vitesse de déplacement de {{ e2 }}% pendant {{ e3 }} sec.<br /><br />Les dégâts et la force du ralentissement augmentent au fur et à mesure que le fût fermente, jusqu'à {{ e6 }}% au bout de {{ e5 }} sec. Inflige {{ e7 }}% de dégâts aux sbires.",
          leveltip: {
            label: [
              "Dégâts",
              "Ralentissement",
        ...
        },
        {
          ...
          tooltip:
            "Gragas boit un coup et subit des dégâts réduits de {{ e1 }}% <scaleAP>(+{{ charabilitypower2*100 }}%)</scaleAP> pendant {{ e5 }} sec.<br /><br />Après avoir bu, sa prochaine attaque de base inflige aux ennemis proches des dégâts magiques supplémentaires équivalents à {{ e3 }} <scaleAP>(+{{ a1 }})</scaleAP> plus {{ e2 }}% des PV max de la cible ({{ e4 }} pts de dégâts max contre les monstres).",
          leveltip: {
            label: ["Réduction des dégâts", "Dégâts"],
        ...
        },
        {
          ...
          name: "Coup de bidon",
          description:
            "Gragas charge vers une zone ciblée et percute le premier ennemi rencontré, infligeant des dégâts à tous les ennemis proches et les étourdissant.",
          tooltip:
            "Gragas se rue en avant, percutant le premier ennemi rencontré. Il inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis dans la zone et les repousse, les étourdissant pendant {{ e2 }} sec.<br /><br />Le délai de récupération de Coup de bidon est réduit de {{ f1 }} sec si Gragas percute une unité.",
          leveltip: {
        ...
        },
        {
          ...
          tooltip:
            "Gragas lance son fût, lequel explose à l'atterrissage. Les ennemis touchés subissent {{ basedamage }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et sont repoussés loin de l'explosion.",
          leveltip: {
            label: ["Dégâts", "Délai de récupération"],
            effect: [
      ...
      passive: {
        name: "Tournée",
        description:
          "Quand il utilise une compétence, Gragas boit une gorgée et récupère 6% de ses PV max. Cet effet ne peut se produire qu'une fois toutes les 8 sec.",
        image: {
