...
const Fiddlesticks2 = {
  ...
  data: {
    Fiddlesticks: {
      ...
      skins: [
        { id: "9000", num: 0, name: "default", chromas: false },
        { id: "9001", num: 1, name: "Fiddlesticks spectral", chromas: false },
        { id: "9002", num: 2, name: "Fiddlesticks Union Jack", chromas: false },
        { id: "9003", num: 3, name: "Fiddlesticks le bandito", chromas: false },
        { id: "9004", num: 4, name: "Fiddlesticks citrouille", chromas: false },
        { id: "9005", num: 5, name: "Fiddlesticks pirate", chromas: false },
        {
          id: "9006",
          num: 6,
        ...
        { id: "9008", num: 8, name: "Fiddlesticks réanimé", chromas: false },
        { id: "9009", num: 9, name: "Fiddlesticks prétorien", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Terreur",
          description:
            "Si Fiddlesticks blesse un ennemi avec un sort en n'étant pas visible ou s'il cible un ennemi avec la propriété active de Terreur, il terrifie cet ennemi et le fait fuir aussi longtemps que dure l'effet.",
          tooltip:
            '<span class="color6655CC">Passive :</span> en dehors des combats, si Fiddlesticks n\'est pas visible, blesser un ennemi avec un sort le terrifie pendant {{ fearduration }} sec.<br /><br /><span class="color6655CC">Active :</span> terrifie une cible pendant {{ fearduration }} sec et inflige des dégâts magiques équivalents à {{ maxhealthdamage*100 }}% (+1% tous les 50 pts de puissance) des PV actuels de la cible (minimum : {{ minimumdamage }}). <br /><br />Si la cible a été terrifiée récemment, elle subit à la place des dégâts magiques équivalents à {{ maxhealthdamage*200 }}% (+2% tous les 50 pts de puissance) de ses PV actuels (minimum : {{ minimumdamage*2 }}). <br /><br /><rules>400 pts de dégâts max contre les monstres.</rules><br />',
          leveltip: {
            label: ["Durée", "Délai de récupération", "% des PV actuels"],
            effect: [
        ...
        },
        {
          ...
          description:
            "Fiddlesticks draine l'essence vitale des ennemis proches, infligeant des dégâts d'exécution supplémentaires à la fin de l'effet.",
          tooltip:
            "Fiddlesticks draine l'âme des ennemis proches, infligeant <scaleAP>{{ draindamagecalc }}</scaleAP> pts de dégâts magiques par seconde pendant 2 sec, plus {{ percentfortooltip }}% de leurs PV manquants lors de la dernière application de dégâts.<br /><br />Fiddlesticks récupère des PV équivalents à {{ vamppercentage }}% des dégâts infligés avant mitigation, réduits à {{ minionhealingmod }}% contre les sbires.<br /><br />Si la canalisation va jusqu'à son terme ou s'il ne reste plus rien à moissonner, le délai de récupération restant est réduit de 60%.<br /><br /><rules>Les sbires subissent {{ miniondamagemod*100 }}% des dégâts.</rules><br />",
          leveltip: {
            label: [
              "Dégâts par seconde",
              "Pourcentage soigné",
        ...
        },
        {
          ...
          name: "Fauchaison",
          description:
            "Fiddlesticks donne un coup de faux dans une zone, ralentissant tous les ennemis touchés et réduisant au silence ceux touchés au centre de la zone.",
          tooltip:
            "Fiddlesticks déchaîne de la magie noire dans une zone en forme de croissant, infligeant <scaleAP>{{ damage }}</scaleAP> pts de dégâts magiques aux ennemis touchés et les ralentissant de {{ slowamount*-100 }}% pendant {{ silenceduration }} sec.<br /><br />Les ennemis au centre du croissant sont réduits au silence pendant la même durée en plus d'être ralentis.<br />",
          leveltip: {
        ...
        },
        {
          ...
          tooltip:
            "Fiddlesticks canalise le sort pendant {{ channeltime }} sec, puis il se téléporte à l'endroit ciblé en déchaînant une nuée de corbeaux meurtriers, infligeant {{ damagepersecond }} <scaleAP>(+{{ apratiotick }})</scaleAP> pts de dégâts magiques par seconde à toutes les unités ennemies dans la zone.<br /><br />L'effet dure {{ duration }} sec et inflige jusqu'à {{ totaldamage }} <scaleAP>(+{{ apratiofullduration }})</scaleAP> pts de dégâts magiques au total.",
          leveltip: {
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              minSummonerLevel: -1,
              maxSummonerLevel: -1,
              showIfSummonerSpell: "SummonerBoost",
              hideIfSummonerSpell: "SummonerSmite",
              appendAfterSection: "",
              visibleWithAllOf: [""],
              hiddenWithAnyOf: [""],
