const Jinx2 = {
  ...
  data: {
    Jinx: {
      ...
      skins: [
        { id: "222000", num: 0, name: "default", chromas: false },
        { id: "222001", num: 1, name: "Donna Jinx", chromas: false },
        { id: "222002", num: 2, name: "Jinx pyrotechnicienne", chromas: true },
        {
          id: "222003",
          num: 3,
          name: "Jinx tueuse de zombies",
          chromas: false,
        },
        {
          id: "222004",
        ...
        { id: "222013", num: 13, name: "Jinx de l'Odyssée", chromas: true },
        { id: "222020", num: 20, name: "PROJET : Jinx", chromas: true },
        { id: "222029", num: 29, name: "Jinx cœur-de-cible", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Flip flap !",
          description:
            "Jinx modifie ses attaques de base en optant pour Bang-Bang, son minigun, ou Poiscaille, son lance-roquettes. Les attaques avec Bang-Bang augmentent la vitesse d'attaque, tandis que les attaques avec Poiscaille infligent des dégâts de zone, ont une plus grande portée et drainent du mana.",
          tooltip:
            "Jinx change d'arme.<br /><br /><spellPassive>Poiscaille, le lance-roquettes :</spellPassive> les attaques de base infligent 110% de dégâts à la cible et aux ennemis proches, ont une portée augmentée de {{ e3 }}, consomment du mana et sont accélérées {{ e5 }}% moins efficacement par les bonus de vitesse d'attaque.<br /><br /><spellPassive>Bang-Bang, le minigun :</spellPassive> les attaques de base augmentent la vitesse d'attaque pendant 2,5 sec. Cet effet se cumule jusqu'à 3 fois pour un bonus total de {{ e1 }}%.<br /><br /><rules>Les effets cumulés se dissipent un par un et seule la première attaque au lance-roquettes en profite.</rules>",
          leveltip: {
            label: [
              "Portée bonus (roquette)",
              "Vitesse d'attaque totale (minigun)",
            ],
            effect: ["{{ e3 }} -> {{ e3NL }}", "{{ e1 }}% -> {{ e1NL }}%"],
          },
          maxrank: 5,
          cooldown: [1, 1, 1, 1, 1],
          cooldownBurn: "1",
          ...
          vars: [],
          costType: " pts de mana par roquette",
          maxammo: "-1",
          ...
          resource: "{{ cost }} pts de mana par roquette",
        },
        {
          id: "JinxW",
          name: "Zap !",
          description:
            "Jinx utilise Zapper, son pistolet, pour tirer un rayon qui inflige des dégâts au premier ennemi touché, le ralentit et le révèle.",
          tooltip:
            "Jinx tire un rayon électrique qui inflige {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques au premier ennemi touché, le révèle et le ralentit de {{ e2 }}% pendant 2 sec.<br /><br /><rules>Le délai d'incantation de Zap ! diminue à mesure que la vitesse d'attaque de Jinx augmente.</rules>",
          leveltip: {
            label: [
              "Dégâts",
              "Ralentissement",
          ...
          vars: [{ link: "attackdamage", coeff: 1.6, key: "a1" }],
        ...
        },
        {
          ...
          name: "Pyromâcheurs !",
          description:
            "Jinx lance des grenades immobilisantes qui explosent au bout de 5 sec et mettent le feu aux ennemis. Les Pyromâcheurs mordent les champions ennemis qui leur marchent dessus, les immobilisant.",
          tooltip:
            "Jinx lance 3 Pyromâcheurs qui, une fois armés, explosent au contact des champions ennemis, immobilisant la cible pendant 1,5 sec et interrompant immédiatement les compétences de déplacement en cours, avant d'infliger {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis proches en 1,5 sec. Les Pyromâcheurs restent en place 5 sec.",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Jinx tire une super roquette qui traverse la carte et dont les dégâts augmentent pendant le trajet. La roquette explose au contact d'un champion ennemi, infligeant des dégâts à ce champion et aux ennemis proches en fonction de leurs PV manquants.",
          tooltip:
            "Jinx tire une roquette dont les dégâts augmentent pendant la première seconde du trajet. La roquette explose sur le premier champion ennemi touché, infligeant de {{ damagefloor }} à {{ damagemax }} pts de dégâts physiques plus {{ percentdamage }}% des PV manquants du champion. Les ennemis proches subissent 80% des dégâts.",
          leveltip: {
            label: [
              "Dégâts minimum",
              "Dégâts maximum",
      ...
      passive: {
        name: "Enthousiasme !",
        description:
          "Si Jinx inflige des dégâts à un champion, à un monstre épique ou à une structure et si cette cible est tuée/détruite dans les 3 sec qui suivent, Jinx reçoit un énorme bonus en vitesse de déplacement et en vitesse d'attaque.",
        image: {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                { id: "2140", count: 1, hideCount: true },
                { id: "3363", count: 1, hideCount: false },
              ],
            },
          ],
        },
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                { id: "3508", count: 1, hideCount: false },
                { id: "3173", count: 1, hideCount: false },
                { id: "3813", count: 1, hideCount: false },
                { id: "3080", count: 1, hideCount: false },
              ],
            },
            {
              type: "odyjinx3",
