  ...
  data: {
    Aatrox: {
      ...
      skins: [
        ...
        { id: "266001", num: 1, name: "Aatrox justicier", chromas: false },
        { id: "266002", num: 2, name: "Mecha Aatrox", chromas: true },
        { id: "266003", num: 3, name: "Aatrox chasseur marin", chromas: false },
        { id: "266007", num: 7, name: "Aatrox lune de sang", chromas: false },
        {
          id: "266008",
          num: 8,
          name: "Aatrox lune de sang édition prestige",
          chromas: false,
        },
        { id: "266009", num: 9, name: "Aatrox héros de guerre", chromas: true },
      ],
      lore:
      ...
      blurb:
        "Autrefois, Aatrox et ses frères étaient honorés pour avoir défendu Shurima contre le Néant. Mais ils finirent par devenir une menace plus grande encore pour Runeterra : la ruse et la sorcellerie furent employées pour les battre. Cependant, après des...",
      allytips: [
      ...
      spells: [
        {
          ...
          description:
            "Aatrox abat son épée devant lui, infligeant des dégâts physiques. Il peut frapper jusqu'à 3 fois et chaque coup a une zone d'effet différente.",
          tooltip:
            "Aatrox abat son épée devant lui, infligeant <physicalDamage>{{ qdamage }} pts de dégâts physiques</physicalDamage>. Épée des Darkin peut être relancée 2 fois de plus et les dégâts augmentent à chaque fois.<br /><br />Les ennemis touchés par le tranchant sont brièvement projetés dans les airs et subissent plus de dégâts.",
          leveltip: {
            label: [
        ...
        },
        {
          ...
          description:
            "Aatrox frappe le sol, blessant le premier ennemi touché. Les champions et les grands monstres doivent vite quitter la zone d'effet sous peine d'être ramenés de force au point d'impact et de subir à nouveau les dégâts.",
          tooltip:
            "Aatrox frappe le sol, infligeant <physicalDamage>{{ wdamage }} pts de dégâts physiques</physicalDamage> au premier ennemi touché et le ralentissant de {{ wslowpercentage*-100 }}% pendant {{ wslowduration }} sec.<br /><br />Les champions et les grands monstres ont {{ wslowduration }} sec pour quitter la zone d'effet sous peine d'être ramenés de force au point d'impact et de subir à nouveau les dégâts.",
          leveltip: {
        ...
        },
        {
          ...
          name: "Ruée obscure",
          description:
            "Passivement, Aatrox se soigne quand il blesse des champions ennemis. À l'activation, il se rue dans une direction.",
          tooltip:
            "<spellPassive>Passive :</spellPassive> Aatrox récupère des PV équivalents à {{ espellvamp }}% des dégâts qu'il inflige aux champions.<br /><br /><spellActive>Active :</spellActive> Aatrox se rue dans une direction.",
          leveltip: {
            label: ["Délai de récupération", "% de soins"],
            effect: [
              "{{ cooldown }} -> {{ cooldownNL }}",
        ...
        },
        {
          ...
          description:
            "Aatrox libère sa forme démoniaque, effrayant les sbires ennemis proches et augmentant ses dégâts d'attaque, ses soins et sa vitesse de déplacement. La durée est prolongée s'il participe à l'élimination d'un champion ennemi.",
          tooltip:
            "Aatrox révèle sa véritable forme démoniaque pendant {{ rduration }} sec. À l'activation, il effraie les sbires ennemis proches et obtient un bonus décroissant en vitesse de déplacement. Tant que Fossoyeur des mondes persiste, ses dégâts d'attaque sont augmentés de {{ rtotaladamp*100 }}% et les soins qu'il reçoit sont augmentés de {{ rhealingamp*100 }}%.<br /><br />Quand il participe à l'élimination d'un champion ennemi, la durée de Fossoyeur des mondes est prolongée.",
          leveltip: {
            label: [
      ...
      passive: {
        ...
        description:
          "Régulièrement, la prochaine attaque de base d'Aatrox inflige des <physicalDamage>dégâts physiques</physicalDamage> supplémentaires et le soigne, selon un pourcentage des PV max de la cible. ",
        image: {
