const Khazix2 = {
  ...
  data: {
    Khazix: {
      ...
      skins: [
        { id: "121000", num: 0, name: "default", chromas: false },
        { id: "121001", num: 1, name: "Mecha Kha'Zix", chromas: true },
        {
          id: "121002",
          num: 2,
          name: "Kha'Zix gardien des sables",
          chromas: false,
        },
        {
          id: "121003",
      ...
      spells: [
        {
          ...
          description:
            "Kha'Zix inflige des dégâts physiques à sa cible. Les dégâts sont augmentés contre les cibles <font color='#FFF673'>isolées</font>. S'il choisit l'<font color='#00DD33'>évolution Griffes de faucheur</font>, Goût de la peur a un délai de récupération réduit s'il est utilisé contre une cible <font color='#FFF673'>isolée</font>. Kha'Zix augmente aussi la portée de ses attaques de base et de Goût de la peur.",
          tooltip:
            'Inflige {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques. Si la cible est <keywordMajor>isolée</keywordMajor>, les dégâts sont augmentés de {{ e2 }}% (<scaleAD>{{ f1 }}</scaleAD>).<br /><br /><span class="color00DD33">Évolution Griffes de faucheur :</span> augmente de {{ e3 }} la portée de Goût de la peur et des attaques de base de Kha\'Zix. Si la cible est <keywordMajor>isolée</keywordMajor>, le délai de récupération de Goût de la peur est réduit de {{ e4 }}%.',
          leveltip: { label: ["Dégâts"], effect: ["{{ e1 }} -> {{ e1NL }}"] },
          maxrank: 5,
          cooldown: [4, 4, 4, 4, 4],
          cooldownBurn: "4",
          cost: [20, 20, 20, 20, 20],
          ...
          vars: [{ link: "bonusattackdamage", coeff: 1.3, key: "a1" }],
        ...
        },
        {
          ...
          tooltip:
            "Projette des piques qui explosent au contact, infligeant {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques aux ennemis touchés. Rend {{ e2 }}<scaleAP> (+{{ a2 }})</scaleAP> PV à Kha'Zix s'il se trouve dans le rayon de l'explosion.<br /><br /><span class=\"color00DD33\">Évolution Batterie de piques :</span> Pique du Néant projette 3 piques dans une zone conique et ralentit les ennemis de {{ e3 }}% pendant {{ e4 }} sec. Les champions ennemis touchés sont révélés pendant 2 sec. Les cibles <keywordMajor>isolées</keywordMajor> sont ralenties de {{ e7 }}%.",
          leveltip: {
            label: ["Dégâts", "Soins", "Coût en @AbilityResourceName@"],
            effect: [
              "{{ e1 }} -> {{ e1NL }}",
              "{{ e2 }} -> {{ e2NL }}",
              "{{ cost }} -> {{ costNL }}",
        ...
        },
        {
          ...
          name: "Bond",
          description:
            "Kha'Zix bondit sur une zone, infligeant des dégâts physiques aux ennemis autour de son point de chute. S'il choisit l'<font color='#00DD33'>évolution Ailes</font>, la portée de Bond augmente de 200 et le délai de récupération est annulé quand il tue un champion ou réussit une assistance.",
          tooltip:
            'Bondit sur la zone ciblée, infligeant {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts physiques.<br /><br /><span class="color00DD33">Évolution Ailes :</span> la portée de Bond augmente de 200 et le délai de récupération est annulé quand Kha\'Zix tue un champion ou réussit une assistance.',
          leveltip: {
          ...
          vars: [{ link: "bonusattackdamage", coeff: 0.2, key: "a1" }],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
        ...
        },
        {
          ...
          description:
            "Chaque rang permet à Kha'Zix de faire évoluer l'une de ses compétences, ce qui lui confère un effet supplémentaire unique. Quand Assaut du Néant est activé, Kha'Zix devient <font color='#91d7ee'>invisible</font>, ce qui déclenche Menace invisible et augmente sa vitesse de déplacement. S'il choisit l'<font color='#00DD33'>évolution Occultation adaptative</font>, Assaut du Néant augmente la durée de son <font color='#91d7ee'>invisibilité</font> et peut être utilisé une fois de plus.",
          tooltip:
            '<spellPassive>Passive :</spellPassive> chaque rang d\'Assaut du Néant permet à Kha\'Zix de faire évoluer l\'une de ses compétences.<br /><br /><spellPassive>Active :</spellPassive> Kha\'Zix devient <span class="color91d7ee">invisible</span> pendant {{ stealthduration }} sec et active Menace invisible. Quand il est <span class="color91d7ee">invisible</span>, il augmente sa vitesse de déplacement de {{ bonusmovementspeedpercent*100 }}% et ignore les collisions avec les autres unités.<br /><br />Assaut du Néant peut être relancé dans les {{ recastwindow }} sec après l\'utilisation initiale, jusqu\'à {{ numberofcasts }} fois au total.<br /><br /><span class="color00DD33">Évolution Occultation adaptative :</span> le nombre d\'utilisations d\'Assaut du Néant est augmenté à {{ evolvednumberofcasts }} dans les {{ recastwindow }} sec, et la durée de sa furtivité est augmentée à {{ evolvedstealthduration }} sec.<br /><br /><u><span class="size16 color91d7ee">Furtivité - Invisibilité</span></u><span class="size16 colorb3b3b3"> : Kha\'Zix ne peut être révélé que par les tourelles ennemies proches ou la <span class="size16 coloree91d7">vision pure</span>.</span>',
          leveltip: {
            label: ["Évolutions disponibles", "Délai de récupération"],
            effect: [
      ...
      recommended: [
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              hideIfSummonerSpell: "",
              items: [
                { id: "3004", count: 1, hideCount: false },
        ...
        {
          champion: "Khazix",
          title: "RainbowScytherFIRSTBLOOD",
          map: "HA",
          mode: "FIRSTBLOOD",
          type: "riot",
          customTag: "",
          ...
          blocks: [
            {
              ...
              items: [
                ...
                { id: "3342", count: 1, hideCount: false },
              ],
            },
            {
              type: "essential",
