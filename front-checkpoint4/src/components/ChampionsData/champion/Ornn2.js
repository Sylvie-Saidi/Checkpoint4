const Ornn2 = {
  ...
  data: {
    Ornn: {
      ...
      skins: [
        { id: "516000", num: 0, name: "default", chromas: false },
        { id: "516001", num: 1, name: "Fulguro Ornn", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          tooltip:
            "Ornn frappe le sol, créant une fissure qui inflige {{ e1 }} <scaleAD>(+{{ f1 }})</scaleAD> pts de dégâts physiques et qui ralentit les ennemis de {{ e5 }}% pendant {{ e6 }} sec. Une colonne de lave se forme ensuite au bout de la fissure pendant {{ e3 }} sec.<br /><br /><rules>La fissure s'arrête peu après avoir touché un champion ennemi.</rules>",
          leveltip: {
          ...
          vars: [{ link: "attackdamage", coeff: 0.6, key: "f1" }],
        ...
        },
        {
          ...
          tooltip:
            "Ornn avance, il crache des flammes et il devient impossible à arrêter pendant {{ breathduration }} sec. Ces flammes infligent des <magicDamage>dégâts magiques équivalents à {{ maxpercenthpperticktooltip }}% des PV max de la cible</magicDamage>.<br /><br />Les ennemis touchés par la dernière flamme deviennent <span class=\"colorFF5733\">fragiles</span> pendant {{ brittleduration }} sec. Le prochain effet immobilisant contre un ennemi fragile dure 30% plus longtemps et inflige des <magicDamage>dégâts magiques équivalents à <scaleLevel>{{ brittlepercentmaxhpcalc }}</scaleLevel> des PV max de l'ennemi</magicDamage>.<br /><br /><rules>Les attaques de base d'Ornn repoussent les cibles fragiles.<br />Contre les champions et les sbires, inflige au minimum {{ totalminimumdamage }} pts de dégâts. Contre les monstres, inflige au maximum {{ totalmonsterdamagecap }} pts de dégâts.<br /></rules>",
          leveltip: {
            label: [
        ...
        },
        {
          ...
          tooltip:
            "Ornn fonce dans une direction en infligeant <physicalDamage>{{ totaldamage }} pts de dégâts physiques</physicalDamage> aux ennemis touchés.<br /><br />Si Ornn percute un terrain, il crée une onde de choc qui projette en l'air les ennemis pendant {{ knockupduration }} sec et qui inflige les dégâts de Ruée ardente à ceux que la ruée n'a pas touchés.<br /><br /><rules>L'onde de choc détruit les colonnes de lave et les terrains créés par les champions ennemis.</rules>",
          leveltip: {
            label: [
              "Dégâts de la ruée",
              "Délai de récupération",
        ...
        },
        {
          ...
          tooltip:
            "Ornn invoque un énorme élémentaire de lave qui fonce vers lui. Les ennemis écrasés par l'élémentaire subissent {{ rdamagecalc }} pts de dégâts magiques, sont ralentis jusqu'à {{ rslowpercentbasepremath }}% (selon la distance parcourue par l'élémentaire) pendant {{ rslowduration }} sec et deviennent <span class=\"colorFF5733\">fragiles</span> pendant {{ brittledurationtooltiponly }} sec.<br /><br />Ornn peut relancer cette compétence pour aller percuter l'élémentaire, ce qui le redirige et le renforce. L'élémentaire renforcé projette le premier champion touché en l'air pendant {{ rstunduration }} sec (durée réduite de {{ rstunreduction*100 }}% pour les champions touchés suivants), inflige {{ rdamagecalc }} pts de dégâts magiques et applique <span class=\"colorFF5733\">Fragilité</span>.",
          leveltip: {
      ...
      passive: {
        ...
        description:
          "Ornn augmente tous ses bonus d'armure et de résistance magique.<br><br>Ornn peut dépenser des PO pour forger des objets non consommables n'importe où sur la carte.<br><br>De plus, il peut créer des chefs-d'œuvre pour ses alliés ou lui-même.",
        image: {
          full: "OrnnP.png",
          sprite: "passive2.png",
          group: "passive",
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              hiddenWithAnyOf: [""],
              items: [
                { id: "3373", count: 1, hideCount: true },
                { id: "3379", count: 1, hideCount: true },
                { id: "3387", count: 1, hideCount: true },
                { id: "3383", count: 1, hideCount: true },
                { id: "3382", count: 1, hideCount: true },
                { id: "3389", count: 1, hideCount: true },
                { id: "3371", count: 1, hideCount: true },
                { id: "3380", count: 1, hideCount: true },
                { id: "3384", count: 1, hideCount: true },
                { id: "3388", count: 1, hideCount: true },
                { id: "3390", count: 1, hideCount: true },
                { id: "3374", count: 1, hideCount: true },
                { id: "3386", count: 1, hideCount: true },
              ],
            },
          ],
        },
