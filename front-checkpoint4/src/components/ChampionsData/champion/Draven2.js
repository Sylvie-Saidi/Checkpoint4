...
const Draven2 = {
  ...
  data: {
    Draven: {
      ...
      skins: [
        { id: "119000", num: 0, name: "default", chromas: false },
        { id: "119001", num: 1, name: "Draven faucheur", chromas: false },
        { id: "119002", num: 2, name: "Draven gladiateur", chromas: false },
        { id: "119003", num: 3, name: "Draven prime time", chromas: true },
        {
          id: "119004",
          num: 4,
          name: "Draven glorieux nageur",
          chromas: false,
        },
        {
          id: "119005",
          num: 5,
          name: "Draven chasseur de bêtes",
          chromas: false,
        },
        { id: "119006", num: 6, name: "Draven Draven", chromas: false },
        { id: "119012", num: 12, name: "Père Draven", chromas: false },
        {
          id: "119013",
          num: 13,
      ...
      spells: [
        {
          ...
          description:
            "La prochaine attaque de Draven infligera des dégâts physiques supplémentaires. Cette hache ricochera sur la cible et sera propulsée dans les airs. Si Draven l'attrape, il prépare automatiquement une autre Hache tournoyante. Draven peut avoir deux Haches tournoyantes simultanément.",
          tooltip:
            "La prochaine attaque de Draven infligera <scaleAD>{{ f1 }}</scaleAD> pts de dégâts physiques supplémentaires. Le bonus est égal à {{ e5 }} plus {{ e2 }}% de ses dégâts d'attaque supplémentaires.<br /><br />Cette hache ricochera sur la cible et sera propulsée dans les airs. Si Draven l'attrape, il prépare automatiquement une autre Hache tournoyante.<br /><br /><span class=\"colorDDDD77\">Draven peut avoir deux Haches tournoyantes simultanément.</span>",
          leveltip: {
            label: [
              "Dégâts",
          ...
          vars: [
            {
              link: "attackdamage",
              coeff: [0.45, 0.55, 0.65, 0.75, 0.85],
              key: "f1",
            },
          ],
        ...
        },
        {
          ...
          description:
            "Draven gagne des bonus en vitesse de déplacement et en vitesse d'attaque. Le bonus en vitesse de déplacement diminue rapidement sur la durée. Attraper une Hache tournoyante met fin au délai de récupération de Pulsion sanguinaire.",
          tooltip:
            "Draven gagne {{ e2 }}% de vitesse de déplacement supplémentaire pendant {{ e3 }} sec et {{ e4 }}% de vitesse d'attaque supplémentaire pendant {{ e5 }} sec. Le bonus en vitesse de déplacement diminue rapidement sur la durée.<br /><br />Attraper une Hache tournoyante met fin au délai de récupération de Pulsion sanguinaire.",
          leveltip: {
            label: [
              "Vitesse d'attaque",
        ...
        },
        {
          ...
          name: "Division",
          description:
            "Draven lance ses haches, infligeant des dégâts physiques aux cibles touchées et les repoussant sur le côté. Les cibles touchées sont ralenties.",
          tooltip:
            "Draven lance ses haches, infligeant {{ e1 }} <scaleAD>(+{{ f1 }})</scaleAD> pts de dégâts physiques aux cibles touchées et les repoussant sur le côté. Les cibles touchées sont ralenties de {{ e2 }}% pendant {{ e3 }} sec.",
          leveltip: {
          ...
          vars: [{ link: "bonusattackdamage", coeff: 0.5, key: "f1" }],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
      ...
      passive: {
        ...
        description:
          "Draven obtient l'Adoration de ses fans quand il rattrape une Hache tournoyante, quand il tue un sbire ou un monstre et quand il détruit une tourelle. Quand il tue des champions ennemis, Draven gagne des PO supplémentaires en fonction de l'Adoration cumulée.",
        image: {
