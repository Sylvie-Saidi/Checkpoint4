const Amumu2 = {
  ...
  data: {
    Amumu: {
      ...
      skins: [
        { id: "32000", num: 0, name: "default", chromas: false },
        { id: "32001", num: 1, name: "Amumu pharaon", chromas: false },
        { id: "32002", num: 2, name: "Amumu de Vancouver", chromas: false },
        { id: "32003", num: 3, name: "Emumu", chromas: false },
        { id: "32004", num: 4, name: "Amumu remballé", chromas: false },
        { id: "32005", num: 5, name: "Amumu quasi-roi du bal", chromas: false },
        { id: "32006", num: 6, name: "Petit chevalier Amumu", chromas: false },
        { id: "32007", num: 7, name: "Amumu triste droïde", chromas: false },
        { id: "32008", num: 8, name: "Amumu fêtard", chromas: true },
        { id: "32017", num: 17, name: "Amumu infernal", chromas: true },
        { id: "32023", num: 23, name: "Amumu Hextech", chromas: false },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Amumu jette une bandelette collante qui étourdit et blesse l'ennemi touché tandis qu'Amumu s'approche de lui.",
          tooltip:
            "Jette une bandelette dans une direction. Si elle touche une unité ennemie, Amumu se propulse vers elle, lui inflige {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et l'étourdit pendant {{ e2 }} sec. ",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          leveltip: {
            label: ["Pourcentage des PV en dégâts", "Dégâts de base"],
            effect: [
          ...
          costType: " {{ abilityresourcename }} par sec",
          maxammo: "-1",
          ...
          resource: "{{ cost }} {{ abilityresourcename }} par sec",
        },
        {
          id: "Tantrum",
          name: "Colère",
          description:
            "Réduit les dégâts physiques subis par Amumu. Il peut libérer sa rage et infliger des dégâts aux ennemis proches. Quand Amumu est touché, le délai de récupération est réduit de 0,5 sec.",
          tooltip:
            '<spellPassive>Passive : </spellPassive>les dégâts physiques subis par Amumu sont réduits de {{ e1 }} <span class="colorFFFF00">(+{{ f1 }})</span><span class="colorFF00FF">(+{{ f2 }})</span>.<br /><br /><spellPassive>Active : </spellPassive>Amumu pique une colère, infligeant {{ e2 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques aux unités proches. Les attaques de base qui touchent Amumu réduisent de 0,5 sec le délai de récupération de Colère.<br /><br /><rules><span class="color8c8c8c">La propriété passive de Colère est renforcée par les bonus d\'armure et de résistance magique.</span></rules>',
          leveltip: {
            label: ["Dégâts réduits", "Délai de récupération", "Dégâts"],
            effect: [
              "{{ e1 }} -> {{ e1NL }}",
              "{{ cooldown }} -> {{ cooldownNL }}",
              "{{ e2 }} -> {{ e2NL }}",
