...
const Sivir2 = {
  ...
  data: {
    Sivir: {
      ...
      skins: [
        { id: "15000", num: 0, name: "default", chromas: false },
        {
          id: "15001",
          num: 1,
          name: "Sivir princesse guerrière",
          chromas: false,
        },
        { id: "15002", num: 2, name: "Sivir spectaculaire", chromas: false },
        { id: "15003", num: 3, name: "Sivir chasseresse", chromas: false },
        { id: "15004", num: 4, name: "Sivir bandit", chromas: false },
        { id: "15005", num: 5, name: "Sivir PAX", chromas: false },
        { id: "15006", num: 6, name: "Sivir du blizzard", chromas: true },
        { id: "15007", num: 7, name: "Sivir purificatrice", chromas: false },
        {
          id: "15008",
          num: 8,
        ...
        { id: "15009", num: 9, name: "Néo Sivir PAX", chromas: false },
        {
          id: "15010",
          num: 10,
        ...
        { id: "15016", num: 16, name: "Sivir lune de sang", chromas: true },
      ],
      lore:
      ...
      spells: [
        {
          ...
          name: "Lame boomerang",
          description:
            "Sivir lance sa lame comme un boomerang, infligeant des dégâts à l'aller comme au retour.",
          tooltip:
            "Sivir lance sa lame comme un boomerang, infligeant <physicalDamage>{{ totaldamage }} pts de dégâts physiques</physicalDamage> à tous les ennemis touchés.<br /><br />Toucher un ennemi autre qu'un champion réduit les dégâts infligés aux cibles suivantes de {{ falloffratio*100 }}%, jusqu'à un minimum de {{ falloffminimum*100 }}%.",
          leveltip: {
            label: [
              "Dégâts",
              "Vitesse d'attaque",
        ...
        },
        {
          ...
          name: "Ricochet",
          description:
            "Les prochaines attaques de base de Sivir rebondiront vers les cibles proches, infligeant des dégâts réduits aux cibles secondaires.",
          tooltip:
            "Les {{ bounceattacks }} prochaines attaques de base de Sivir rebondissent sur les cibles proches, infligeant <scaleAD>{{ firsttargetdamage }} pts de dégâts physiques</scaleAD> à la première cible et <scaleAD>{{ bouncedamage }} pts de dégâts physiques</scaleAD> à chaque cible suivante.<br /><br />Si une attaque inflige un coup critique à la première cible, tous les rebonds suivants de cette attaque infligeront aussi des coups critiques.<br /><br /><span class=\"color919191\"><i>Chaque cible ne peut être touchée qu'une fois par attaque et les effets à l'impact ne sont appliqués que sur la première cible de l'attaque.</i></span>",
          leveltip: {
            label: [
        ...
        },
        {
          ...
          description:
            "Crée une barrière magique qui bloque une compétence ennemie lancée contre Sivir. Celle-ci regagne du mana si un sort est bloqué.",
          tooltip:
            "Sivir crée une barrière magique pendant {{ e1 }} sec et bloque ainsi la prochaine compétence ennemie.<br /><br />Si une compétence est bloquée par le bouclier, Sivir regagne {{ e2 }} pts de mana.",
          leveltip: {
            label: ["Délai de récupération", "Gain de mana"],
            effect: [
              "{{ cooldown }} -> {{ cooldownNL }}",
              "{{ e2 }} -> {{ e2NL }}",
            ],
        ...
        },
        {
          ...
          tooltip:
            "<spellPassive>Passive : </spellPassive>la vitesse d'attaque de Sivir augmente de {{ ricochetattackspeed*100 }}% quand Ricochet est actif.<br /><br /><spellPassive>Active : </spellPassive>Sivir rallie ses alliés pendant {{ ultduration }} sec, conférant à tous les alliés proches un bonus initial en vitesse de déplacement de {{ maxms }}% qui se réduit à {{ minms }}% après les {{ maxmsduration }} premières secondes d'En chasse.",
          leveltip: {
            label: [
              "Vitesse d'attaque",
              "Vitesse de déplacement maximum",
              "Vitesse de déplacement minimum",
      ...
      passive: {
        name: "Mille-pattes",
        description:
          "Sivir gagne un bref bonus en vitesse de déplacement quand elle attaque un champion ennemi.",
        image: {
