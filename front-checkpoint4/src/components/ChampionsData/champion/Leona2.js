...
const Leona2 = {
  ...
  data: {
    Leona: {
      ...
      skins: [
        { id: "89000", num: 0, name: "default", chromas: false },
        { id: "89001", num: 1, name: "Leona valkyrie", chromas: false },
        { id: "89002", num: 2, name: "Leona protectrice", chromas: false },
        { id: "89003", num: 3, name: "Leona de l'Iron Solari", chromas: false },
        { id: "89004", num: 4, name: "Leona bain de soleil", chromas: true },
        { id: "89008", num: 8, name: "PROJET : Leona", chromas: false },
        { id: "89009", num: 9, name: "Leona reine du grill", chromas: false },
        {
          id: "89010",
          num: 10,
      ...
      spells: [
        {
          ...
          tooltip:
            "La prochaine attaque de base inflige {{ e2 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques supplémentaires et étourdit la cible pendant {{ e1 }} sec.",
          leveltip: {
            label: ["Dégâts", "Coût en @AbilityResourceName@"],
            effect: ["{{ e2 }} -> {{ e2NL }}", "{{ cost }} -> {{ costNL }}"],
          },
          maxrank: 5,
          cooldown: [5, 5, 5, 5, 5],
          cooldownBurn: "5",
        ...
        },
        {
          ...
          name: "Éclipse",
          description:
            "Leona lève son bouclier et profite d'une amélioration de son armure et de sa résistance magique ainsi que d'une réduction des dégâts. Lorsque l'effet prend fin pour la première fois, s'il y a des ennemis proches, elle leur inflige des dégâts magiques et l'effet de protection est prolongé.",
          tooltip:
            'Pendant {{ e3 }} sec, Leona réduit de {{ flatdamagereduction }} les dégâts subis et obtient un bonus de {{ e4 }} <scaleArmor>(+{{ f1 }})</scaleArmor> en armure et de {{ e2 }} <span class="colorFF00FF">(+{{ f2 }})</span> en résistance magique. Lorsque l\'effet prend fin, les ennemis proches qui sont touchés subissent {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques et Leona prolonge ses bonus défensifs pendant {{ e3 }} sec.<br /><br /><rules>La réduction des dégâts ne peut pas dépasser {{ flatdamagereductionmax*100 }}% des dégâts reçus.</rules>',
          leveltip: {
            label: [
              "Dégâts",
          ...
          vars: [
            { link: "bonusarmor", coeff: 0.2, key: "f1" },
            { link: "bonusspellblock", coeff: 0.2, key: "f2" },
        ...
        },
        {
          ...
          name: "Lame du zénith",
          description:
            "Leona projette une image solaire de son épée, infligeant des dégâts magiques à tous les ennemis sur une ligne. Lorsque l'image se dissipe, le dernier champion ennemi touché est brièvement immobilisé et Leona fonce vers lui.",
          tooltip:
            "Frappe tous les ennemis sur une ligne, infligeant {{ e1 }} <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts magiques. Le dernier champion ennemi touché est immobilisé pendant {{ e2 }} sec et Leona fonce vers lui.",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Leona invoque un rayon d'énergie solaire qui inflige des dégâts à tous les ennemis dans une zone. Les ennemis au centre de la zone sont étourdis et ceux qui sont en bordure sont ralentis.",
          tooltip:
            "Invoque un rayon d'énergie solaire qui inflige {{ explosioncalculateddamage }} pts de dégâts magiques et qui ralentit les ennemis de {{ slowpercent }}% pendant {{ ccduration }} sec. Les ennemis au centre de la zone d'effet sont étourdis au lieu d'être ralentis.",
          leveltip: {
            label: ["Dégâts", "Délai de récupération"],
            effect: [
      ...
      passive: {
        ...
        description:
          "Les sorts marquent les ennemis d'un Rayon de soleil pendant 1,5 sec. Si des champions alliés blessent ces ennemis, ils dissipent Rayon de soleil et infligent des dégâts magiques supplémentaires.",
        image: {
