...
const XinZhao2 = {
  ...
  data: {
    XinZhao: {
      ...
      skins: [
        { id: "5000", num: 0, name: "default", chromas: false },
        { id: "5001", num: 1, name: "Xin Zhao commando", chromas: false },
        { id: "5002", num: 2, name: "Xin Zhao impérial", chromas: false },
        { id: "5003", num: 3, name: "Xin Zhao Viscero", chromas: false },
        { id: "5004", num: 4, name: "Xin Zhao hussard ailé", chromas: false },
        {
          id: "5005",
          num: 5,
        ...
        { id: "5006", num: 6, name: "Xin Zhao agent secret", chromas: false },
        {
          id: "5013",
          num: 13,
      ...
      spells: [
        {
          ...
          description:
            "Les 3 prochaines attaques de base de Xin Zhao infligeront plus de dégâts et la 3e attaque projettera la cible dans les airs.",
          tooltip:
            "Les 3 prochaines attaques de base de Xin Zhao infligent {{ e1 }} <scaleAD>(+{{ f1 }})</scaleAD> pts de dégâts physiques supplémentaires et réduisent de 1 sec ses autres délais de récupération. Le dernier coup projette l'adversaire dans les airs pendant {{ e2 }} sec.",
          leveltip: {
        ...
        },
        {
          ...
          name: "Vent et foudre",
          description:
            "Xin Zhao donne un coup de taille devant lui avec sa lance, puis donne un coup d'estoc, ralentissant les ennemis affectés.",
          tooltip:
            "Xin Zhao donne un coup de taille devant lui avec sa lance, puis donne un coup d'estoc.<br /><br /><span class=\"colorDDDD77\">Taille </span>: {{ e1 }} <scaleAD>(+{{ a1 }})</scaleAD> pts de dégâts.<br /><span class=\"colorDDDD77\">Estoc </span>: {{ e2 }} <scaleAD>(+{{ a2 }})</scaleAD> pts de dégâts et ralentissement de {{ e6 }}% pendant {{ e7 }} sec.<br /><br />Le temps d'utilisation est réduit par la vitesse d'attaque fournie par les objets et les niveaux gagnés (temps minimum : 0,4 sec).<br />Temps d'utilisation actuel : <scaleLevel>{{ f5 }}</scaleLevel>.<br /><br /><rules>Inflige 50% de dégâts en moins aux sbires.<br />Le Vol de vie a une efficacité de 33% pour les deux attaques.<br />Prolonge de {{ f5 }} sec la durée actuelle des autres compétences de Xin Zhao.</rules>",
          leveltip: {
            label: [
              "Dégâts de taille",
              "Dégâts d'estoc",
          ...
          vars: [
            { link: "attackdamage", coeff: 0.3, key: "a1" },
            { link: "attackdamage", coeff: 0.75, key: "a2" },
          ],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
        ...
        },
        {
          ...
          description:
            "Xin Zhao charge un ennemi, infligeant des dégâts à tous les ennemis dans la zone et les ralentissant brièvement.",
          tooltip:
            "Xin Zhao charge un ennemi. La charge inflige {{ e1 }}<scaleAP> (+{{ a1 }})</scaleAP> pts de dégâts magiques aux ennemis proches et les ralentit de {{ e2 }}% pendant 0,5 sec. La charge augmente la vitesse d'attaque de Xin Zhao de {{ e3 }}% pendant {{ e4 }} sec.",
          leveltip: {
        ...
        },
        {
          ...
          description:
            "Xin Zhao inflige des dégâts aux ennemis proches en fonction de leurs PV actuels et repousse les cibles non défiées. Xin Zhao est immunisé contre les dégâts infligés par les champions hors du cercle créé.",
          tooltip:
            'Xin Zhao effectue un balayage autour de lui, infligeant des dégâts physiques équivalents à {{ totaldamage }} plus {{ percentcurrenthealthdamage*100 }}% des PV actuels de la cible et repoussant les ennemis (600 max contre les monstres).<br /><br />Pendant {{ missiledefensebaseduration }} sec après le lancement de cette compétence, Xin Zhao devient plus <span class="colorDDDD77">vigilant</span> et bloquera complètement les dégâts des ennemis éloignés. Les attaques et les compétences de Xin Zhao augmentent la durée de <span class="colorDDDD77">Vigilance</span> de {{ bonusdurationperswing }} sec chacune.<br /><br />Le dernier champion touché par les attaques de base de Xin Zhao ou par Charge audacieuse n\'est pas repoussé.',
          leveltip: {
      ...
      passive: {
        name: "Détermination",
        description:
          "Toutes les 3 attaques, Xin Zhao inflige des dégâts supplémentaires et récupère des PV.",
        image: {
          full: "XinZhaoP.png",
          sprite: "passive4.png",
          group: "passive",
