  ...
  data: {
    Jax: {
      ...
      skins: [
        ...
        { id: "24001", num: 1, name: "Le Grand Jax", chromas: false },
        { id: "24002", num: 2, name: "Jax le vandale", chromas: false },
        { id: "24003", num: 3, name: "Jax le pêcheur", chromas: false },
        { id: "24004", num: 4, name: "Jax PAX", chromas: false },
        { id: "24005", num: 5, name: "Jaximus", chromas: false },
        { id: "24006", num: 6, name: "Jax Shaolin", chromas: false },
        { id: "24007", num: 7, name: "Jax Némésis", chromas: true },
        { id: "24008", num: 8, name: "SKT T1 Jax", chromas: false },
        { id: "24012", num: 12, name: "Jax purificateur", chromas: false },
        { id: "24013", num: 13, name: "Jax au bâton divin", chromas: false },
        {
          id: "24014",
          num: 14,
      ...
      spells: [
        {
          ...
          tooltip:
            "Jax bondit sur l'unité ciblée, infligeant {{ e1 }} <scaleAD>(+{{ f1 }})</scaleAD> <scaleAP>(+{{ a1 }})</scaleAP> pts de dégâts physiques s'il s'agit d'un ennemi.",
          leveltip: {
          ...
          vars: [
            { link: "bonusattackdamage", coeff: 1, key: "f1" },
        ...
        },
        {
          ...
          tooltip:
            "Jax charge son arme en énergie pour que sa prochaine attaque de base ou sa prochaine Frappe bondissante inflige {{ e1 }} <scaleAP>(+{{ a1 }}) </scaleAP>pts de dégâts magiques supplémentaires.",
          leveltip: {
            label: ["Dégâts", "Délai de récupération"],
            effect: [
              "{{ e1 }} -> {{ e1NL }}",
        ...
        },
        {
          ...
          tooltip:
            "Jax prend une posture défensive pendant {{ e6 }} sec maximum, esquivant toutes les attaques de base et réduisant de {{ e3 }}% les dégâts que lui infligent les compétences à effet de zone.<br /><br />Après les 2 sec ou si vous réactivez la compétence, Jax étourdit les ennemis proches pendant {{ e2 }} sec et leur inflige {{ e1 }} <scaleAD>(+{{ f2 }})</scaleAD> pts de dégâts physiques.<br /><br /><scaleAP>Contre-attaque inflige {{ e5 }}% de dégâts supplémentaires pour chaque attaque esquivée par Jax (max : {{ e4 }}% de dégâts supplémentaires).</scaleAP>",
          leveltip: {
            label: [
          ...
          vars: [{ link: "bonusattackdamage", coeff: 0.5, key: "f2" }],
          costType: " {{ abilityresourcename }}",
          maxammo: "-1",
          range: [300, 300, 300, 300, 300],
          rangeBurn: "300",
        ...
        },
        {
          ...
          name: "Force du maître",
          description:
            "Le troisième coup consécutif de Jax inflige des dégâts magiques supplémentaires. En outre, Jax peut activer cette compétence pour renforcer sa détermination, augmentant son armure et sa résistance magique pendant un court instant.",
          tooltip:
            "<spellPassive>Passive :</spellPassive> toutes les trois attaques consécutives, Jax inflige <magicDamage>{{ damagecalc }} pts de dégâts magiques supplémentaires</magicDamage>.<br /><br /><spellPassive>Active :</spellPassive> Jax renforce sa détermination, augmentant son armure de {{ armorcalc }} et sa résistance magique de {{ mrcalc }} pendant {{ activeduration }} sec.",
          leveltip: {
            label: [
              "Dégâts passifs",
              "Bonus d'armure",
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                { id: "3124", count: 1, hideCount: false },
                { id: "3161", count: 1, hideCount: false },
                { id: "4403", count: 1, hideCount: false },
              ],
            },
            {
              type: "defensive",
