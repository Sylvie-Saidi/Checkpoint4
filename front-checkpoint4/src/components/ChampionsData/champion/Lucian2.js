const Lucian2 = {
  ...
  data: {
    Lucian: {
      ...
      skins: [
        { id: "236000", num: 0, name: "default", chromas: true },
        { id: "236001", num: 1, name: "Lucian tueur à gages", chromas: false },
        { id: "236002", num: 2, name: "Lucian buteur", chromas: false },
        { id: "236006", num: 6, name: "PROJET : Lucian", chromas: true },
        { id: "236007", num: 7, name: "Lucian cœur-de-cible", chromas: false },
        { id: "236008", num: 8, name: "Lucian de l'Ouest", chromas: false },
        { id: "236009", num: 9, name: "Lucian Demacia Vice", chromas: true },
        { id: "236018", num: 18, name: "Lucian Pulsefire", chromas: false },
        {
          id: "236019",
          num: 19,
          name: "Lucian Pulsefire édition prestige",
          chromas: false,
        },
      ],
      lore:
      ...
      spells: [
        {
          ...
          description:
            "Lucian tire un rayon lumineux qui transperce une cible.",
          tooltip:
            "Tire un rayon lumineux qui transperce une unité ennemie, infligeant {{ e1 }} <scaleAD>(+{{ f1 }})</scaleAD> ({{ e2 }}% des dégâts d'attaque supplémentaires) pts de dégâts physiques aux ennemis sur une ligne.<br /><br /><rules><span class=\"color8c8c8c\">Le délai d'incantation de Lumière perforante se réduit légèrement à mesure que le niveau de Lucian augmente.</span></rules>",
          leveltip: {
            label: [
              "Dégâts",
              "Dégâts d'attaque",
        ...
        },
        {
          ...
          name: "Flamboiement",
          description:
            "Lucian tire un projectile qui provoque une explosion en forme d'étoile, marquant et révélant brièvement les ennemis. Lucian augmente sa vitesse de déplacement quand il attaque les ennemis marqués.",
          tooltip:
            "Tire un projectile qui explose au contact d'un ennemi ou en bout de course. L'explosion inflige {{ e1 }} <span class=\"color88FF88\">(+{{ a1 }})</span> pts de dégâts magiques, marque les ennemis pendant 6 sec et les révèle brièvement.<br /><br />Quand Lucian ou ses alliés blessent une cible marquée, Lucian augmente sa vitesse de déplacement de {{ e2 }} pendant 1 sec.",
          leveltip: {
            label: [
              "Dégâts",
        ...
        },
        {
          ...
          description:
            "Lucian fonce sur une courte distance. Pistolero réduit le délai de récupération de Poursuite inlassable.",
          tooltip:
            "Fonce sur une courte distance.<br /><br />Si Pistolero touche un ennemi, le délai de récupération de Poursuite inlassable est réduit de {{ e1 }} sec ({{ e2 }} sec contre les champions).",
          leveltip: {
        ...
        },
        {
          ...
          tooltip:
            "Lucian se déplace librement tout en tirant rapidement dans une direction pendant {{ duration }} sec. Les balles blessent le premier ennemi touché et infligent <physicalDamage>{{ damageperbullet }} pts de dégâts physiques</physicalDamage> chacune.  Déluge de balles inflige {{ percentdamageamptominions }}% des dégâts aux sbires.<br /><br />Pendant Déluge de balles, Lucian peut utiliser Poursuite inlassable.<br /><br />Réactiver pour annuler Déluge de balles plus tôt.",
          leveltip: {
      ...
      passive: {
        name: "Pistolero",
        description:
          "Quand Lucian utilise une compétence, sa prochaine attaque devient un double-tir.",
        image: {
